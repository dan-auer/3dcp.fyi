...
hide:
    ...
    - tags
    - footer
title: Sapata Alise, Pluminss Ernests, Šlosbergs Pēteris, Šinka Māris
description:
tags:
 - aggregate
 - cement
...
#Utilizing Construction Demolition Waste Aggregates in Cement- Free Concrete for 3D Printing ([2025-08](date/2025/08))
<span class="author"><a href="https://orcid.org/0009-0007-1221-2026" title="ORCID: 0009-0007-1221-2026" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/sapata_alise"><b>Sapata</b>&nbsp;Alise</a></span>, <a href="../../../author/pluminss_ernests"><b>Pluminss</b>&nbsp;Ernests</a></span>, <a href="../../../author/slosbergs_peteris"><b>Šlosbergs</b>&nbsp;Pēteris</a></span>, <span class="author"><a href="https://orcid.org/0000-0002-2332-1347" title="ORCID: 0000-0002-2332-1347" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/sinka_maris"><b>Šinka</b>&nbsp;Māris</a></span><br>
Contribution - Proceedings of the 4th International Conference on Sustainable Building Materials

<a href="../../keyword/aggregate"><button class="btn">#aggregate</button></a> <a href="../../keyword/cement"><button class="btn">#cement</button></a> <a href="../../keyword/concrete"><button class="btn">#concrete</button></a> <a href="../../keyword/construction"><button class="btn">#construction</button></a> <a href="../../keyword/demolition"><button class="btn">#demolition</button></a> <a href="../../keyword/print"><button class="btn">#print</button></a> <a href="../../keyword/util"><button class="btn">#util</button></a> <a href="../../keyword/waste"><button class="btn">#waste</button></a> 

<a href="https://scholar.google.com/scholar?as_q=utilizing+construction+demolition+waste+aggregates+in+cement-+free+concrete+for+3d+printing&as_occt=title&as_sauthors=sapata&as_ylo=2023&as_yhi=2027&hl=en" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{sapa_plum_slos_sink.2025.UCDWAiCFCf3P,
      author            = "Alise Sapata and Ernests Pluminss and Pēteris Šlosbergs and Māris Šinka",
      title             = "Utilizing Construction Demolition Waste Aggregates in Cement- Free Concrete for 3D Printing",
      year              = "2025",
      booktitle         = "Proceedings of the 4th International Conference on Sustainable Building Materials",
    }
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">A. Sapata, E. Pluminss, P. Šlosbergs and M. Šinka, “Utilizing Construction Demolition Waste Aggregates in Cement- Free Concrete for 3D Printing”,  2025.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Sapata, Alise, Ernests Pluminss, Pēteris Šlosbergs, and Māris Šinka. “Utilizing Construction Demolition Waste Aggregates in Cement- Free Concrete for 3D Printing”. In <i>Proceedings of the 4th International Conference on Sustainable Building Materials</i>, 2025.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
