...
hide:
    ...
    - tags
    - footer
title: Lachmayer Lukas, Recker Tobias, Raatz Annika
description:
tags:
 - additive
 - application
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{lach_reck_raat.2022.CTCfMRAtLSAaAMiC,
      author            = "Lukas Lachmayer and Tobias Recker and Annika Raatz",
      title             = "Contour-Tracking-Control for Mobile Robots Applicable to Large-Scale Assembly and Additive Manufacturing in Construction",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">L. Lachmayer, T. Recker and A. Raatz, “Contour-Tracking-Control for Mobile Robots Applicable to Large-Scale Assembly and Additive Manufacturing in Construction”, <i>Procedia CIRP</i>, vol. 106, pp. 108–113, 2022, doi: 10.1016/j.procir.2022.02.163.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Lachmayer, Lukas, Tobias Recker, and Annika Raatz. “Contour-Tracking-Control for Mobile Robots Applicable to Large-Scale Assembly and Additive Manufacturing in Construction”. <i>Procedia CIRP</i> 106 (2022): 108–13. https://doi.org/10.1016/j.procir.2022.02.163.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
