...
hide:
    ...
    - tags
    - footer
title: Wang Junsong, Ye Haoran, Sun Yating, Zhang Zixin, Qi Chenxu, Zhang Chenzhe, Song Chengwei, Demartino Cristoforo, Usmani Asif
description:
tags:
 - concrete
 - design
...
<a href="https://api.crossref.org/works/10.1007/978-3-031-90690-9_21" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1007/978-3-031-90690-9_21" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1007/978-3-031-90690-9_21" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1007/978-3-031-90690-9_21&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1007/978-3-031-90690-9_21" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1007/978-3-031-90690-9_21&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4410772903" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1007/978-3-031-90690-9_21" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1007/978-3-031-90690-9_21?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{wang_ye_sun_zhan.2025.Io3PFCaOfESD,
      author            = "Junsong Wang and Haoran Ye and Yating Sun and Zixin Zhang and Chenxu Qi and Chenzhe Zhang and Chengwei Song and Cristoforo Demartino and Asif Usmani",
      title             = "Integration of 3D Printed Fiber Concrete and OpenSeesTO for Enhanced Structural Design",
      doi               = "10.1007/978-3-031-90690-9_21",
      year              = "2025",
      volume            = "638",
      pages             = "241--252",
      booktitle         = "Proceedings of the 2024 Eurasian OpenSees Days",
      editor            = "Xinzheng Lu and Cristoforo Demartino and Fabio Di Trapani and Kaiqi Lin and Giorgio Monti",
    }
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">J. Wang, “Integration of 3D Printed Fiber Concrete and OpenSeesTO for Enhanced Structural Design”, in <i>Proceedings of the 2024 Eurasian OpenSees Days</i>,  2025, vol. 638, pp. 241–252. doi: 10.1007/978-3-031-90690-9_21.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Wang, Junsong, Haoran Ye, Yating Sun, Zixin Zhang, Chenxu Qi, Chenzhe Zhang, Chengwei Song, Cristoforo Demartino, and Asif Usmani. “Integration of 3D Printed Fiber Concrete and OpenSeesTO for Enhanced Structural Design”. In <i>Proceedings of the 2024 Eurasian OpenSees Days</i>, edited by Xinzheng Lu, Cristoforo Demartino, Fabio Di Trapani, Kaiqi Lin, and Giorgio Monti, 638:241–52, 2025. https://doi.org/10.1007/978-3-031-90690-9_21.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
