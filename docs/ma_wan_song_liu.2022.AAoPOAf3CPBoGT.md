...
hide:
    - navigation
    - tags
title: Zongfang Ma, Weipeng Wan, Lin Song, Chao Liu, Huawei Liu, Yiwen Wu
description:
tags:
 - algorithm
 - approach
...
#[:aca-openaccess:{ .xgreen }](https://www.mdpi.com/2076-3417/12/22/11315/pdf?version=1668590011) An Approach of Path-Optimization Algorithm for 3D Concrete Printing Based on Graph-Theory ([2022-11](date/2022/11))
<a href="https://doi.org/10.3390/app122211315" title="DOI" target="_blank">:aca-doi:{ .lg .middle } 10.3390/app122211315</a>
...
:aca-blank:{ .lg .middle}
    Journal Article - Applied Sciences, Vol. 12, Iss. 22, No. (None,)
