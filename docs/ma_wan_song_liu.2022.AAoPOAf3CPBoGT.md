...
hide:
    ...
    - tags
    - footer
title: Ma Zongfang, Wan Weipeng, Song Lin, Liu Chao, Liu Huawei, Wu Yiwen
description:
tags:
 - algorithm
 - approach
...
<a href="https://api.crossref.org/works/10.3390/app122211315" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.3390/app122211315" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.3390/app122211315" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.3390/app122211315&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.3390/app122211315" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.3390/app122211315&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4308526978" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.3390/app122211315" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.3390/app122211315?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{ma_wan_song_liu.2022.AAoPOAf3CPBoGT,
      author            = "Zongfang Ma and Weipeng Wan and Lin Song and Chao Liu and Huawei Liu and Yiwen Wu",
      title             = "An Approach of Path-Optimization Algorithm for 3D Concrete Printing Based on Graph-Theory",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">Z. Ma, W. Wan, L. Song, C. Liu, H. Liu and Y. Wu, “An Approach of Path-Optimization Algorithm for 3D Concrete Printing Based on Graph-Theory”, <i>Applied Sciences</i>, vol. 12, no. 22, 2022, doi: 10.3390/app122211315.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Ma, Zongfang, Weipeng Wan, Lin Song, Chao Liu, Huawei Liu, and Yiwen Wu. “An Approach of Path-Optimization Algorithm for 3D Concrete Printing Based on Graph-Theory”. <i>Applied Sciences</i> 12, no. 22 (2022). https://doi.org/10.3390/app122211315.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
