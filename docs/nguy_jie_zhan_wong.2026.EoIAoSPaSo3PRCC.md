...
hide:
    ...
    - tags
    - footer
title: Nguyen Vuong, Jie Cheah, Zhang Y., Wong Hong
description:
tags:
 - architecture
 - column
...
<a href="https://api.crossref.org/works/10.1016/j.engstruct.2025.122057" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1016/j.engstruct.2025.122057" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1016/j.engstruct.2025.122057" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1016/j.engstruct.2025.122057&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1016/j.engstruct.2025.122057" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1016/j.engstruct.2025.122057&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/None" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1016/j.engstruct.2025.122057" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1016/j.engstruct.2025.122057?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{nguy_jie_zhan_wong.2026.EoIAoSPaSo3PRCC,
      author            = "Vuong van Nguyen and Cheah Chun Jie and Y. X. Zhang and Hong S. Wong",
      title             = "Effect of Infill Architecture on Structural Performance and Sustainability of 3D-Printed Reinforced Concrete Columns",
      doi               = "10.1016/j.engstruct.2025.122057",
      year              = "2026",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">V. van Nguyen, C. C. Jie, Y. X. Zhang and H. S. Wong, “Effect of Infill Architecture on Structural Performance and Sustainability of 3D-Printed Reinforced Concrete Columns”, <i>Engineering Structures</i>, vol. 351, p. 122057, 2026, doi: 10.1016/j.engstruct.2025.122057.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Nguyen, Vuong van, Cheah Chun Jie, Y. X. Zhang, and Hong S. Wong. “Effect of Infill Architecture on Structural Performance and Sustainability of 3D-Printed Reinforced Concrete Columns”. <i>Engineering Structures</i> 351 (2026): 122057. https://doi.org/10.1016/j.engstruct.2025.122057.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
