...
hide:
    ...
    - tags
    - footer
title: Giulivo Marco, Capozzi Vittorio, Menna Costantino
description:
tags:
 - analysis
 - assessment
...
#Experimental and Analytical Assessment of the in-Plane Behaviour of 3D Printed Concrete Walls Subjected to Cyclic Loads ([2025-10](date/2025/10))
<a title="Closed Access">:aca-closedaccess:{ .xred .lg .middle}</a>
 <a href="https://doi.org/10.1016/j.engstruct.2025.121516" title="DOI" target="_blank">:aca-doi:{ .lg .middle }</a> <a href="https://doi.org/10.1016/j.engstruct.2025.121516" target="_blank">10.1016/j.engstruct.2025.121516</a>

<span class="author"><a href="https://orcid.org/0009-0008-2542-3348" title="ORCID: 0009-0008-2542-3348" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/giulivo_marco"><b>Giulivo</b>&nbsp;Marco</a></span>, <a href="../../../author/capozzi_vittorio"><b>Capozzi</b>&nbsp;Vittorio</a></span>, <span class="author"><a href="https://orcid.org/0000-0001-9528-1324" title="ORCID: 0000-0001-9528-1324" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/menna_costantino"><b>Menna</b>&nbsp;Costantino</a></span><br>
Journal Article - Engineering Structures, Vol. 345, No. 121516

<a href="../../keyword/analysis"><button class="btn">#analysis</button></a> <a href="../../keyword/assessment"><button class="btn">#assessment</button></a> <a href="../../keyword/behavior"><button class="btn">#behavior</button></a> <a href="../../keyword/concrete"><button class="btn">#concrete</button></a> <a href="../../keyword/cycle"><button class="btn">#cycle</button></a> <a href="../../keyword/experiment"><button class="btn">#experiment</button></a> <a href="../../keyword/load"><button class="btn">#load</button></a> <a href="../../keyword/plane"><button class="btn">#plane</button></a> <a href="../../keyword/print"><button class="btn">#print</button></a> <a href="../../keyword/wall"><button class="btn">#wall</button></a> 

<a href="https://scholar.google.com/scholar?as_q=experimental+and+analytical+assessment+of+the+in-plane+behaviour+of+3d+printed+concrete+walls+subjected+to+cyclic+loads&as_occt=title&as_sauthors=giulivo&as_ylo=2023&as_yhi=2027&hl=en" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
<a href="https://www.scopus.com/record/display.url?eid=2-s2.0-105020423981&origin=resultslist" title="Search on Scopus" target="_blank">:aca-scopus:{ .lg .middle }</a>
<a href="https://www.webofscience.com/wos/woscc/full-record/WOS:001600266300001" title="Search on Web of Science" target="_blank">:aca-wos:{ .lg .middle }</a>
<a href="https://plu.mx/plum/a/?doi=10.1016/j.engstruct.2025.121516" title="Search on plu.mx" target="_blank">:aca-plumx:{ .lg .middle }</a>
<a href="https://api.crossref.org/works/10.1016/j.engstruct.2025.121516" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1016/j.engstruct.2025.121516" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1016/j.engstruct.2025.121516" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1016/j.engstruct.2025.121516&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1016/j.engstruct.2025.121516" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1016/j.engstruct.2025.121516&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4415216353" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1016/j.engstruct.2025.121516" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1016/j.engstruct.2025.121516?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{giul_capo_menn.2025.EaAAotiPBo3PCWStCL,
      author            = "Marco Giulivo and Vittorio Capozzi and Costantino Menna",
      title             = "Experimental and Analytical Assessment of the in-Plane Behaviour of 3D Printed Concrete Walls Subjected to Cyclic Loads",
      doi               = "10.1016/j.engstruct.2025.121516",
      year              = "2025",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">M. Giulivo, V. Capozzi and C. Menna, “Experimental and Analytical Assessment of the in-Plane Behaviour of 3D Printed Concrete Walls Subjected to Cyclic Loads”, <i>Engineering Structures</i>, vol. 345, p. 121516, 2025, doi: 10.1016/j.engstruct.2025.121516.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Giulivo, Marco, Vittorio Capozzi, and Costantino Menna. “Experimental and Analytical Assessment of the in-Plane Behaviour of 3D Printed Concrete Walls Subjected to Cyclic Loads”. <i>Engineering Structures</i> 345 (2025): 121516. https://doi.org/10.1016/j.engstruct.2025.121516.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
