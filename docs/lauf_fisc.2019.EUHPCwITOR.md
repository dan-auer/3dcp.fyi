...
hide:
    - navigation
    - tags
title: Philipp Lauff, Oliver Fischer
description:
tags:
 - concrete
 - efficient
...
#:aca-closedaccess:{ .xred '} Efficient Ultra-High Performance Concrete with Innovative Trajectory-Oriented "Reinforcement" ([2019-04](date/2019/04))
<a href="https://doi.org/10.1002/cepa.976" title="DOI" target="_blank">:aca-doi:{ .lg .middle } 10.1002/cepa.976</a>
