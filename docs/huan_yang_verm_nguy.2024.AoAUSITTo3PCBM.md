...
hide:
    ...
    - tags
    - footer
title: Huang Zili, Yang Weiyi, Verma Rupesh, Nguyen Giang, Tung Tran, Karakus Murat
description:
tags:
 - application
 - base
...
<a href="../../../author/huang_zili"><b>Huang</b>&nbsp;Zili</a></span>, <a href="../../../author/yang_weiyi"><b>Yang</b>&nbsp;Weiyi</a></span>, <a href="../../../author/verma_rupesh"><b>Verma</b>&nbsp;Rupesh</a></span>, <span class="author"><a href="https://orcid.org/0000-0003-2348-7563" title="ORCID: 0000-0003-2348-7563" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/nguyen_d_giang"><b>Nguyen</b>&nbsp;Giang</a></span>, <a href="../../../author/tung_t_tran"><b>Tung</b>&nbsp;Tran</a></span>, <a href="../../../author/karakus_murat"><b>Karakus</b>&nbsp;Murat</a></span><br>
...
<a href="https://api.crossref.org/works/10.1016/j.prostr.2024.06.032" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1016/j.prostr.2024.06.032" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1016/j.prostr.2024.06.032" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1016/j.prostr.2024.06.032&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1016/j.prostr.2024.06.032" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1016/j.prostr.2024.06.032&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4401010428" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1016/j.prostr.2024.06.032" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1016/j.prostr.2024.06.032?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{huan_yang_verm_nguy.2024.AoAUSITTo3PCBM,
      author            = "Zili Huang and Weiyi Yang and Rupesh Verma and Giang D. Nguyen and Tran T. Tung and Murat Karakus",
      title             = "Application of Adelaide-University-Snapback-Indirect-Tensile-Test on 3D Printed Cement-Based Materials",
      doi               = "10.1016/j.prostr.2024.06.032",
      year              = "2024",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">Z. Huang, W. Yang, R. Verma, G. D. Nguyen, T. T. Tung and M. Karakus, “Application of Adelaide-University-Snapback-Indirect-Tensile-Test on 3D Printed Cement-Based Materials”, <i>Procedia Structural Integrity</i>, vol. 61, pp. 252–259, 2024, doi: 10.1016/j.prostr.2024.06.032.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Huang, Zili, Weiyi Yang, Rupesh Verma, Giang D. Nguyen, Tran T. Tung, and Murat Karakus. “Application of Adelaide-University-Snapback-Indirect-Tensile-Test on 3D Printed Cement-Based Materials”. <i>Procedia Structural Integrity</i> 61 (2024): 252–59. https://doi.org/10.1016/j.prostr.2024.06.032.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
