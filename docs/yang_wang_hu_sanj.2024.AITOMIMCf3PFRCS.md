...
<a title="Closed Access">:aca-closedaccess:{ .xred .lg .middle}</a>
 <a href="https://doi.org/10.1016/j.matlet.2023.135442" title="DOI" target="_blank">:aca-doi:{ .lg .middle }</a> <a href="https://doi.org/10.1016/j.matlet.2023.135442" target="_blank">10.1016/j.matlet.2023.135442</a>
...
<a href="https://scholar.google.com/scholar?as_q=an+integrated+topology-optimization+method+including+manufacturing-constraints+for+3d+printed+fiber-reinforced+concrete+structures&as_occt=title&as_sauthors=yang&as_ylo=2021&as_yhi=2025&hl=en" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
