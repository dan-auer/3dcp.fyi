...
hide:
    ...
    - tags
    - footer
title: Pal Biswajit, Chourasia Ajay, Tomar Milan, Pradeep Kumar
description:
tags:
 - beam
 - behavior
...
<a href="https://api.crossref.org/works/10.1007/978-981-96-9712-0_1" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1007/978-981-96-9712-0_1" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1007/978-981-96-9712-0_1" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1007/978-981-96-9712-0_1&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1007/978-981-96-9712-0_1" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1007/978-981-96-9712-0_1&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W7118013850" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1007/978-981-96-9712-0_1" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1007/978-981-96-9712-0_1?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">B. Pal, A. Chourasia, M. Tomar and K. R. Pradeep, “Influence of Interfilament Bond Characteristics on the Load–Deflection Behavior of 3D Printed Beam: A Numerical Study”, in <i>Futuristic Trends in Structural Engineering</i>,  2026, vol. 716, pp. 1–15. doi: 10.1007/978-981-96-9712-0_1.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Pal, Biswajit, Ajay Chourasia, Milan Tomar, and Kumar R. Pradeep. “Influence of Interfilament Bond Characteristics on the Load–Deflection Behavior of 3D Printed Beam: A Numerical Study”. In <i>Futuristic Trends in Structural Engineering</i>, 716:1–15, 2026. https://doi.org/10.1007/978-981-96-9712-0_1.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
