...
hide:
    - navigation
    - tags
title: Virama Ekanayaka, Lukas Lachmayer, Annika Raatz, André Hürkamp
description:
tags:
 - additive
 - approach
...
#[:aca-openaccess:{ .xgreen }](https://doi.org/10.1016/j.procir.2022.05.295) Approach to Optimize the Inter-Layer Waiting Time in Additive Manufacturing with Concrete Utilizing FEM Modeling ([2022-06](date/2022/06))
<a href="https://doi.org/10.1016/j.procir.2022.05.295" title="DOI" target="_blank">:aca-doi:{ .lg .middle } 10.1016/j.procir.2022.05.295</a>
