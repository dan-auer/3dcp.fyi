...
hide:
    ...
    - tags
    - footer
title: Otto Jens, Maiwald Patrick
description:
tags:
 - automation
 - classification
...
#Classification and Automated Quality Assurance of 3D Concrete Printed Surfaces ([2024-05](date/2024/05))
<a href="https://doi.org/10.1016/j.autcon.2024.105467" title="Open Access - Click to Download" target="_blank">:aca-openaccess:{ .xgreen .lg .middle}</a>
 <a href="https://doi.org/10.1016/j.autcon.2024.105467" title="DOI" target="_blank">:aca-doi:{ .lg .middle }</a> <a href="https://doi.org/10.1016/j.autcon.2024.105467" target="_blank">10.1016/j.autcon.2024.105467</a>

<span class="author"><a href="https://orcid.org/0000-0001-7157-2143" title="ORCID: 0000-0001-7157-2143" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/otto_jens"><b>Otto</b>&nbsp;Jens</a></span>, <a href="../../../author/maiwald_patrick"><b>Maiwald</b>&nbsp;Patrick</a></span><br>
Journal Article - Automation in Construction, Vol. 164, No. 105467

<a href="../../keyword/automation"><button class="btn">#automation</button></a> <a href="../../keyword/classification"><button class="btn">#classification</button></a> <a href="../../keyword/concrete"><button class="btn">#concrete</button></a> <a href="../../keyword/print"><button class="btn">#print</button></a> <a href="../../keyword/quality"><button class="btn">#quality</button></a> <a href="../../keyword/surface"><button class="btn">#surface</button></a> 

<a href="https://scholar.google.com/scholar?as_q=classification+and+automated+quality+assurance+of+3d+concrete+printed+surfaces&as_occt=title&as_sauthors=otto&as_ylo=2022&as_yhi=2026&hl=en" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
<a href="https://www.scopus.com/record/display.url?eid=2-s2.0-85193838926&origin=resultslist" title="Search on Scopus" target="_blank">:aca-scopus:{ .lg .middle }</a>
<a href="https://www.webofscience.com/wos/woscc/full-record/WOS:001244601700001" title="Search on Web of Science" target="_blank">:aca-wos:{ .lg .middle }</a>
<a href="https://plu.mx/plum/a/?doi=10.1016/j.autcon.2024.105467" title="Search on plu.mx" target="_blank">:aca-plumx:{ .lg .middle }</a>
<a href="https://api.crossref.org/works/10.1016/j.autcon.2024.105467" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1016/j.autcon.2024.105467" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1016/j.autcon.2024.105467" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1016/j.autcon.2024.105467&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1016/j.autcon.2024.105467" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1016/j.autcon.2024.105467&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4398193444" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1016/j.autcon.2024.105467" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1016/j.autcon.2024.105467?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{otto_maiw.2024.CaAQAo3CPS,
      author            = "Jens Otto and Patrick Maiwald",
      title             = "Classification and Automated Quality Assurance of 3D Concrete Printed Surfaces",
      doi               = "10.1016/j.autcon.2024.105467",
      year              = "2024",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">J. Otto  and P. Maiwald, “Classification and Automated Quality Assurance of 3D Concrete Printed Surfaces”, <i>Automation in Construction</i>, vol. 164, p. 105467, 2024, doi: 10.1016/j.autcon.2024.105467.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Otto, Jens, and Patrick Maiwald. “Classification and Automated Quality Assurance of 3D Concrete Printed Surfaces”. <i>Automation in Construction</i> 164 (2024): 105467. https://doi.org/10.1016/j.autcon.2024.105467.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
