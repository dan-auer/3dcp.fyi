...
hide:
    ...
    - tags
    - footer
title: Zhu Wenxuan, Zhu Shidong, Li Wangxin, Zhang Yu, Chen Wannian, Zhang Jinghong, Liu Yaxiong, Zhang Yunsheng, Xia Yijian
description:
tags:
 - concrete
 - manufacturing
...
<a href="https://api.crossref.org/works/10.1016/j.conbuildmat.2023.134153" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1016/j.conbuildmat.2023.134153" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1016/j.conbuildmat.2023.134153" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1016/j.conbuildmat.2023.134153&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1016/j.conbuildmat.2023.134153" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1016/j.conbuildmat.2023.134153&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4388713328" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1016/j.conbuildmat.2023.134153" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1016/j.conbuildmat.2023.134153?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{zhu_zhu_li_zhan.2023.ASotPoMSC,
      author            = "Wenxuan Zhu and Shidong Zhu and Wangxin Li and Yu Zhang and Wannian Chen and Jinghong Zhang and Yaxiong Liu and Yunsheng Zhang and Yijian Xia",
      title             = "A Study on the Printability of Manufactured Sand Concrete",
      doi               = "10.1016/j.conbuildmat.2023.134153",
      year              = "2023",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">W. Zhu, “A Study on the Printability of Manufactured Sand Concrete”, <i>Construction and Building Materials</i>, vol. 409, p. 134153, 2023, doi: 10.1016/j.conbuildmat.2023.134153.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Zhu, Wenxuan, Shidong Zhu, Wangxin Li, Yu Zhang, Wannian Chen, Jinghong Zhang, Yaxiong Liu, Yunsheng Zhang, and Yijian Xia. “A Study on the Printability of Manufactured Sand Concrete”. <i>Construction and Building Materials</i> 409 (2023): 134153. https://doi.org/10.1016/j.conbuildmat.2023.134153.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
