...
hide:
    ...
    - tags
    - footer
title: Li Zhuming, Aslani Farhad
description:
tags:
 - beam
 - cement
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{li_asla.2023.Po3PBaSUSSCCaDM,
      author            = "Zhuming Li and Farhad Aslani",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">Z. Li  and F. Aslani, “Performance of 3D Printed Beams and Slabs Using Self-Sensing Cementitious Composites and DIC Method”, <i>Sensors</i>, vol. 23, no. 20, 2023, doi: 10.3390/s23208486.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Li, Zhuming, and Farhad Aslani. “Performance of 3D Printed Beams and Slabs Using Self-Sensing Cementitious Composites and DIC Method”. <i>Sensors</i> 23, no. 20 (2023). https://doi.org/10.3390/s23208486.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
