...
hide:
    ...
    - tags
    - footer
title: Rehman Asif, Sglavo Vincenzo
description:
tags:
 - cement
 - containment
...
<a href="https://api.crossref.org/works/10.1108/rpj-08-2020-0195" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1108/rpj-08-2020-0195" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1108/rpj-08-2020-0195" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1108/rpj-08-2020-0195&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1108/rpj-08-2020-0195" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1108/rpj-08-2020-0195&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W3195413925" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1108/rpj-08-2020-0195" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1108/rpj-08-2020-0195?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
    Recent advances in 3D printing construction elements have focused on ordinary Portland cement (OPC) concrete using polymeric binders; herein, this study aims to produce the same using pure water. A binder jet printer prototype was used to fabricate specimens that are used to assess geometric and mechanical properties. Two distinct water-based binder formulations, compatible with OPC chemistry and piezoelectric jetting device, were used: pure water and water-polyvinyl alcohol (98:2 w/w) solution. This study examines the effect of binder flow rate on dimensional accuracy. Furthermore, the changes in the mechanical properties over time with hydration have been investigated. Results indicate that the increase in mechanical strength of Portland cement concrete with pure water was consistent; however, it was delayed by the water: PVA (98:2 w/w) solution. Post-curing by water vapor hardened the structure with the removal of layering native to 3DP and decreased infilling porosity by diffusion mechanism. This paper has used pure water jetting for BJT of Portland cement-containing bodies
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{rehm_sgla.2022.3PoPCCB,
      author            = "Asif Ur Rehman and Vincenzo M. Sglavo",
      title             = "3D Printing of Portland-Cement-Containing Bodies",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">A. U. Rehman  and V. M. Sglavo, “3D Printing of Portland-Cement-Containing Bodies”, <i>Rapid Prototyping Journal</i>, vol. 28, no. 2, pp. 197–203, 2022, doi: 10.1108/rpj-08-2020-0195.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Rehman, Asif Ur, and Vincenzo M. Sglavo. “3D Printing of Portland-Cement-Containing Bodies”. <i>Rapid Prototyping Journal</i> 28, no. 2 (2022): 197–203. https://doi.org/10.1108/rpj-08-2020-0195.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
