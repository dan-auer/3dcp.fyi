...
hide:
    ...
    - tags
    - footer
title: Meng Xiangcheng, Zhang Xueqing
description:
tags:
 - analysis
 - case
...
<a href="https://api.crossref.org/works/10.1007/978-3-030-20216-3_41" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1007/978-3-030-20216-3_41" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1007/978-3-030-20216-3_41" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1007/978-3-030-20216-3_41&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1007/978-3-030-20216-3_41" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1007/978-3-030-20216-3_41&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W2951201651" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1007/978-3-030-20216-3_41" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1007/978-3-030-20216-3_41?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{meng_zhan.2020.CSAfDSoC3P,
      author            = "Xiangcheng Meng and Xueqing Zhang",
      title             = "Case-Study-Analysis for Development-Strategies of Construction 3D Printing",
      doi               = "10.1007/978-3-030-20216-3_41",
      year              = "2020",
      volume            = "975",
      pages             = "439--450",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">X. Meng  and X. Zhang, “Case-Study-Analysis for Development-Strategies of Construction 3D Printing”, in <i>Proceedings of the 2019 International Conference on Additive Manufacturing, Modeling Systems and 3D Prototyping</i>,  2020, vol. 975, pp. 439–450. doi: 10.1007/978-3-030-20216-3_41.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Meng, Xiangcheng, and Xueqing Zhang. “Case-Study-Analysis for Development-Strategies of Construction 3D Printing”. In <i>Proceedings of the 2019 International Conference on Additive Manufacturing, Modeling Systems and 3D Prototyping</i>, edited by Massimo di Nicolantonio, Emilio Rossi, and Thomas Alexander, 975:439–50, 2020. https://doi.org/10.1007/978-3-030-20216-3_41.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
