...
hide:
    - navigation
    - tags
title: Elis Ribeiro, Bárbara Rangel, Filipe Brandão, Bruno Figueiredo, Lino Maia, Vanessa Tavares
description:
tags:
 - concrete
 - improvement
...
#:aca-closedaccess:{ .xred '} Improving Natural Ventilation Through 3D Concrete Printing ([2026-01](date/2026/01))
<a href="https://doi.org/10.1007/978-981-95-1822-7_44" title="DOI" target="_blank">:aca-doi:{ .lg .middle } 10.1007/978-981-95-1822-7_44</a>
...
:aca-blank:{ .lg .middle}
    ...
    [`#print`](keyword/print)
    [`#ventilation`](keyword/ventilation)
