...
hide:
    - navigation
    - tags
title: Thomas Fischer, Christiane Herr
description:
tags:
 - concrete
 - customization
...
#[:aca-openaccess:{ .xgreen }](http://papers.cumincad.org/data/works/att/caadria2016_549.pdf) Parametric Customisation of a 3D Concrete Printed Pavilion ([2016-04](date/2016/04))
<a href="https://doi.org/10.52842/conf.caadria.2016.549" title="DOI" target="_blank">:aca-doi:{ .lg .middle } 10.52842/conf.caadria.2016.549</a>

-------------------------

:aca-blank:{ .lg .middle}
      <a href="../../../author/fischer_thomas"><b>Fischer</b> Thomas</a>
