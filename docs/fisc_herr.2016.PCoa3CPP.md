...
hide:
    ...
    - tags
    - footer
title: Fischer Thomas, Herr Christiane
description:
tags:
 - concrete
 - customization
...
<a href="https://api.crossref.org/works/10.52842/conf.caadria.2016.549" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.52842/conf.caadria.2016.549" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.52842/conf.caadria.2016.549" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.52842/conf.caadria.2016.549&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.52842/conf.caadria.2016.549" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.52842/conf.caadria.2016.549&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W3118111868" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.52842/conf.caadria.2016.549" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.52842/conf.caadria.2016.549?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{fisc_herr.2016.PCoa3CPP,
      author            = "Thomas Fischer and Christiane M. Herr",
      title             = "Parametric Customisation of a 3D Concrete Printed Pavilion",
      doi               = "10.52842/conf.caadria.2016.549",
      year              = "2016",
      pages             = "549--558",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">T. Fischer  and C. M. Herr, “Parametric Customisation of a 3D Concrete Printed Pavilion”, in <i>Proceedings of the 21st Conference on Computer Aided Architectural Design Research in Asia (CAADRIA)</i>,  2016, pp. 549–558. doi: 10.52842/conf.caadria.2016.549.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Fischer, Thomas, and Christiane M. Herr. “Parametric Customisation of a 3D Concrete Printed Pavilion”. In <i>Proceedings of the 21st Conference on Computer Aided Architectural Design Research in Asia (CAADRIA)</i>, edited by Sheng-Fen Chien, Seungyeon Choo, Marc Aurel Schnabel, Walaiporn Nakapan, Mi Jeong Kim, and Stanislav Roudavski, 549–58, 2016. https://doi.org/10.52842/conf.caadria.2016.549.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
