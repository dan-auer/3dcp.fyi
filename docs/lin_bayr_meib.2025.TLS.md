...
hide:
    ...
    - tags
    - footer
title: Lin Yuxin, Bayramvand Alireza, Meibodi Mania
description:
tags:
 - concrete
 - couple
...
<a href="https://api.crossref.org/works/10.1007/978-981-96-3433-0_1" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1007/978-981-96-3433-0_1" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1007/978-981-96-3433-0_1" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1007/978-981-96-3433-0_1&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1007/978-981-96-3433-0_1" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1007/978-981-96-3433-0_1&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4409253157" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1007/978-981-96-3433-0_1" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1007/978-981-96-3433-0_1?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{lin_bayr_meib.2025.TLS,
      author            = "Yuxin Lin and Alireza Bayramvand and Mania Aghaei Meibodi",
      title             = "Towards Lightweight Structure: Coupling Topology Optimization with Non-Planar 3D Concrete Printing",
      doi               = "10.1007/978-981-96-3433-0_1",
      year              = "2025",
      pages             = "3--12",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">Y. Lin, A. Bayramvand and M. A. Meibodi, “Towards Lightweight Structure: Coupling Topology Optimization with Non-Planar 3D Concrete Printing”, in <i>Symbiotic Intelligence</i>,  2025, pp. 3–12. doi: 10.1007/978-981-96-3433-0_1.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Lin, Yuxin, Alireza Bayramvand, and Mania Aghaei Meibodi. “Towards Lightweight Structure: Coupling Topology Optimization with Non-Planar 3D Concrete Printing”. In <i>Symbiotic Intelligence</i>, edited by Hua Chai, Ding Wen Bao, Zhe Guo, and Philip F. Yuan, 3–12, 2025. https://doi.org/10.1007/978-981-96-3433-0_1.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
