...
hide:
    - navigation
    - tags
title: Jeero Pandum, Katsufumi Hashimoto, Takafumi Sugiyama, Kota Nakase
description:
tags:
 - acoustic
 - ai
...
# AI-Driven Evaluation of 3D-Printed Concrete:<br/>:aca-blank: Analyzing Printed Patterns Using Impact-Echo and Acoustic Emission ([2025-11](date/2025/11))
-------------------------

:aca-blank:{ .lg .middle}
      <a href="../../../author/pandum_jeero"><b>Pandum</b> Jeero</a>
...
<a href="https://scholar.google.com/scholar_lookup?title=AI-Driven%20Evaluation%20of%203D-Printed%20Concrete" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
