...
hide:
    ...
    - tags
    - footer
title: Chamatete Kunda, Yalçınkaya Çağlar
description:
tags:
 - concrete
 - effect
...
#Numerical Evaluation on Thermal Performance of 3D Printed Concrete Walls&nbsp;([2024-03](date/2024/03))
<div class="h1-like">The Effects of Lattice-Type, Filament-Width and Granular-Filling-Material</div>
<a href="https://www.mdpi.com/2075-5309/14/4/926/pdf?version=1711612084" title="Open Access - Click to Download" target="_blank">:aca-openaccess:{ .xgreen .lg .middle}</a>
 <a href="https://doi.org/10.3390/buildings14040926" title="DOI" target="_blank">:aca-doi:{ .lg .middle }</a> <a href="https://doi.org/10.3390/buildings14040926" target="_blank">10.3390/buildings14040926</a>

<span class="author"><a href="https://orcid.org/0009-0009-4581-0860" title="ORCID: 0009-0009-4581-0860" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/chamatete_kunda"><b>Chamatete</b>&nbsp;Kunda</a></span>, <span class="author"><a href="https://orcid.org/0000-0002-4688-6164" title="ORCID: 0000-0002-4688-6164" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/yalcinkaya_caglar"><b>Yalçınkaya</b>&nbsp;Çağlar</a></span><br>
Journal Article - Buildings, Vol. 14, Iss. 4, No. 926

<a href="../../keyword/concrete"><button class="btn">#concrete</button></a> <a href="../../keyword/effect"><button class="btn">#effect</button></a> <a href="../../keyword/evaluation"><button class="btn">#evaluation</button></a> <a href="../../keyword/filament"><button class="btn">#filament</button></a> <a href="../../keyword/fill"><button class="btn">#fill</button></a> <a href="../../keyword/grain"><button class="btn">#grain</button></a> <a href="../../keyword/lattice"><button class="btn">#lattice</button></a> <a href="../../keyword/material"><button class="btn">#material</button></a> <a href="../../keyword/numeric"><button class="btn">#numeric</button></a> <a href="../../keyword/performance"><button class="btn">#performance</button></a> <a href="../../keyword/print"><button class="btn">#print</button></a> <a href="../../keyword/temperature"><button class="btn">#temperature</button></a> <a href="../../keyword/type"><button class="btn">#type</button></a> <a href="../../keyword/wall"><button class="btn">#wall</button></a> <a href="../../keyword/width"><button class="btn">#width</button></a> 

<a href="https://scholar.google.com/scholar?as_q=numerical+evaluation+on+thermal+performance+of+3d+printed+concrete+walls&as_occt=title&as_sauthors=chamatete&as_ylo=2022&as_yhi=2026&hl=en" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
<a href="https://www.scopus.com/record/display.url?eid=2-s2.0-85191392422&origin=resultslist" title="Search on Scopus" target="_blank">:aca-scopus:{ .lg .middle }</a>
<a href="https://www.webofscience.com/wos/woscc/full-record/WOS:001210486600001" title="Search on Web of Science" target="_blank">:aca-wos:{ .lg .middle }</a>
<a href="https://plu.mx/plum/a/?doi=10.3390/buildings14040926" title="Search on plu.mx" target="_blank">:aca-plumx:{ .lg .middle }</a>
<a href="https://api.crossref.org/works/10.3390/buildings14040926" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.3390/buildings14040926" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.3390/buildings14040926" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.3390/buildings14040926&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.3390/buildings14040926" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.3390/buildings14040926&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4393279536" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.3390/buildings14040926" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.3390/buildings14040926?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{cham_yalc.2024.NEoTPo3PCW,
      author            = "Kunda Chamatete and Çağlar Yalçınkaya",
      title             = "Numerical Evaluation on Thermal Performance of 3D Printed Concrete Walls: The Effects of Lattice-Type, Filament-Width and Granular-Filling-Material",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">K. Chamatete  and Ç. Yalçınkaya, “Numerical Evaluation on Thermal Performance of 3D Printed Concrete Walls: The Effects of Lattice-Type, Filament-Width and Granular-Filling-Material”, <i>Buildings</i>, vol. 14, no. 4, p. 926, 2024, doi: 10.3390/buildings14040926.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Chamatete, Kunda, and Çağlar Yalçınkaya. “Numerical Evaluation on Thermal Performance of 3D Printed Concrete Walls: The Effects of Lattice-Type, Filament-Width and Granular-Filling-Material”. <i>Buildings</i> 14, no. 4 (2024): 926. https://doi.org/10.3390/buildings14040926.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
