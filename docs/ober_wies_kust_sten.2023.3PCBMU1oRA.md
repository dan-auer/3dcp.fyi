...
hide:
    ...
    - tags
    - footer
title: Obermeier Nico, Wiese Felix, Kustermann Andrea, Stengel Thorsten
description:
tags:
 - aggregate
 - base
...
<a href="https://api.crossref.org/works/10.1007/978-3-031-32519-9_63" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1007/978-3-031-32519-9_63" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1007/978-3-031-32519-9_63" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1007/978-3-031-32519-9_63&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1007/978-3-031-32519-9_63" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1007/978-3-031-32519-9_63&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4378878399" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1007/978-3-031-32519-9_63" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1007/978-3-031-32519-9_63?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
    After a couple ofyears ofintensive research and the first realized houses all over the world, 3D printing becomes a more and more important construction technique. However, 3D printing cement-based materials up to now are often based on a huge amount of binder materials and high-quality fine sands. Indeed, most of the realized projects are made of fine-grained mortars. As raw materials and especially high-quality sands are getting less available, it is aim of a research project to use recycled aggregates for 3D printing materials. The present paper gives an overview of fresh and hardened properties using 100% of recycled sand for a 3D printing mortar. The fresh mortar was characterized by a slump, filter press and a penetration test. The paper also summarizes the properties of hardened mortar, i.e., compressive and bending strength.
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{ober_wies_kust_sten.2023.3PCBMU1oRA,
      author            = "Nico Obermeier and Felix Wiese and Andrea Kustermann and Thorsten Stengel",
      title             = "3D Printing Cement-Based Materials Using 100% of Recycled Aggregates",
      doi               = "10.1007/978-3-031-32519-9_63",
      year              = "2023",
      volume            = "349",
      pages             = "648--657",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">N. Obermeier, F. Wiese, A. Kustermann and T. Stengel, “3D Printing Cement-Based Materials Using 100% of Recycled Aggregates”, in <i>Proceedings of the fib Symposium 2023: Building for the Future Durable, Sustainable, Resilient</i>,  2023, vol. 349, pp. 648–657. doi: 10.1007/978-3-031-32519-9_63.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Obermeier, Nico, Felix Wiese, Andrea Kustermann, and Thorsten Stengel. “3D Printing Cement-Based Materials Using 100% of Recycled Aggregates”. In <i>Proceedings of the Fib Symposium 2023: Building for the Future Durable, Sustainable, Resilient</i>, edited by Alper Ilki, Derya Çavunt, and Yavuz Selim Çavunt, 349:648–57, 2023. https://doi.org/10.1007/978-3-031-32519-9_63.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
