...
hide:
    ...
    - tags
    - footer
title: Liu Jianan, Wang Zhenjun, Zhao Xin, Yu Cong, Zhou Xiaowei
description:
tags:
 - adhesion
 - aggregate
...
<a href="https://api.crossref.org/works/10.1016/j.conbuildmat.2022.127022" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1016/j.conbuildmat.2022.127022" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1016/j.conbuildmat.2022.127022" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1016/j.conbuildmat.2022.127022&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1016/j.conbuildmat.2022.127022" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1016/j.conbuildmat.2022.127022&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4221026168" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1016/j.conbuildmat.2022.127022" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1016/j.conbuildmat.2022.127022?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{liu_wang_zhao_yu.2022.QEoIoASToIAU3PA,
      author            = "Jianan Liu and Zhenjun Wang and Xin Zhao and Cong Yu and Xiaowei Zhou",
      title             = "Quantitative Evaluations on Influences of Aggregate Surface Texture on Interfacial Adhesion Using 3D Printing Aggregate",
      doi               = "10.1016/j.conbuildmat.2022.127022",
      year              = "2022",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">J. Liu, Z. Wang, X. Zhao, C. Yu and X. Zhou, “Quantitative Evaluations on Influences of Aggregate Surface Texture on Interfacial Adhesion Using 3D Printing Aggregate”, <i>Construction and Building Materials</i>, vol. 328, 2022, doi: 10.1016/j.conbuildmat.2022.127022.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Liu, Jianan, Zhenjun Wang, Xin Zhao, Cong Yu, and Xiaowei Zhou. “Quantitative Evaluations on Influences of Aggregate Surface Texture on Interfacial Adhesion Using 3D Printing Aggregate”. <i>Construction and Building Materials</i> 328 (2022). https://doi.org/10.1016/j.conbuildmat.2022.127022.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
