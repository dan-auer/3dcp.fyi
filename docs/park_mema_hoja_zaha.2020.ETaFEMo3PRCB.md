...
hide:
    - navigation
    - tags
title: Keunhyoung Park, Ali Memari, Maryam Hojati, Mehrzad Zahabi, Shadi Nazarian, José Duarte
description:
tags:
 - beam
 - concrete
...
:aca-blank:{ .lg .middle}
    Contribution - Proceedings of the 5th Residential Building Design & Construction, pp. (None,)
...
<a href="https://scholar.google.com/scholar_lookup?title=Experimental%20Testing%20and%20Finite%20Element%20Modeling%20of%203D%20Printed%20Reinforced%20Concrete%20Beams" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
