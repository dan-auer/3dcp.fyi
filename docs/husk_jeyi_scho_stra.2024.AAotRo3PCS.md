...
hide:
    - navigation
    - tags
title: Götz Hüsken, Olubunmi Jeyifous, Eric Schönsee, Christoph Strangfeld
description:
tags:
 - assessment
 - concrete
...
<a href="https://doi.org/10.24355/dbbs.084-202408150641-0" title="DOI" target="_blank">:aca-doi:{ .lg .middle } 10.24355/dbbs.084-202408150641-0</a>
...
:aca-blank:{ .lg .middle}
    ...
    [`#print`](keyword/print)
    [`#repeatability`](keyword/repeatability)
    [`#structure`](keyword/structure)


-------------------------

<a href="https://scholar.google.com/scholar_lookup?title=An%20Assessment%20of%20the%20Repeatability%20of%203D%20Printed%20Concrete%20Structures" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
