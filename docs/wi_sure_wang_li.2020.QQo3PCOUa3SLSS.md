...
hide:
    ...
    - tags
    - footer
title: Wi Kwangwoo, Suresh Vignesh, Wang Kejin, Li Beiwen, Qin Hantang
description:
tags:
 - clay
 - light
...
<a href="https://api.crossref.org/works/10.1016/j.addma.2019.100987" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1016/j.addma.2019.100987" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1016/j.addma.2019.100987" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1016/j.addma.2019.100987&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1016/j.addma.2019.100987" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1016/j.addma.2019.100987&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W2998717417" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1016/j.addma.2019.100987" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1016/j.addma.2019.100987?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{wi_sure_wang_li.2020.QQo3PCOUa3SLSS,
      author            = "Kwangwoo Wi and Vignesh Suresh and Kejin Wang and Beiwen Li and Hantang Qin",
      title             = "Quantifying Quality of 3D Printed Clay Objects Using a 3D Structured Light Scanning System",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">K. Wi, V. Suresh, K. Wang, B. Li and H. Qin, “Quantifying Quality of 3D Printed Clay Objects Using a 3D Structured Light Scanning System”, <i>Additive Manufacturing</i>, vol. 32, 2020, doi: 10.1016/j.addma.2019.100987.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Wi, Kwangwoo, Vignesh Suresh, Kejin Wang, Beiwen Li, and Hantang Qin. “Quantifying Quality of 3D Printed Clay Objects Using a 3D Structured Light Scanning System”. <i>Additive Manufacturing</i> 32 (2020). https://doi.org/10.1016/j.addma.2019.100987.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
