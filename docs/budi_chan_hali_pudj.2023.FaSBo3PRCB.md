...
hide:
    ...
    - tags
    - footer
title: Budiman Franky, Chandra Jimmy, Halim Alvin, Pudjisuryadi Pamuda
description:
tags:
 - beam
 - behavior
...
<a href="https://api.crossref.org/works/10.9744/ced.25.1.1-9" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.9744/ced.25.1.1-9" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.9744/ced.25.1.1-9" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.9744/ced.25.1.1-9&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.9744/ced.25.1.1-9" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.9744/ced.25.1.1-9&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4364377672" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.9744/ced.25.1.1-9" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.9744/ced.25.1.1-9?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">F. Budiman, J. Chandra, A. Halim and P. Pudjisuryadi, “Flexural and Shear Behavior of 3D Printed Reinforced Concrete Beams: An Experimental Study”, <i>Civil Engineering Dimension</i>, vol. 25, no. 1, pp. 1–9, 2023, doi: 10.9744/ced.25.1.1-9.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Budiman, Franky, Jimmy Chandra, Alvin Halim, and Pamuda Pudjisuryadi. “Flexural and Shear Behavior of 3D Printed Reinforced Concrete Beams: An Experimental Study”. <i>Civil Engineering Dimension</i> 25, no. 1 (2023): 1–9. https://doi.org/10.9744/ced.25.1.1-9.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
