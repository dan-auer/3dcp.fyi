...
hide:
    ...
    - tags
    - footer
title: Wang Jun, Zhang Xuanzheng, Liu Zhenhua, Zhao Jiasheng
description:
tags:
 - bead
 - effect
...
<a href="https://api.crossref.org/works/10.3390/ma17133220" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.3390/ma17133220" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.3390/ma17133220" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.3390/ma17133220&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.3390/ma17133220" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.3390/ma17133220&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4400200117" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.3390/ma17133220" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.3390/ma17133220?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{wang_zhan_liu_zhao.2024.SotEoPPaRMotPo3PGBIM,
      author            = "Jun Wang and Xuanzheng Zhang and Zhenhua Liu and Jiasheng Zhao",
      title             = "Study on the Effects of Printing Process and Reinforcement Materials on the Performance of 3D-Printed Glass Bead Insulation Mortar",
      doi               = "10.3390/ma17133220",
      year              = "2024",
      journal           = "Materials",
      volume            = "17",
      number            = "13",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">J. Wang, X. Zhang, Z. Liu and J. Zhao, “Study on the Effects of Printing Process and Reinforcement Materials on the Performance of 3D-Printed Glass Bead Insulation Mortar”, <i>Materials</i>, vol. 17, no. 13, p. 3220, 2024, doi: 10.3390/ma17133220.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Wang, Jun, Xuanzheng Zhang, Zhenhua Liu, and Jiasheng Zhao. “Study on the Effects of Printing Process and Reinforcement Materials on the Performance of 3D-Printed Glass Bead Insulation Mortar”. <i>Materials</i> 17, no. 13 (2024): 3220. https://doi.org/10.3390/ma17133220.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
