...
hide:
    ...
    - tags
    - footer
title: Mahdy Deena, Sameh Hazem, Fekry Mayar
description:
tags:
 - analysis
 - dome
...
<a href="https://api.crossref.org/works/10.1016/j.istruc.2025.110273" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1016/j.istruc.2025.110273" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1016/j.istruc.2025.110273" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1016/j.istruc.2025.110273&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1016/j.istruc.2025.110273" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1016/j.istruc.2025.110273&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4414477202" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1016/j.istruc.2025.110273" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1016/j.istruc.2025.110273?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{mahd_same_fekr.2025.SSo3PECD,
      author            = "Deena El Mahdy and Hazem Sameh and Mayar Fekry",
      title             = "Structural Stability of 3D-Printed Earthen Catenary Domes: Experimental and Analytical Insights",
      doi               = "10.1016/j.istruc.2025.110273",
      year              = "2025",
      journal           = "Structures",
      volume            = "81",
      pages             = "110273",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">D. E. Mahdy, H. Sameh and M. Fekry, “Structural Stability of 3D-Printed Earthen Catenary Domes: Experimental and Analytical Insights”, <i>Structures</i>, vol. 81, p. 110273, 2025, doi: 10.1016/j.istruc.2025.110273.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Mahdy, Deena El, Hazem Sameh, and Mayar Fekry. “Structural Stability of 3D-Printed Earthen Catenary Domes: Experimental and Analytical Insights”. <i>Structures</i> 81 (2025): 110273. https://doi.org/10.1016/j.istruc.2025.110273.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
