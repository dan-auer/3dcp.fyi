...
hide:
    ...
    - tags
    - footer
title: Romani Alessia, Levi Marinella
description:
tags:
 - additive
 - application
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{roma_levi.2024.LFMEAMfCEP,
      author            = "Alessia Romani and Marinella Levi",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">A. Romani  and M. Levi, “Large-Format Material-Extrusion Additive Manufacturing for Circular Economy Practices: A Focus on Product-Applications with Materials from Recycled Plastics and Biomass-Waste”, <i>Sustainability</i>, vol. 16, no. 18, p. 7966, 2024, doi: 10.3390/su16187966.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Romani, Alessia, and Marinella Levi. “Large-Format Material-Extrusion Additive Manufacturing for Circular Economy Practices: A Focus on Product-Applications with Materials from Recycled Plastics and Biomass-Waste”. <i>Sustainability</i> 16, no. 18 (2024): 7966. https://doi.org/10.3390/su16187966.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
