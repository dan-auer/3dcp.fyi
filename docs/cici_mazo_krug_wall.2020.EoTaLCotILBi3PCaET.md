...
hide:
    - navigation
    - tags
title: Antonio Cicione, K. Mazolwana, Jacques Kruger, Richard Walls, Zara Sander, Gideon Zijl
description:
tags:
 - bond
 - concrete
...
#:aca-closedaccess:{ .xred '} Effect of Transverse and Longitudinal Confinement on the Inter-Layer Bond in 3D Printed Concrete at Elevated Temperatures:<br/>:aca-blank: An Experimental Study ([2020-12](date/2020/12))
<a href="https://doi.org/10.14264/d006b39" title="DOI" target="_blank">:aca-doi:{ .lg .middle } 10.14264/d006b39</a>
...
,     <a href="../../../author/mazolwana_k"><b>Mazolwana</b> K.</a>
...
,     <a href="../../../author/sander_zara"><b>Sander</b> Zara</a>
...
:aca-blank:{ .lg .middle}
    Contribution - Proceedings of the 11th International Conference on Structures in Fire, pp. (None,)
...
:aca-blank:{ .lg .middle}
    ...
    [`#inter`](keyword/inter)
    [`#layer`](keyword/layer)
    [`#longitudinal`](keyword/longitudinal)
    [`#print`](keyword/print)
    [`#temperature`](keyword/temperature)
    [`#transversal`](keyword/transversal)
