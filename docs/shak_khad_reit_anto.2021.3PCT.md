...
hide:
    - navigation
    - tags
title: Aya Shaker, Noor Khader, Lex Reiter, Ana-Maria Anton
description:
tags:
 - concrete
 - print
...
#[:aca-openaccess:{ .xgreen }](http://papers.cumincad.org/data/works/att/acadia21_420.pdf) 3D Printed Concrete Tectonics ([2021-11](date/2021/11))
<a href="https://doi.org/10.52842/conf.acadia.2021.420" title="DOI" target="_blank">:aca-doi:{ .lg .middle } 10.52842/conf.acadia.2021.420</a>

-------------------------

:aca-blank:{ .lg .middle}
      <a href="../../../author/shaker_aya"><b>Shaker</b> Aya</a>
