...
hide:
    ...
    - tags
    - footer
title: Westerlind Helena, Vargas José, Silfwerbrand Johan
description:
tags:
 - application
 - bearing
...
<a href="https://api.crossref.org/works/10.2478/ncr-2023-0011" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.2478/ncr-2023-0011" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.2478/ncr-2023-0011" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.2478/ncr-2023-0011&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.2478/ncr-2023-0011" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.2478/ncr-2023-0011&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4390642226" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.2478/ncr-2023-0011" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.2478/ncr-2023-0011?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{west_varg_silf.2023.TtAoMi3CP,
      author            = "Helena Westerlind and José Hernández Vargas and Johan Silfwerbrand",
      title             = "Towards the Application of Mesostructures in 3D Concrete Printing: Evaluating Load-bearing Performance",
      doi               = "10.2478/ncr-2023-0011",
      year              = "2023",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">H. Westerlind, J. H. Vargas and J. Silfwerbrand, “Towards the Application of Mesostructures in 3D Concrete Printing: Evaluating Load-bearing Performance”, <i>Nordic Concrete Research</i>, vol. 69, no. 2, pp. 87–100, 2023, doi: 10.2478/ncr-2023-0011.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Westerlind, Helena, José Hernández Vargas, and Johan Silfwerbrand. “Towards the Application of Mesostructures in 3D Concrete Printing: Evaluating Load-bearing Performance”. <i>Nordic Concrete Research</i> 69, no. 2 (2023): 87–100. https://doi.org/10.2478/ncr-2023-0011.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
