...
hide:
    - navigation
    - tags
title: Teng Teng, Yefan Zhi, Masoud Akbarzadeh
description:
tags:
 - additive
 - architecture
...
# Gradient Multimaterial Printing:<br/>:aca-blank: Integrated and Tailored Thermal Insulation Through Gradient Multimaterial Additive Manufacturing for Masonry Architectural Components ([2024-11](date/2024/11))
-------------------------
...
<a href="https://scholar.google.com/scholar_lookup?title=Gradient%20Multimaterial%20Printing" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
