...
hide:
    ...
    - tags
    - footer
title: Wu Dinglue, Luo Qiling, Long Wujian, Zhang Shunxian, Geng Songyuan
description:
tags:
 - advance
 - bond
...
<a href="https://api.crossref.org/works/10.3390/ma17051033" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.3390/ma17051033" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.3390/ma17051033" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.3390/ma17051033&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.3390/ma17051033" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.3390/ma17051033&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4392096922" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.3390/ma17051033" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.3390/ma17051033?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{wu_luo_long_zhan.2024.AC3PwPILBS,
      author            = "Dinglue Wu and Qiling Luo and Wujian Long and Shunxian Zhang and Songyuan Geng",
      title             = "Advancing Construction 3D Printing with Predictive Inter-Layer Bonding Strength: A Stacking Model Paradigm",
      doi               = "10.3390/ma17051033",
      year              = "2024",
      journal           = "Materials",
      volume            = "17",
      number            = "5",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">D. Wu, Q. Luo, W. Long, S. Zhang and S. Geng, “Advancing Construction 3D Printing with Predictive Inter-Layer Bonding Strength: A Stacking Model Paradigm”, <i>Materials</i>, vol. 17, no. 5, p. 1033, 2024, doi: 10.3390/ma17051033.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Wu, Dinglue, Qiling Luo, Wujian Long, Shunxian Zhang, and Songyuan Geng. “Advancing Construction 3D Printing with Predictive Inter-Layer Bonding Strength: A Stacking Model Paradigm”. <i>Materials</i> 17, no. 5 (2024): 1033. https://doi.org/10.3390/ma17051033.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
