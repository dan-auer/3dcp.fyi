...
<a href="https://api.crossref.org/works/10.1007/978-3-031-70031-6_8" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1007/978-3-031-70031-6_8" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1007/978-3-031-70031-6_8" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1007/978-3-031-70031-6_8&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1007/978-3-031-70031-6_8" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1007/978-3-031-70031-6_8&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4402088618" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1007/978-3-031-70031-6_8" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1007/978-3-031-70031-6_8?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{parm_fall_moro_ferr.2024.PSoMFBCUVDFCv3P,
      author            = "Silvia Parmigiani and Devid Falliano and Sandro Moro and Giuseppe Andrea Ferro and Luciana Restuccia",
      title             = "Preliminary Study on Multi-Functional Building Components Utilizing Variable Density Foamed Concrete via 3D Printing",
      doi               = "10.1007/978-3-031-70031-6_8",
      year              = "2024",
      volume            = "53",
      pages             = "65--73",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">S. Parmigiani, D. Falliano, S. Moro, G. A. Ferro and L. Restuccia, “Preliminary Study on Multi-Functional Building Components Utilizing Variable Density Foamed Concrete via 3D Printing”, in <i>Proceedings of the 4th RILEM International Conference on Concrete and Digital Fabrication</i>,  2024, vol. 53, pp. 65–73. doi: 10.1007/978-3-031-70031-6_8.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Parmigiani, Silvia, Devid Falliano, Sandro Moro, Giuseppe Andrea Ferro, and Luciana Restuccia. “Preliminary Study on Multi-Functional Building Components Utilizing Variable Density Foamed Concrete via 3D Printing”. In <i>Proceedings of the 4th RILEM International Conference on Concrete and Digital Fabrication</i>, edited by Dirk Lowke, Niklas Freund, David Böhler, and Friedrich Herding, 53:65–73, 2024. https://doi.org/10.1007/978-3-031-70031-6_8.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
