...
hide:
    ...
    - tags
    - footer
title: Vatandoost Mohsen, McGee Wesley, Buelow Peter
description:
tags:
 - cast
 - concrete
...
#Ultra-Thin-Layered 3D Printed Hollow-Core Sections for Concrete Casting ([2024-08](date/2024/08))
<a href="../../../author/vatandoost_mohsen"><b>Vatandoost</b>&nbsp;Mohsen</a></span>, <span class="author"><a href="https://orcid.org/0000-0002-0456-2460" title="ORCID: 0000-0002-0456-2460" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/mcgee_wesley"><b>McGee</b>&nbsp;Wesley</a></span>, <a href="../../../author/buelow_peter"><b>von&nbsp;Buelow</b>&nbsp;Peter</a></span><br>
Contribution - Proceedings of the International Association for Shell and Spatial Structures Symposium

<a href="../../keyword/cast"><button class="btn">#cast</button></a> <a href="../../keyword/concrete"><button class="btn">#concrete</button></a> <a href="../../keyword/core"><button class="btn">#core</button></a> <a href="../../keyword/hollow"><button class="btn">#hollow</button></a> <a href="../../keyword/layer"><button class="btn">#layer</button></a> <a href="../../keyword/print"><button class="btn">#print</button></a> <a href="../../keyword/section"><button class="btn">#section</button></a> <a href="../../keyword/thin"><button class="btn">#thin</button></a> 

<a href="https://scholar.google.com/scholar?as_q=ultra-thin-layered+3d+printed+hollow-core+sections+for+concrete+casting&as_occt=title&as_sauthors=vatandoost&as_ylo=2022&as_yhi=2026&hl=en" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{vata_mcge_buel.2024.UTL3PHCSfCC,
      author            = "Mohsen Vatandoost and Wesley McGee and Peter von Buelow",
      title             = "Ultra-Thin-Layered 3D Printed Hollow-Core Sections for Concrete Casting",
      year              = "2024",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">M. Vatandoost, W. McGee and P. von Buelow, “Ultra-Thin-Layered 3D Printed Hollow-Core Sections for Concrete Casting”, in <i>Proceedings of the International Association for Shell and Spatial Structures Symposium: Redefining the Art of Structural Design</i>,  2024.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Vatandoost, Mohsen, Wesley McGee, and Peter von Buelow. “Ultra-Thin-Layered 3D Printed Hollow-Core Sections for Concrete Casting”. In <i>Proceedings of the International Association for Shell and Spatial Structures Symposium: Redefining the Art of Structural Design</i>, edited by Philippe Block, Cathrine de Wolf, Walter Kaufmann, and Jacqueline Pauli, 2024.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
