...
hide:
    - navigation
    - tags
title: Mohsen Vatandoost, Wesley McGee, Peter Buelow
description:
tags:
 - cast
 - concrete
...
:aca-blank:{ .lg .middle}
      <a href="../../../author/vatandoost_mohsen"><b>Vatandoost</b> Mohsen</a>
...
<a href="https://scholar.google.com/scholar_lookup?title=Ultra-Thin-Layered%203D%20Printed%20Hollow-Core%20Sections%20for%20Concrete%20Casting" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
