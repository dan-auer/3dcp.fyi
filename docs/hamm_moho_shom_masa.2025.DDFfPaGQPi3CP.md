...
hide:
    ...
    - tags
    - footer
title: Hammoud Ahmad, Mohomad Yosef, Shomar Hasan, Masad Eyad, Arroyave Raymundo, Tafreshi Reza
description:
tags:
 - concrete
 - data
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">A. Hammoud, Y. Mohomad, H. Shomar, E. Masad, R. Arroyave and R. Tafreshi, “Data-Driven Framework for Printability and Geometric Quality Prediction in 3D Concrete Printing”, <i>Materials & Design</i>, p. 115309, 2025, doi: 10.1016/j.matdes.2025.115309.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Hammoud, Ahmad, Yosef Mohomad, Hasan Shomar, Eyad Masad, Raymundo Arroyave, and Reza Tafreshi. “Data-Driven Framework for Printability and Geometric Quality Prediction in 3D Concrete Printing”. <i>Materials & Design</i>, 2025, 115309. https://doi.org/10.1016/j.matdes.2025.115309.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
