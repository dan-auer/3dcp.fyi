...
hide:
    - navigation
    - tags
title: Uday Boddepalli, Revanth Kandagaddala, Prakash Nanthagopalan
description:
tags:
 - activation
 - alkali
...
:aca-blank:{ .lg .middle}
    Contribution - Proceedings of the 4th International Conference on Sustainable Building Materials, pp. (None,)
...
<a href="https://scholar.google.com/scholar_lookup?title=Evaluation%20of%20Alkali-Activated%20Limestone%20Calcined%20Clay%20Mortars%20for%203D%20Concrete%20Printing%20Applications" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
