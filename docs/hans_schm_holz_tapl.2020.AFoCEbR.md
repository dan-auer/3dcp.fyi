...
hide:
    ...
    - tags
    - footer
title: Hansemann Georg, Schmid Robert, Holzinger Christoph, Tapley Joshua, Kim Hoang, Sliskovic Valentino, Freytag Bernhard, Trummer Andreas, Peters Stefan
description:
tags:
 - additive
 - ceiling
...
<a href="https://api.crossref.org/works/10.2307/j.ctv13xpsvw.20" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.2307/j.ctv13xpsvw.20" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.2307/j.ctv13xpsvw.20" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.2307/j.ctv13xpsvw.20&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.2307/j.ctv13xpsvw.20" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.2307/j.ctv13xpsvw.20&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4239590863" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.2307/j.ctv13xpsvw.20" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.2307/j.ctv13xpsvw.20?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">G. Hansemann, “Additive Fabrication of Concrete Elements by Robots: Lightweight Concrete Ceiling”, in <i>Fabricate 2020</i>,  2020, pp. 124–129. doi: 10.2307/j.ctv13xpsvw.20.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Hansemann, Georg, Robert Schmid, Christoph Holzinger, Joshua Paul Tapley, Hoang Huy Kim, Valentino Sliskovic, Bernhard Freytag, Andreas Trummer, and Stefan Peters. “Additive Fabrication of Concrete Elements by Robots: Lightweight Concrete Ceiling”. In <i>Fabricate 2020</i>, edited by Jane Burry, Jenny Sabin, Bob Sheil, and Marilena Skavara, 124–29, 2020. https://doi.org/10.2307/j.ctv13xpsvw.20.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
