...
hide:
    ...
    - tags
    - footer
title: Ledderose Lukas, Lehmberg Sven, Budelmann Harald, Kloft Harald
description:
tags:
 - alignment
 - assistance
...
<a href="https://api.crossref.org/works/10.1002/best.201800083" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1002/best.201800083" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1002/best.201800083" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1002/best.201800083&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1002/best.201800083" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1002/best.201800083&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W2904509943" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1002/best.201800083" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1002/best.201800083?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{ledd_lehm_bude_klof.2019.RAMAoMFiTWUC,
      author            = "Lukas Ledderose and Sven Lehmberg and Harald Budelmann and Harald Kloft",
      title             = "Robot-Assisted, Magnetic Alignment of Microsteel Fibers in Thin-Walled UHPFRC Components",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">L. Ledderose, S. Lehmberg, H. Budelmann and H. Kloft, “Robot-Assisted, Magnetic Alignment of Microsteel Fibers in Thin-Walled UHPFRC Components”, <i>Beton- und Stahlbetonbau</i>, vol. 114, no. 1, pp. 33–42, 2019, doi: 10.1002/best.201800083.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Ledderose, Lukas, Sven Lehmberg, Harald Budelmann, and Harald Kloft. “Robot-Assisted, Magnetic Alignment of Microsteel Fibers in Thin-Walled UHPFRC Components”. <i>Beton- Und Stahlbetonbau</i> 114, no. 1 (2019): 33–42. https://doi.org/10.1002/best.201800083.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
