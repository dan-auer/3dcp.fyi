...
hide:
    ...
    - tags
    - footer
title: Mehdizadeh Samim, Zimmermann Adrian, Tessmann Oliver
description:
tags:
 - cast
 - concrete
...
<a href="https://api.crossref.org/works/10.1007/978-3-031-13249-0_38" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1007/978-3-031-13249-0_38" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1007/978-3-031-13249-0_38" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1007/978-3-031-13249-0_38&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1007/978-3-031-13249-0_38" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1007/978-3-031-13249-0_38&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4297837669" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1007/978-3-031-13249-0_38" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1007/978-3-031-13249-0_38?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{mehd_zimm_tess.2023.R,
      author            = "Samim Mehdizadeh and Adrian Zimmermann and Oliver Tessmann",
      title             = "RotoColumn: A Continuous Digital Fabrication Framework for Casting Large-Scale Linear Concrete Hollow Elements",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">S. Mehdizadeh, A. Zimmermann and O. Tessmann, “RotoColumn: A Continuous Digital Fabrication Framework for Casting Large-Scale Linear Concrete Hollow Elements”, in <i>Proceedings of the Design Modelling Symposium: Towards Radical Regeneration</i>,  2023, pp. 476–486. doi: 10.1007/978-3-031-13249-0_38.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Mehdizadeh, Samim, Adrian Zimmermann, and Oliver Tessmann. “RotoColumn: A Continuous Digital Fabrication Framework for Casting Large-Scale Linear Concrete Hollow Elements”. In <i>Proceedings of the Design Modelling Symposium: Towards Radical Regeneration</i>, edited by Christoph Gengnagel, Olivier Baverel, Giovanni Betti, Mariana Popescu, Mette Ramsgaard Thomsen, and Jan Wurm, 476–86, 2023. https://doi.org/10.1007/978-3-031-13249-0_38.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
