...
hide:
    ...
    - tags
    - footer
title: Wang Xiaoqi, Liu Xing, Xu Yanling, Cao Jianfu, Zhang Huiyi, Zhang Huajun
description:
tags:
 - adaption
 - algorithm
...
#A General Adaptive Layer Height Continuous Path Planning Algorithm for Concrete 3D Printing of Complex Porous Structures Based on Multi-Objective Optimization and Reinforcement Learning ([2025-08](date/2025/08))
<a title="Closed Access">:aca-closedaccess:{ .xred .lg .middle}</a>
 <a href="https://doi.org/10.1016/j.istruc.2025.109926" title="DOI" target="_blank">:aca-doi:{ .lg .middle }</a> <a href="https://doi.org/10.1016/j.istruc.2025.109926" target="_blank">10.1016/j.istruc.2025.109926</a>

<a href="../../../author/wang_xiaoqi"><b>Wang</b>&nbsp;Xiaoqi</a></span>, <a href="../../../author/liu_xing"><b>Liu</b>&nbsp;Xing</a></span>, <a href="../../../author/xu_yanling"><b>Xu</b>&nbsp;Yanling</a></span>, <a href="../../../author/cao_jianfu"><b>Cao</b>&nbsp;Jianfu</a></span>, <a href="../../../author/zhang_huiyi"><b>Zhang</b>&nbsp;Huiyi</a></span>, <a href="../../../author/zhang_huajun"><b>Zhang</b>&nbsp;Huajun</a></span><br>
Journal Article - Structures, Vol. 80, No. 109926

<a href="../../keyword/adaption"><button class="btn">#adaption</button></a> <a href="../../keyword/algorithm"><button class="btn">#algorithm</button></a> <a href="../../keyword/base"><button class="btn">#base</button></a> <a href="../../keyword/complexity"><button class="btn">#complexity</button></a> <a href="../../keyword/concrete"><button class="btn">#concrete</button></a> <a href="../../keyword/continuous"><button class="btn">#continuous</button></a> <a href="../../keyword/general"><button class="btn">#general</button></a> <a href="../../keyword/height"><button class="btn">#height</button></a> <a href="../../keyword/layer"><button class="btn">#layer</button></a> <a href="../../keyword/learn"><button class="btn">#learn</button></a> <a href="../../keyword/multi"><button class="btn">#multi</button></a> <a href="../../keyword/objective"><button class="btn">#objective</button></a> <a href="../../keyword/optimization"><button class="btn">#optimization</button></a> <a href="../../keyword/path"><button class="btn">#path</button></a> <a href="../../keyword/porosity"><button class="btn">#porosity</button></a> <a href="../../keyword/print"><button class="btn">#print</button></a> <a href="../../keyword/reinforcement"><button class="btn">#reinforcement</button></a> <a href="../../keyword/structure"><button class="btn">#structure</button></a> 

<a href="https://scholar.google.com/scholar?as_q=a+general+adaptive+layer+height+continuous+path+planning+algorithm+for+concrete+3d+printing+of+complex+porous+structures+based+on+multi-objective+optimization+and+reinforcement+learning&as_occt=title&as_sauthors=wang&as_ylo=2023&as_yhi=2027&hl=en" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">X. Wang, X. Liu, Y. Xu, J. Cao, H. Zhang and H. Zhang, “A General Adaptive Layer Height Continuous Path Planning Algorithm for Concrete 3D Printing of Complex Porous Structures Based on Multi-Objective Optimization and Reinforcement Learning”, <i>Structures</i>, vol. 80, p. 109926, 2025, doi: 10.1016/j.istruc.2025.109926.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Wang, Xiaoqi, Xing Liu, Yanling Xu, Jianfu Cao, Huiyi Zhang, and Huajun Zhang. “A General Adaptive Layer Height Continuous Path Planning Algorithm for Concrete 3D Printing of Complex Porous Structures Based on Multi-Objective Optimization and Reinforcement Learning”. <i>Structures</i> 80 (2025): 109926. https://doi.org/10.1016/j.istruc.2025.109926.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
