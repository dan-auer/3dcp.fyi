...
hide:
    ...
    - tags
    - footer
title: Tabakova Vesela, Klug Christina, Schmitz Thomas
description:
tags:
 - clay
 - control
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{taba_klug_schm.2023.DECiSDMfP3CS,
      author            = "Vesela Tabakova and Christina Klug and Thomas H. Schmitz",
      title             = "Dynamic Extrusion-Control in Spot-Deposition Modeling for Porous 3D Clay-Structures",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">V. Tabakova, C. Klug and T. H. Schmitz, “Dynamic Extrusion-Control in Spot-Deposition Modeling for Porous 3D Clay-Structures”, <i>Ceramics</i>, vol. 6, no. 4, pp. 2018–2035, 2023, doi: 10.3390/ceramics6040124.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Tabakova, Vesela, Christina Klug, and Thomas H. Schmitz. “Dynamic Extrusion-Control in Spot-Deposition Modeling for Porous 3D Clay-Structures”. <i>Ceramics</i> 6, no. 4 (2023): 2018–35. https://doi.org/10.3390/ceramics6040124.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
