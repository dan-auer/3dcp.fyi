...
hide:
    ...
    - tags
    - footer
title: Wu Zixia, Xu Yading, Šavija Branko
description:
tags:
 - cement
 - change
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{wu_xu_savi.2021.MPoLCCCIMEPCM,
      author            = "Zixia Wu and Yading Xu and Branko Šavija",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">Z. Wu, Y. Xu and B. Šavija, “Mechanical Properties of Lightweight Cementitious Cellular Composites Incorporating Micro-Encapsulated Phase-Change-Material”, <i>Materials</i>, vol. 14, no. 24, 2021, doi: 10.3390/ma14247586.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Wu, Zixia, Yading Xu, and Branko Šavija. “Mechanical Properties of Lightweight Cementitious Cellular Composites Incorporating Micro-Encapsulated Phase-Change-Material”. <i>Materials</i> 14, no. 24 (2021). https://doi.org/10.3390/ma14247586.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
