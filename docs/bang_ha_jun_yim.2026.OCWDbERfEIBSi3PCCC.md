...
<a href="https://scholar.google.com/scholar?as_q=optimal+casting+window+defined+by+electrical+resistivity+for+enhancing+interfacial+bond+strength+in+3d+printed-cast+concrete+composites&as_occt=title&as_sauthors=bang&as_ylo=2023&as_yhi=2027&hl=en" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
