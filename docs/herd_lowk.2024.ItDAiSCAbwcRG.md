...
hide:
    ...
    - tags
    - footer
title: Herding Friedrich, Lowke Dirk
description:
tags:
 - accuracy
 - activation
...
<a href="https://api.crossref.org/works/10.1007/978-3-031-70031-6_43" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1007/978-3-031-70031-6_43" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1007/978-3-031-70031-6_43" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1007/978-3-031-70031-6_43&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1007/978-3-031-70031-6_43" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1007/978-3-031-70031-6_43&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4402088786" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1007/978-3-031-70031-6_43" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1007/978-3-031-70031-6_43?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{herd_lowk.2024.ItDAiSCAbwcRG,
      author            = "Friedrich Herding and Dirk Lowke",
      title             = "Improving the Dimensional Accuracy in Selective Cement-Activation by w/c-Ratio Gradation",
      doi               = "10.1007/978-3-031-70031-6_43",
      year              = "2024",
      volume            = "53",
      pages             = "370--377",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">F. Herding  and D. Lowke, “Improving the Dimensional Accuracy in Selective Cement-Activation by w/c-Ratio Gradation”, in <i>Proceedings of the 4th RILEM International Conference on Concrete and Digital Fabrication</i>,  2024, vol. 53, pp. 370–377. doi: 10.1007/978-3-031-70031-6_43.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Herding, Friedrich, and Dirk Lowke. “Improving the Dimensional Accuracy in Selective Cement-Activation by w/c-Ratio Gradation”. In <i>Proceedings of the 4th RILEM International Conference on Concrete and Digital Fabrication</i>, edited by Dirk Lowke, Niklas Freund, David Böhler, and Friedrich Herding, 53:370–77, 2024. https://doi.org/10.1007/978-3-031-70031-6_43.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
