...
hide:
    ...
    - tags
    - footer
title: Latorraca Tássia, Guimarães Ana, Rangel Bárbara
description:
tags:
 - analysis
 - base
...
<a href="https://api.crossref.org/works/10.3390/buildings14030802" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.3390/buildings14030802" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.3390/buildings14030802" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.3390/buildings14030802&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.3390/buildings14030802" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.3390/buildings14030802&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4392862462" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.3390/buildings14030802" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.3390/buildings14030802?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{lato_guim_rang.2024.BAoP3PCBMfC,
      author            = "Tássia F. Latorraca and Ana Sofia Guimarães and Bárbara Rangel",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">T. F. Latorraca, A. S. Guimarães and B. Rangel, “Bibliometric Analysis of Personalized 3D Printed Concrete-Based Modules for Construction: Leveraging the Ordinatio Method”, <i>Buildings</i>, vol. 14, no. 3, p. 802, 2024, doi: 10.3390/buildings14030802.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Latorraca, Tássia F., Ana Sofia Guimarães, and Bárbara Rangel. “Bibliometric Analysis of Personalized 3D Printed Concrete-Based Modules for Construction: Leveraging the Ordinatio Method”. <i>Buildings</i> 14, no. 3 (2024): 802. https://doi.org/10.3390/buildings14030802.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
