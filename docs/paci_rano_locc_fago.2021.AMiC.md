...
hide:
    ...
    - tags
    - footer
title: Pacillo Gerardo, Ranocchiai Giovanna, Loccarini Federica, Fagone Mario
description:
tags:
 - additive
 - application
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{paci_rano_locc_fago.2021.AMiC,
      author            = "Gerardo Arcangelo Pacillo and Giovanna Ranocchiai and Federica Loccarini and Mario Fagone",
      title             = "Additive Manufacturing in Construction: A Review on Technologies, Processes, Materials, and Their Applications of 3D and 4D Printing",
      doi               = "10.1002/mdp2.253",
      year              = "2021",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">G. A. Pacillo, G. Ranocchiai, F. Loccarini and M. Fagone, “Additive Manufacturing in Construction: A Review on Technologies, Processes, Materials, and Their Applications of 3D and 4D Printing”, <i>Material Design & Processing Communications</i>, vol. 3, no. 5, 2021, doi: 10.1002/mdp2.253.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Pacillo, Gerardo Arcangelo, Giovanna Ranocchiai, Federica Loccarini, and Mario Fagone. “Additive Manufacturing in Construction: A Review on Technologies, Processes, Materials, and Their Applications of 3D and 4D Printing”. <i>Material Design & Processing Communications</i> 3, no. 5 (2021). https://doi.org/10.1002/mdp2.253.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
