...
hide:
    ...
    - tags
    - footer
title: Albar Abdulrahman, Swash Mohammad, Ghaffar Seyed
description:
tags:
 - cement
 - design
...
<a href="https://api.crossref.org/works/10.1109/ismsit.2019.8932771" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1109/ismsit.2019.8932771" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1109/ismsit.2019.8932771" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1109/ismsit.2019.8932771&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1109/ismsit.2019.8932771" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1109/ismsit.2019.8932771&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W2995448833" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1109/ismsit.2019.8932771" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1109/ismsit.2019.8932771?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{alba_swas_ghaf.2019.TDaDoaESf3PCM,
      author            = "Abdulrahman M. Albar and Mohammad Rafiq Swash and Seyed Hamidreza Ghaffar",
      title             = "The Design and Development of an Extrusion-System for 3D Printing Cementitious Materials",
      doi               = "10.1109/ismsit.2019.8932771",
      year              = "2019",
      pages             = "1--5",
      booktitle         = "Proceedings of the 3rd International Symposium on Multidisciplinary Studies and Innovative Technologies",
    }
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">A. M. Albar, M. R. Swash and S. H. Ghaffar, “The Design and Development of an Extrusion-System for 3D Printing Cementitious Materials”, in <i>Proceedings of the 3rd International Symposium on Multidisciplinary Studies and Innovative Technologies</i>,  2019, pp. 1–5. doi: 10.1109/ismsit.2019.8932771.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Albar, Abdulrahman M., Mohammad Rafiq Swash, and Seyed Hamidreza Ghaffar. “The Design and Development of an Extrusion-System for 3D Printing Cementitious Materials”. In <i>Proceedings of the 3rd International Symposium on Multidisciplinary Studies and Innovative Technologies</i>, 1–5, 2019. https://doi.org/10.1109/ismsit.2019.8932771.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
