...
hide:
    ...
    - tags
    - footer
title: Eugenin Claudia, Cuevas Villalobos Karla, Navarrete Iván
description:
tags:
 - concrete
 - copper
...
<a href="https://api.crossref.org/works/10.1002/cepa.2829" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1002/cepa.2829" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1002/cepa.2829" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1002/cepa.2829&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1002/cepa.2829" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1002/cepa.2829&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4389409153" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1002/cepa.2829" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1002/cepa.2829?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{euge_cuev_nava.2023.TDo3PCPwCT,
      author            = "Claudia Eugenin and Karla Francisca Cuevas Villalobos and Iván Navarrete",
      title             = "Temperature-Dependance of 3D Printed Concrete Produced with Copper-Tailings",
      doi               = "10.1002/cepa.2829",
      year              = "2023",
      journal           = "ce/papers",
      volume            = "6",
      number            = "6",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">C. Eugenin, K. F. C. Villalobos and I. Navarrete, “Temperature-Dependance of 3D Printed Concrete Produced with Copper-Tailings”, <i>ce/papers</i>, vol. 6, no. 6, pp. 802–811, 2023, doi: 10.1002/cepa.2829.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Eugenin, Claudia, Karla Francisca Cuevas Villalobos, and Iván Navarrete. “Temperature-Dependance of 3D Printed Concrete Produced with Copper-Tailings”. <i>Ce/papers</i> 6, no. 6 (2023): 802–11. https://doi.org/10.1002/cepa.2829.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
