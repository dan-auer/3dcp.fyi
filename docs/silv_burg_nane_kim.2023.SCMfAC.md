...
hide:
    - navigation
    - tags
title: Guido Silva, Valeria Burgos, Robert Ñañez, Suyeon Kim, Gaby Ruiz, Miguel Pando, Rafael Aguilar, Javier Nakamatsu
description:
tags:
 - additive
 - cement
...
#:aca-closedaccess:{ .xred '} Soil-Cement Matrices for Additive Construction:<br/>:aca-blank: 3D Printing System Validation and Printing Tests ([2023-07](date/2023/07))
<a href="https://doi.org/10.4028/p-sc9yi5" title="DOI" target="_blank">:aca-doi:{ .lg .middle } 10.4028/p-sc9yi5</a>
...
<a href="https://scholar.google.com/scholar_lookup?title=Soil-Cement%20Matrices%20for%20Additive%20Construction" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
