...
hide:
    ...
    - tags
    - footer
title: Liu Bing, Cheng Xiao-Ming, Wang Lian-Gang, Qian Kai
description:
tags:
 - bar
 - column
...
<a href="https://api.crossref.org/works/10.1016/j.jobe.2024.111174" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1016/j.jobe.2024.111174" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1016/j.jobe.2024.111174" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1016/j.jobe.2024.111174&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1016/j.jobe.2024.111174" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1016/j.jobe.2024.111174&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4403897529" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1016/j.jobe.2024.111174" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1016/j.jobe.2024.111174?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{liu_chen_wang_qian.2024.CPoPFR3CPPFCCRwBB,
      author            = "Bing Liu and Xiao-Ming Cheng and Lian-Gang Wang and Kai Qian",
      title             = "Compressive Performance of PVA Fiber-Reinforced 3D Concrete Printing Permanent Formwork Composite Columns Reinforced with BFRP-Bars",
      doi               = "10.1016/j.jobe.2024.111174",
      year              = "2024",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">B. Liu, X.-M. Cheng, L.-G. Wang and K. Qian, “Compressive Performance of PVA Fiber-Reinforced 3D Concrete Printing Permanent Formwork Composite Columns Reinforced with BFRP-Bars”, <i>Journal of Building Engineering</i>, p. 111174, 2024, doi: 10.1016/j.jobe.2024.111174.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Liu, Bing, Xiao-Ming Cheng, Lian-Gang Wang, and Kai Qian. “Compressive Performance of PVA Fiber-Reinforced 3D Concrete Printing Permanent Formwork Composite Columns Reinforced with BFRP-Bars”. <i>Journal of Building Engineering</i>, 2024, 111174. https://doi.org/10.1016/j.jobe.2024.111174.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
