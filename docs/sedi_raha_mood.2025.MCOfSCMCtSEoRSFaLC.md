...
hide:
    ...
    - tags
    - footer
title: Sedighi Saeed, Rahai Alireza, Moodi Faramarz
description:
tags:
 - concrete
 - criteria
...
<a href="https://api.crossref.org/works/10.1016/j.rineng.2025.107809" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1016/j.rineng.2025.107809" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1016/j.rineng.2025.107809" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1016/j.rineng.2025.107809&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1016/j.rineng.2025.107809" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1016/j.rineng.2025.107809&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W7092360878" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1016/j.rineng.2025.107809" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1016/j.rineng.2025.107809?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{sedi_raha_mood.2025.MCOfSCMCtSEoRSFaLC,
      author            = "Saeed Sedighi and Alireza Rahai and Faramarz Moodi",
      title             = "Multi-Criteria Optimization for Sustainable Concrete Mix Considering the Synergistic Effect of Recycled Steel Fiber and LC3 Concrete",
      doi               = "10.1016/j.rineng.2025.107809",
      year              = "2025",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">S. Sedighi, A. Rahai and F. Moodi, “Multi-Criteria Optimization for Sustainable Concrete Mix Considering the Synergistic Effect of Recycled Steel Fiber and LC3 Concrete”, <i>Results in Engineering</i>, p. 107809, 2025, doi: 10.1016/j.rineng.2025.107809.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Sedighi, Saeed, Alireza Rahai, and Faramarz Moodi. “Multi-Criteria Optimization for Sustainable Concrete Mix Considering the Synergistic Effect of Recycled Steel Fiber and LC3 Concrete”. <i>Results in Engineering</i>, 2025, 107809. https://doi.org/10.1016/j.rineng.2025.107809.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
