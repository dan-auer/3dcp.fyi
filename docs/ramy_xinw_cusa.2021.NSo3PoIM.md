...
hide:
    ...
    - tags
    - footer
title: Ramyar Elham, Xinwei Z., Cusatis Gianluca
description:
tags:
 - infrastructure
 - material
...
<a href="https://api.crossref.org/works/10.1061/9780784483374.115" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1061/9780784483374.115" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1061/9780784483374.115" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1061/9780784483374.115&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1061/9780784483374.115" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1061/9780784483374.115&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W3163768667" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1061/9780784483374.115" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1061/9780784483374.115?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{ramy_xinw_cusa.2021.NSo3PoIM,
      author            = "Elham Ramyar and Z. Xinwei and Gianluca Cusatis",
      title             = "Numerical Simulation of 3D Printing of Infrastructure Materials",
      doi               = "10.1061/9780784483374.115",
      year              = "2021",
      pages             = "1242--1250",
      booktitle         = "Proceedings of 17th Biennial International Conference on Engineering, Science, Construction, and Operations in Challenging Environments: Space Exploration, Utilization, Engineering, and Construction in Extreme Environments, Earth and Space",
      editor            = "Paul J. van Susante",
    }
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">E. Ramyar, Z. Xinwei and G. Cusatis, “Numerical Simulation of 3D Printing of Infrastructure Materials”, in <i>Proceedings of 17th Biennial International Conference on Engineering, Science, Construction, and Operations in Challenging Environments: Space Exploration, Utilization, Engineering, and Construction in Extreme Environments, Earth and Space</i>,  2021, pp. 1242–1250. doi: 10.1061/9780784483374.115.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Ramyar, Elham, Z. Xinwei, and Gianluca Cusatis. “Numerical Simulation of 3D Printing of Infrastructure Materials”. In <i>Proceedings of 17th Biennial International Conference on Engineering, Science, Construction, and Operations in Challenging Environments: Space Exploration, Utilization, Engineering, and Construction in Extreme Environments, Earth and Space</i>, edited by Paul J. van Susante, 1242–50, 2021. https://doi.org/10.1061/9780784483374.115.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
