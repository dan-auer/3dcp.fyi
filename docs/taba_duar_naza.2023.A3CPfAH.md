...
hide:
    - navigation
    - tags
title: Nusrat Tabassum, José Duarte, Shadi Nazarian
description:
tags:
 - advance
 - affordability
...
# Advancing 3D Concrete Printing for Affordable Housing:<br/>:aca-blank: A Shape Grammar-Based Approach to Print Spanning-Roof Structures ([2023-11](date/2023/11))
-------------------------
...
<a href="https://scholar.google.com/scholar_lookup?title=Advancing%203D%20Concrete%20Printing%20for%20Affordable%20Housing" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
