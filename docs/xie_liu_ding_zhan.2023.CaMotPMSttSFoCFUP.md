...
hide:
    ...
    - tags
    - footer
title: Xie Xiangyu, Liu Xuemei, Ding Faxing, Zhang Lihai
description:
tags:
 - characteristic
 - concrete
...
<a href="https://api.crossref.org/works/10.1016/j.jobe.2023.107693" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1016/j.jobe.2023.107693" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1016/j.jobe.2023.107693" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1016/j.jobe.2023.107693&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1016/j.jobe.2023.107693" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1016/j.jobe.2023.107693&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4386270629" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1016/j.jobe.2023.107693" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1016/j.jobe.2023.107693?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
    The concrete flow under pressure highly depends on the formation of a lubrication layer between the concrete mass and the pipe wall. Though it is widely believed that particle migration under shear flow influences the formation of this layer, the exact mechanism remains unclear. Therefore, a fully coupled computational fluid dynamic - discrete element method (CFD-DEM) model is developed to investigate the dynamic behaviour of the aggregates within the pipe flow and validated via computed tomography (CT) study and aggregate phase segmentation. The characteristics and influencing factors of the particle migration process is examined by the validated model. The sub-spheres method is employed to accurately model the aggregate shapes in the model. It reveals that the uneven distribution of particle collision frequency contributes to radial particle migration and the subsequent formation of the lubrication layer. The extent of particle migration is found to depend on the pipe size, but independent on the flow rate. The methodology and findings of this paper will also be useful for three dimensional (3D) printing concrete.
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{xie_liu_ding_zhan.2023.CaMotPMSttSFoCFUP,
      author            = "Xiangyu Xie and Xuemei Liu and Faxing Ding and Lihai Zhang",
      title             = "Characteristics and Mechanism of the Particle-Migration Subject to the Shear Flow of Concrete Flow Under Pressure",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">X. Xie, X. Liu, F. Ding and L. Zhang, “Characteristics and Mechanism of the Particle-Migration Subject to the Shear Flow of Concrete Flow Under Pressure”, <i>Journal of Building Engineering</i>, p. 107693, 2023, doi: 10.1016/j.jobe.2023.107693.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Xie, Xiangyu, Xuemei Liu, Faxing Ding, and Lihai Zhang. “Characteristics and Mechanism of the Particle-Migration Subject to the Shear Flow of Concrete Flow Under Pressure”. <i>Journal of Building Engineering</i>, 2023, 107693. https://doi.org/10.1016/j.jobe.2023.107693.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
