...
hide:
    - navigation
    - tags
title: Luca Breseghello, Sandro Sanin, Roberto Naboni
description:
tags:
 - concrete
 - design
...
#:aca-closedaccess:{ .xred '} Tool-Path Simulation, Design and Manipulation in Robotic 3D Concrete Printing ([2021-04](date/2021/04))
<a href="https://doi.org/10.52842/conf.caadria.2021.1.623" title="DOI" target="_blank">:aca-doi:{ .lg .middle } 10.52842/conf.caadria.2021.1.623</a>
