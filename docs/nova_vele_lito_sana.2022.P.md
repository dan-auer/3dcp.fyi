...
hide:
    ...
    - tags
    - footer
title: Nováková Kateřina, Vele Jiří, Litoš Jiří, Šána Vladimír
description:
tags:
 - buildability
 - concrete
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{nova_vele_lito_sana.2022.P,
      author            = "Kateřina Nováková and Jiří Vele and Jiří Litoš and Vladimír Šána",
      title             = "Prvok: Issue on 3D Printing Concrete Building",
      doi               = "10.14311/app.2022.38.0247",
      year              = "2022",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">K. Nováková, J. Vele, J. Litoš and V. Šána, “Prvok: Issue on 3D Printing Concrete Building”, <i>Acta Polytechnica</i>, vol. 38, pp. 247–254, 2022, doi: 10.14311/app.2022.38.0247.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Nováková, Kateřina, Jiří Vele, Jiří Litoš, and Vladimír Šána. “Prvok: Issue on 3D Printing Concrete Building”. <i>Acta Polytechnica</i> 38 (2022): 247–54. https://doi.org/10.14311/app.2022.38.0247.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
