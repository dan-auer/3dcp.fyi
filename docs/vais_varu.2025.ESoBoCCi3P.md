...
hide:
    ...
    - tags
    - footer
title: Vaishali Panneer, Varunkumar P.
description:
tags:
 - behavior
 - cement
...
<a href="https://api.crossref.org/works/10.1007/978-981-97-7043-4_13" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1007/978-981-97-7043-4_13" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1007/978-981-97-7043-4_13" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1007/978-981-97-7043-4_13&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1007/978-981-97-7043-4_13" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1007/978-981-97-7043-4_13&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4404253237" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1007/978-981-97-7043-4_13" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1007/978-981-97-7043-4_13?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{vais_varu.2025.ESoBoCCi3P,
      author            = "Panneer Vaishali and P. Varunkumar",
      title             = "Experimental Study on Behavior of Cement Concrete in 3d Printing",
      doi               = "10.1007/978-981-97-7043-4_13",
      year              = "2025",
      volume            = "550",
      pages             = "133--142",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">P. Vaishali  and P. Varunkumar, “Experimental Study on Behavior of Cement Concrete in 3d Printing”, in <i>Recent Developments in Structural Engineering</i>,  2025, vol. 550, pp. 133–142. doi: 10.1007/978-981-97-7043-4_13.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Vaishali, Panneer, and P. Varunkumar. “Experimental Study on Behavior of Cement Concrete in 3d Printing”. In <i>Recent Developments in Structural Engineering</i>, edited by Manmohan Dass Goel, Rahul Biswas, and Sonal Dhanvijay, 550:133–42, 2025. https://doi.org/10.1007/978-981-97-7043-4_13.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
