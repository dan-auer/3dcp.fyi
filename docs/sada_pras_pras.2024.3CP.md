...
<a href="https://api.crossref.org/works/10.1007/978-981-99-4049-3_2" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1007/978-981-99-4049-3_2" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1007/978-981-99-4049-3_2" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1007/978-981-99-4049-3_2&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1007/978-981-99-4049-3_2" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1007/978-981-99-4049-3_2&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4387335486" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1007/978-981-99-4049-3_2" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1007/978-981-99-4049-3_2?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
    Cement-based materials are widely used materials in today's construction industry because of its durability and strength. However, there were practical challenges of using them as construction materials such as errors by craftsmen, construction time, and many wastes from construction process. The latest technology is becoming an important key in the construction industry in a near future is 3D printing technology with cement-based materials that can eliminate the practical challenges in terms of the operational cost and the construction time during construction process. This research aims to study the Design for Manufacture and Assembly (DFMA) process of 3D printing technology with cement-based system. The study program includes testing the strength performance of the load-bearing walls with geometric patterns. The results of the research were the DFMA guidelines to minimize the practical challenges and operational costs of construction. The knowledge of applying 3D printing technology using cement-based system was established for developing the DFMA guidelines for small residential houses.
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{sada_pras_pras.2024.3CP,
      author            = "Wannapol Sadakorn and Santirak Prasertsuk and Lapyote Prasittisopin",
      title             = "3D Cement Printing: DFMA Guideline of Patterned Load-Bearing Walls for Small Residential Units",
      doi               = "10.1007/978-981-99-4049-3_2",
      year              = "2024",
      volume            = "369",
      pages             = "19--28",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">W. Sadakorn, S. Prasertsuk and L. Prasittisopin, “3D Cement Printing: DFMA Guideline of Patterned Load-Bearing Walls for Small Residential Units”, in <i>Proceedings of 5th International Conference on Civil Engineering and Architecture</i>,  2024, vol. 369, pp. 19–28. doi: 10.1007/978-981-99-4049-3_2.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Sadakorn, Wannapol, Santirak Prasertsuk, and Lapyote Prasittisopin. “3D Cement Printing: DFMA Guideline of Patterned Load-Bearing Walls for Small Residential Units”. In <i>Proceedings of 5th International Conference on Civil Engineering and Architecture</i>, edited by Thomas Kang, 369:19–28, 2024. https://doi.org/10.1007/978-981-99-4049-3_2.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
