...
hide:
    - navigation
    - tags
title: Prabhat Prem, Darssni Ravichandran, Senthil Kaliyavaradhan, Parukutty Ambily
description:
tags:
 - comparision
 - concrete
...
#:aca-closedaccess:{ .xred '} Comparative Evaluation of Rheological Models for 3D Printable Concrete ([2022-04](date/2022/04))
<a href="https://doi.org/10.1016/j.matpr.2022.04.555" title="DOI" target="_blank">:aca-doi:{ .lg .middle } 10.1016/j.matpr.2022.04.555</a>
...
:aca-blank:{ .lg .middle}
    Journal Article - Materials Today: Proceedings, Vol. 65, Iss. 2, No. (None,)
