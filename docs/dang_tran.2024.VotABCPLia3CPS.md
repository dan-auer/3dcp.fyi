...
<a href="https://api.crossref.org/works/10.1007/978-981-99-7434-4_102" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1007/978-981-99-7434-4_102" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1007/978-981-99-7434-4_102" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1007/978-981-99-7434-4_102&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1007/978-981-99-7434-4_102" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1007/978-981-99-7434-4_102&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4389541557" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1007/978-981-99-7434-4_102" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1007/978-981-99-7434-4_102?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
    3D printing is an advanced technology that is being researched and applied in the construction sector. 3D concrete printing is a technique of generating concrete structures by applying each layer of printing concrete through the control of a robot, hence reducing the amount of human participation in the production process. The adhesion between adjacent layers is one of the indicators used to assess the quality of 3D-printed concrete. Nonetheless, adhesion between printing layers frequently varies with the height of the printed concrete structures. Experiments were conducted on 3D-printed concrete square blocks with a 500mm height and 500mm length. Each layer had a thickness of 10 mm and a width of 20 mm, using the concrete mixture with a water-to-binder ratio of 0.32. The adhesion strength between printed layers was measured using a splitting tensile test according to TCVN 8862:2011 on 28-day 3D-printed concrete samples. According to experimental findings, the bonding between the layers of 3D-printed concrete reduces as the height of the printed concrete block increases.
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{dang_tran.2024.VotABCPLia3CPS,
      author            = "Thi Thuy Hang Dang and Mien van Tran",
      title             = "Variation of the Adhesion Between Concrete Printed Layers in a 3D Concrete Printed Structure",
      doi               = "10.1007/978-981-99-7434-4_102",
      year              = "2024",
      volume            = "442",
      pages             = "971--978",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">T. T. H. Dang  and M. van Tran, “Variation of the Adhesion Between Concrete Printed Layers in a 3D Concrete Printed Structure”, in <i>Proceedings of the 3rd International Conference on Sustainable Civil Engineering and Architecture</i>,  2024, vol. 442, pp. 971–978. doi: 10.1007/978-981-99-7434-4_102.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Dang, Thi Thuy Hang, and Mien van Tran. “Variation of the Adhesion Between Concrete Printed Layers in a 3D Concrete Printed Structure”. In <i>Proceedings of the 3rd International Conference on Sustainable Civil Engineering and Architecture</i>, edited by Junuthula N. Reddy, Chien Ming Wang, Van Hai Louong, and Anh Tuan Le, 442:971–78, 2024. https://doi.org/10.1007/978-981-99-7434-4_102.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
