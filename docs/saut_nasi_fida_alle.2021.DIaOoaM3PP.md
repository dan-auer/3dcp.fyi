...
hide:
    ...
    - tags
    - footer
title: Sauter Andreas, Nasirov Aslan, Fidan Ismail, Allen Michael, Elliott Amy, Cossette Mel, Tackett Ed, Singer Thomas
description:
tags:
 - development
 - implementation
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">A. Sauter, “Development, Implementation and Optimization of a Mobile 3D Printing Platform”, <i>Progress in Additive Manufacturing</i>, vol. 6, no. 2, pp. 231–241, 2021, doi: 10.1007/s40964-020-00154-2.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Sauter, Andreas, Aslan Nasirov, Ismail Fidan, Michael Allen, Amy Elliott, Mel Cossette, Ed Tackett, and Thomas Singer. “Development, Implementation and Optimization of a Mobile 3D Printing Platform”. <i>Progress in Additive Manufacturing</i> 6, no. 2 (2021): 231–41. https://doi.org/10.1007/s40964-020-00154-2.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
