...
<a href="../../keyword/print"><button class="btn">#print (9)</button></a> <a href="../../keyword/cement"><button class="btn">#cement (6)</button></a> <a href="../../keyword/inspiration"><button class="btn">#inspiration (6)</button></a> <a href="../../keyword/performance"><button class="btn">#performance (5)</button></a> <a href="../../keyword/structure"><button class="btn">#structure (5)</button></a> 
