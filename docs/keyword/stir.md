...
<a href="../../keyword/cement"><button class="btn">#cement (2)</button></a> <a href="../../keyword/extrusion"><button class="btn">#extrusion (2)</button></a> <a href="../../keyword/integration"><button class="btn">#integration (2)</button></a> <a href="../../keyword/mixing"><button class="btn">#mixing (2)</button></a> <a href="../../keyword/print"><button class="btn">#print (2)</button></a> 
