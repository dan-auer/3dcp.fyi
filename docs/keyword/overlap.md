...
<a href="../../keyword/cement"><button class="btn">#cement (2)</button></a> <a href="../../keyword/print"><button class="btn">#print (2)</button></a> <a href="../../keyword/durability"><button class="btn">#durability (1)</button></a> <a href="../../keyword/mortar"><button class="btn">#mortar (1)</button></a> <a href="../../keyword/parameter"><button class="btn">#parameter (1)</button></a> 
