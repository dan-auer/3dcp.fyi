...
<a href="../../keyword/buildability"><button class="btn">#buildability (2)</button></a> <a href="../../keyword/hybrid"><button class="btn">#hybrid (2)</button></a> <a href="../../keyword/print"><button class="btn">#print (2)</button></a> <a href="../../keyword/structure"><button class="btn">#structure (2)</button></a> <a href="../../keyword/workforce"><button class="btn">#workforce (2)</button></a> 
