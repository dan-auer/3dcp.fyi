...
<a href="../../keyword/base"><button class="btn">#base (2)</button></a> <a href="../../keyword/performance"><button class="btn">#performance (2)</button></a> <a href="../../keyword/printability"><button class="btn">#printability (2)</button></a> <a href="../../keyword/cement"><button class="btn">#cement (1)</button></a> <a href="../../keyword/commercial"><button class="btn">#commercial (1)</button></a> 
