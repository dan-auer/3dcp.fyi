...
<a href="../../keyword/additive"><button class="btn">#additive (2)</button></a> <a href="../../keyword/cement"><button class="btn">#cement (2)</button></a> <a href="../../keyword/manufacturing"><button class="btn">#manufacturing (2)</button></a> <a href="../../keyword/print"><button class="btn">#print (2)</button></a> <a href="../../keyword/geometry"><button class="btn">#geometry (1)</button></a> 
