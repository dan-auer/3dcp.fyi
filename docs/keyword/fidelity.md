...
<a href="../../keyword/print"><button class="btn">#print (3)</button></a> <a href="../../keyword/additive"><button class="btn">#additive (2)</button></a> <a href="../../keyword/cement"><button class="btn">#cement (2)</button></a> <a href="../../keyword/manufacturing"><button class="btn">#manufacturing (2)</button></a> <a href="../../keyword/multi"><button class="btn">#multi (2)</button></a> 
