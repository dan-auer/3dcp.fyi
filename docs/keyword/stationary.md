...
<a href="../../keyword/base"><button class="btn">#base (2)</button></a> <a href="../../keyword/cement"><button class="btn">#cement (2)</button></a> <a href="../../keyword/computer"><button class="btn">#computer (2)</button></a> <a href="../../keyword/paste"><button class="btn">#paste (2)</button></a> <a href="../../keyword/print"><button class="btn">#print (2)</button></a> 
