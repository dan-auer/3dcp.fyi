...
<a href="../../keyword/base"><button class="btn">#base (1)</button></a> <a href="../../keyword/bulkley"><button class="btn">#bulkley (1)</button></a> <a href="../../keyword/concrete"><button class="btn">#concrete (1)</button></a> <a href="../../keyword/model"><button class="btn">#model (1)</button></a> <a href="../../keyword/print"><button class="btn">#print (1)</button></a> 
