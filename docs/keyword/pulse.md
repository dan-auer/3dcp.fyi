...
<a href="../../keyword/print"><button class="btn">#print (2)</button></a> <a href="../../keyword/ultrasonic"><button class="btn">#ultrasonic (2)</button></a> <a href="../../keyword/velocity"><button class="btn">#velocity (2)</button></a> <a href="../../keyword/cement"><button class="btn">#cement (1)</button></a> <a href="../../keyword/performance"><button class="btn">#performance (1)</button></a> 
