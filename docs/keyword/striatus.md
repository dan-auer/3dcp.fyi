...
<a href="../../keyword/bridge"><button class="btn">#bridge (2)</button></a> <a href="../../keyword/concrete"><button class="btn">#concrete (2)</button></a> <a href="../../keyword/masonry"><button class="btn">#masonry (2)</button></a> <a href="../../keyword/print"><button class="btn">#print (2)</button></a> <a href="../../keyword/structure"><button class="btn">#structure (2)</button></a> 
