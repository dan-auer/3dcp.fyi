...
<a href="../../keyword/print"><button class="btn">#print (3)</button></a> <a href="../../keyword/concrete"><button class="btn">#concrete (2)</button></a> <a href="../../keyword/cement"><button class="btn">#cement (1)</button></a> <a href="../../keyword/reduction"><button class="btn">#reduction (1)</button></a> <a href="../../keyword/result"><button class="btn">#result (1)</button></a> 
