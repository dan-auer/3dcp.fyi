...
<a href="../../keyword/print"><button class="btn">#print (6)</button></a> <a href="../../keyword/buildability"><button class="btn">#buildability (3)</button></a> <a href="../../keyword/concrete"><button class="btn">#concrete (2)</button></a> <a href="../../keyword/energy"><button class="btn">#energy (2)</button></a> <a href="../../keyword/material"><button class="btn">#material (2)</button></a> 
