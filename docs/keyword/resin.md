...
<a href="../../keyword/base"><button class="btn">#base (2)</button></a> <a href="../../keyword/situ"><button class="btn">#situ (2)</button></a> <a href="../../keyword/extrusion"><button class="btn">#extrusion (1)</button></a> <a href="../../keyword/performance"><button class="btn">#performance (1)</button></a> <a href="../../keyword/spray"><button class="btn">#spray (1)</button></a> 
