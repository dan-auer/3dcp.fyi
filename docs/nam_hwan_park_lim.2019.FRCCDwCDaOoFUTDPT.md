...
hide:
    ...
    - tags
    - footer
title: Nam Young, Hwang Young, Park Ji, Lim Yun
description:
tags:
 - cement
 - composite
...
#Fiber-Reinforced Cementitious Composite Design with Controlled Distribution and Orientation of Fibers Using Three-Dimensional Printing Technology ([2019-02](date/2019/02))
:aca-closedaccess:{ .xred .lg .middle} <a href="https://doi.org/10.1016/b978-0-12-815481-6.00004-x" title="DOI" target="_blank">:aca-doi:{ .lg .middle }</a> <a href="https://doi.org/10.1016/b978-0-12-815481-6.00004-x" target="_blank">10.1016/b978-0-12-815481-6.00004-x</a>
...
Contribution - 3D Concrete Printing Technology, pp. 59-72

<a href="../../keyword/cement"><button class="btn">#cement</button></a> <a href="../../keyword/composite"><button class="btn">#composite</button></a> <a href="../../keyword/control"><button class="btn">#control</button></a> <a href="../../keyword/design"><button class="btn">#design</button></a> <a href="../../keyword/dimension"><button class="btn">#dimension</button></a> <a href="../../keyword/distribution"><button class="btn">#distribution</button></a> <a href="../../keyword/fiber"><button class="btn">#fiber</button></a> <a href="../../keyword/orientation"><button class="btn">#orientation</button></a> <a href="../../keyword/print"><button class="btn">#print</button></a> <a href="../../keyword/reinforcement"><button class="btn">#reinforcement</button></a> <a href="../../keyword/technology"><button class="btn">#technology</button></a> <a href="../../keyword/three"><button class="btn">#three</button></a> 

<a href="https://scholar.google.com/scholar_lookup?title=Fiber-Reinforced%20Cementitious%20Composite%20Design%20with%20Controlled%20Distribution%20and%20Orientation%20of%20Fibers%20Using%20Three-Dimensional%20Printing%20Technology" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
<a href="https://www.scopus.com/record/display.url?eid=2-s2.0-85077161681&origin=resultslist" title="Search on Scopus" target="_blank">:aca-scopus:{ .lg .middle }</a>
<a href="https://www.webofscience.com/wos/woscc/full-record/WOS:None" title="Search on Web of Science" target="_blank">:aca-wos:{ .lg .middle }</a>
<a href="https://plu.mx/plum/a/?doi=10.1016/b978-0-12-815481-6.00004-x" title="Search on plu.mx" target="_blank">:aca-plumx:{ .lg .middle }</a>
<a href="https://api.crossref.org/works/10.1016/b978-0-12-815481-6.00004-x" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1016/b978-0-12-815481-6.00004-x" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1016/b978-0-12-815481-6.00004-x" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1016/b978-0-12-815481-6.00004-x&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1016/b978-0-12-815481-6.00004-x" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1016/b978-0-12-815481-6.00004-x&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W2915703839" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1016/b978-0-12-815481-6.00004-x" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1016/b978-0-12-815481-6.00004-x?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{nam_hwan_park_lim.2019.FRCCDwCDaOoFUTDPT,
      author            = "Young Jun Nam and Young Kwang Hwang and Ji Woon Park and Yun Mook Lim",
      title             = "Fiber-Reinforced Cementitious Composite Design with Controlled Distribution and Orientation of Fibers Using Three-Dimensional Printing Technology",
      doi               = "10.1016/b978-0-12-815481-6.00004-x",
      year              = "2019",
      pages             = "59--72",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">Y. J. Nam, Y. K. Hwang, J. W. Park and Y. M. Lim, “Fiber-Reinforced Cementitious Composite Design with Controlled Distribution and Orientation of Fibers Using Three-Dimensional Printing Technology”, in <i>3D Concrete Printing Technology: Construction and Building Applications</i>,  2019, pp. 59–72. doi: 10.1016/b978-0-12-815481-6.00004-x.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Nam, Young Jun, Young Kwang Hwang, Ji Woon Park, and Yun Mook Lim. “Fiber-Reinforced Cementitious Composite Design with Controlled Distribution and Orientation of Fibers Using Three-Dimensional Printing Technology”. In <i>3D Concrete Printing Technology: Construction and Building Applications</i>, edited by Jay Gnananandan Sanjayan, Ali Nazari, and Behzad Nematollahi, 59–72, 2019. https://doi.org/10.1016/b978-0-12-815481-6.00004-x.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
