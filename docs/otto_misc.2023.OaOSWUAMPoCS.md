...
<a href="https://api.crossref.org/works/10.1002/bate.202300021" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1002/bate.202300021" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1002/bate.202300021" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1002/bate.202300021&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1002/bate.202300021" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1002/bate.202300021&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4386380076" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1002/bate.202300021" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1002/bate.202300021?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
    The use of automated manufacturing processes on construction sites is based on the principles of industrial manufacturing with industrial robots. As a result of the construction-specific features, established standards with regard to operational safety and occupational safety can only be applied to a limited extent, although there is an increased potential risk from independently operating construction machines, especially on construction sites. In this context, this essay compiles the most important legal and normative framework conditions in addition to specific basics and the status quo of automated production on construction sites and draws conclusions about the responsibilities and the implementation of protective measures for robotic applications.
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{otto_misc.2023.OaOSWUAMPoCS,
      author            = "Jens Otto and Janik Mischke",
      title             = "Operational and Occupational Safety When Using Automated Manufacturing Processes on Construction Sites: Consideration of Current Legal and Technical Framework Conditions",
      doi               = "10.1002/bate.202300021",
      year              = "2023",
      journal           = "Bautechnik",
      volume            = "100",
      number            = "12",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">J. Otto  and J. Mischke, “Operational and Occupational Safety When Using Automated Manufacturing Processes on Construction Sites: Consideration of Current Legal and Technical Framework Conditions”, <i>Bautechnik</i>, vol. 100, no. 12, pp. 727–741, 2023, doi: 10.1002/bate.202300021.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Otto, Jens, and Janik Mischke. “Operational and Occupational Safety When Using Automated Manufacturing Processes on Construction Sites: Consideration of Current Legal and Technical Framework Conditions”. <i>Bautechnik</i> 100, no. 12 (2023): 727–41. https://doi.org/10.1002/bate.202300021.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
