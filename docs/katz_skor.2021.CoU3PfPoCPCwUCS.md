...
hide:
    ...
    - tags
    - footer
title: Katzer Jacek, Skoratko Aneta
description:
tags:
 - column
 - concept
...
<a href="https://api.crossref.org/works/10.3390/ma14061565" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.3390/ma14061565" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.3390/ma14061565" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.3390/ma14061565&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.3390/ma14061565" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.3390/ma14061565&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W3136634272" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.3390/ma14061565" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.3390/ma14061565?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{katz_skor.2021.CoU3PfPoCPCwUCS,
      author            = "Jacek Katzer and Aneta Skoratko",
      title             = "Concept of Using 3D Printing for Production of Concrete-Plastic Columns with Unconventional Cross-Sections",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">J. Katzer  and A. Skoratko, “Concept of Using 3D Printing for Production of Concrete-Plastic Columns with Unconventional Cross-Sections”, <i>Materials</i>, vol. 14, no. 6, 2021, doi: 10.3390/ma14061565.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Katzer, Jacek, and Aneta Skoratko. “Concept of Using 3D Printing for Production of Concrete-Plastic Columns with Unconventional Cross-Sections”. <i>Materials</i> 14, no. 6 (2021). https://doi.org/10.3390/ma14061565.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
