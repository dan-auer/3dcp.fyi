...
hide:
    ...
    - tags
    - footer
title: Cohen Zach, Carlson Nicholas
description:
tags:
 - column
 - concrete
...
<a href="https://api.crossref.org/works/10.1007/s41693-020-00029-6" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1007/s41693-020-00029-6" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1007/s41693-020-00029-6" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1007/s41693-020-00029-6&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1007/s41693-020-00029-6" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1007/s41693-020-00029-6&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W3021557832" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1007/s41693-020-00029-6" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1007/s41693-020-00029-6?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{cohe_carl.2020.PaP,
      author            = "Zach Cohen and Nicholas Carlson",
      title             = "Piling and Pressing: Towards a Method of 3D Printing Reinforced Concrete Columns",
      doi               = "10.1007/s41693-020-00029-6",
      year              = "2020",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">Z. Cohen  and N. Carlson, “Piling and Pressing: Towards a Method of 3D Printing Reinforced Concrete Columns”, <i>Construction Robotics</i>, vol. 4, no. 1–2, pp. 61–73, 2020, doi: 10.1007/s41693-020-00029-6.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Cohen, Zach, and Nicholas Carlson. “Piling and Pressing: Towards a Method of 3D Printing Reinforced Concrete Columns”. <i>Construction Robotics</i> 4, no. 1-2 (2020): 61–73. https://doi.org/10.1007/s41693-020-00029-6.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
