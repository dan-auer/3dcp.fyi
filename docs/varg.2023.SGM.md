...
#Spatially Graded Modeling&nbsp;([2023-12](date/2023/12))
<div class="h1-like">An Integrated Workflow For 3D Concrete Printing</div>
<a href="https://pdf.blucher.com.br/designproceedings/sigradi2023/437.pdf" title="Open Access - Click to Download" target="_blank">:aca-openaccess:{ .xgreen .lg .middle}</a>
 <a href="https://doi.org/10.5151/sigradi2023-437" title="DOI" target="_blank">:aca-doi:{ .lg .middle }</a> <a href="https://doi.org/10.5151/sigradi2023-437" target="_blank">10.5151/sigradi2023-437</a>

<span class="author"><a href="https://orcid.org/0000-0002-0641-0567" title="ORCID: 0000-0002-0641-0567" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/vargas_hernandez_jose"><b>Vargas</b>&nbsp;José</a></span><br>
Contribution - Proceedings of the XXVIIth SIGraDi Conference

<a href="../../keyword/concrete"><button class="btn">#concrete</button></a> <a href="../../keyword/grade"><button class="btn">#grade</button></a> <a href="../../keyword/integration"><button class="btn">#integration</button></a> <a href="../../keyword/model"><button class="btn">#model</button></a> <a href="../../keyword/print"><button class="btn">#print</button></a> <a href="../../keyword/space"><button class="btn">#space</button></a> <a href="../../keyword/workflow"><button class="btn">#workflow</button></a> 

<a href="https://scholar.google.com/scholar?as_q=spatially+graded+modeling&as_occt=title&as_sauthors=vargas&as_ylo=2021&as_yhi=2025&hl=en" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
<a href="https://www.scopus.com/record/display.url?eid=None&origin=resultslist" title="Search on Scopus" target="_blank">:aca-scopus:{ .lg .middle }</a>
<a href="https://www.webofscience.com/wos/woscc/full-record/WOS:None" title="Search on Web of Science" target="_blank">:aca-wos:{ .lg .middle }</a>
<a href="https://plu.mx/plum/a/?doi=10.5151/sigradi2023-437" title="Search on plu.mx" target="_blank">:aca-plumx:{ .lg .middle }</a>
<a href="https://api.crossref.org/works/10.5151/sigradi2023-437" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.5151/sigradi2023-437" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.5151/sigradi2023-437" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.5151/sigradi2023-437&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.5151/sigradi2023-437" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.5151/sigradi2023-437&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4399774755" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.5151/sigradi2023-437" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.5151/sigradi2023-437?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">J. H. Vargas, “Spatially Graded Modeling: An Integrated Workflow For 3D Concrete Printing”, in <i>Proceedings of the XXVIIth SIGraDi Conference: Accelerated Landscapes</i>,  2023. doi: 10.5151/sigradi2023-437.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Vargas, José Hernández. “Spatially Graded Modeling: An Integrated Workflow For 3D Concrete Printing”. In <i>Proceedings of the XXVIIth SIGraDi Conference: Accelerated Landscapes</i>, edited by Sociedad Iberoamericana de Gráfica Digital, 2023. https://doi.org/10.5151/sigradi2023-437.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
