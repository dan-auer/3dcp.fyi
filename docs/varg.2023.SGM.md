...
#[:aca-openaccess:{ .xgreen }](https://pdf.blucher.com.br/designproceedings/sigradi2023/437.pdf) Spatially Graded Modeling:<br/>:aca-blank: An Integrated Workflow For 3D Concrete Printing ([2023-12](date/2023/12))
<a href="https://doi.org/10.5151/sigradi2023-437" title="DOI" target="_blank">:aca-doi:{ .lg .middle } 10.5151/sigradi2023-437</a>
...
:aca-blank:{ .lg .middle}
    Contribution - Proceedings of the XXVIIth SIGraDi Conference, pp. (None,)
...
<a href="https://scholar.google.com/scholar_lookup?title=Spatially%20Graded%20Modeling" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
