...
hide:
    ...
    - tags
    - footer
title: Ebiloma David, Olatunbosun Olajumoke, Isang Inimbom, Aigbavboa Clinton
description:
tags:
 - assessment
 - concrete
...
<a href="https://api.crossref.org/works/10.14455/isec.2025.12(1).con-22" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.14455/isec.2025.12(1).con-22" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.14455/isec.2025.12(1).con-22" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.14455/isec.2025.12(1).con-22&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.14455/isec.2025.12(1).con-22" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.14455/isec.2025.12(1).con-22&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4416969369" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.14455/isec.2025.12(1).con-22" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.14455/isec.2025.12(1).con-22?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{ebil_olat_isan_aigb.2025.AtEo3PCfSC,
      author            = "David Ojimaojo Ebiloma and Olajumoke Olatunbosun and Inimbom Walter Isang and Clinton Ohis Aigbavboa",
      title             = "Assessing the Effects of 3D-Printed Concrete for Sustainable Construction: The Stakeholders' Perspective",
      doi               = "10.14455/isec.2025.12(1).con-22",
      year              = "2025",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">D. O. Ebiloma, O. Olatunbosun, I. W. Isang and C. O. Aigbavboa, “Assessing the Effects of 3D-Printed Concrete for Sustainable Construction: The Stakeholders' Perspective”, <i>Proceedings of International Structural Engineering and Construction</i>, vol. 12, no. 1, 2025, doi: 10.14455/isec.2025.12(1).con-22.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Ebiloma, David Ojimaojo, Olajumoke Olatunbosun, Inimbom Walter Isang, and Clinton Ohis Aigbavboa. “Assessing the Effects of 3D-Printed Concrete for Sustainable Construction: The Stakeholders' Perspective”. <i>Proceedings of International Structural Engineering and Construction</i> 12, no. 1 (2025). https://doi.org/10.14455/isec.2025.12(1).con-22.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
