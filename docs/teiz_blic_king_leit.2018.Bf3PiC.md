...
hide:
    ...
    - tags
    - footer
title: Teizer Jochen, Blickle Alexander, King Tobias, Leitzbach Olaf, Guenther Daniel, Mattern Hannah, König Markus
description:
tags:
 - bim
 - construction
...
<a href="https://api.crossref.org/works/10.1007/978-3-319-92862-3_26" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1007/978-3-319-92862-3_26" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1007/978-3-319-92862-3_26" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1007/978-3-319-92862-3_26&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1007/978-3-319-92862-3_26" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1007/978-3-319-92862-3_26&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W2890916988" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1007/978-3-319-92862-3_26" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1007/978-3-319-92862-3_26?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{teiz_blic_king_leit.2018.Bf3PiC,
      author            = "Jochen Teizer and Alexander Blickle and Tobias King and Olaf Leitzbach and Daniel Guenther and Hannah Mattern and Markus König",
      title             = "BIM for 3D Printing in Construction",
      doi               = "10.1007/978-3-319-92862-3_26",
      year              = "2018",
      pages             = "421--446",
      booktitle         = "Building Information Modeling",
      editor            = "André Borrmann and Markus König and Christian Koch and Jakob Beetz",
    }
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">J. Teizer, “BIM for 3D Printing in Construction”, in <i>Building Information Modeling</i>,  2018, pp. 421–446. doi: 10.1007/978-3-319-92862-3_26.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Teizer, Jochen, Alexander Blickle, Tobias King, Olaf Leitzbach, Daniel Guenther, Hannah Mattern, and Markus König. “BIM for 3D Printing in Construction”. In <i>Building Information Modeling</i>, edited by André Borrmann, Markus König, Christian Koch, and Jakob Beetz, 421–46, 2018. https://doi.org/10.1007/978-3-319-92862-3_26.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
