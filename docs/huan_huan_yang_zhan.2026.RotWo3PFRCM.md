...
hide:
    ...
    - tags
    - footer
title: Huang Qunyi, Huang Qingyu, Yang Hong, Zhang Jiahang, Wu Yajie
description:
tags:
 - concrete
 - fiber
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{huan_huan_yang_zhan.2026.RotWo3PFRCM,
      author            = "Qunyi Huang and Qingyu Huang and Hong Yang and Jiahang Zhang and Yajie Wu",
      title             = "Research on the Workability of 3D Printed Fiber-Reinforced Concrete Materials",
      doi               = "10.3390/fib14010001",
      year              = "2026",
      journal           = "Fibers",
      volume            = "14",
      number            = "1",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">Q. Huang, Q. Huang, H. Yang, J. Zhang and Y. Wu, “Research on the Workability of 3D Printed Fiber-Reinforced Concrete Materials”, <i>Fibers</i>, vol. 14, no. 1, p. 1, 2026, doi: 10.3390/fib14010001.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Huang, Qunyi, Qingyu Huang, Hong Yang, Jiahang Zhang, and Yajie Wu. “Research on the Workability of 3D Printed Fiber-Reinforced Concrete Materials”. <i>Fibers</i> 14, no. 1 (2026): 1. https://doi.org/10.3390/fib14010001.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
