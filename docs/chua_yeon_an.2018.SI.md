...
hide:
    ...
    - tags
    - footer
title: Chua Chee, Yeong Wai, An Jia
description:
tags:
 - material
 - print
...
<a href="https://api.crossref.org/works/10.3390/ma11040555" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.3390/ma11040555" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.3390/ma11040555" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.3390/ma11040555&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.3390/ma11040555" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.3390/ma11040555&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W2796085292" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.3390/ma11040555" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.3390/ma11040555?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{chua_yeon_an.2018.SI,
      author            = "Chee Kai Chua and Wai Yee Yeong and Jia An",
      title             = "Special Issue: NextGen Materials for 3D Printing",
      doi               = "10.3390/ma11040555",
      year              = "2018",
      journal           = "Materials",
      volume            = "11",
      number            = "4",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">C. K. Chua, W. Y. Yeong and J. An, “Special Issue: NextGen Materials for 3D Printing”, <i>Materials</i>, vol. 11, no. 4, 2018, doi: 10.3390/ma11040555.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Chua, Chee Kai, Wai Yee Yeong, and Jia An. “Special Issue: NextGen Materials for 3D Printing”. <i>Materials</i> 11, no. 4 (2018). https://doi.org/10.3390/ma11040555.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
