...
hide:
    - navigation
    - tags
title: Li Wang, Yuanyuan Hu, Qiao Wang, Tianlong Cui
description:
tags:
 - crack
 - fiber
...
#:aca-closedaccess:{ .xred '} Shrinkage and Cracking Performance of PP/PVA Fiber-Reinforced 3D Printed Mortar ([2023-03](date/2023/03))
<a href="https://doi.org/10.1061/jmcee7.mteng-14062" title="DOI" target="_blank">:aca-doi:{ .lg .middle } 10.1061/jmcee7.mteng-14062</a>
...
:aca-blank:{ .lg .middle}
    Journal Article - Journal of Materials in Civil Engineering, Vol. 35, Iss. 6, No. (None,)
