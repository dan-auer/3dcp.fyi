...
hide:
    ...
    - tags
    - footer
title: Schryver Robin, Cheikh Khadija, Lesage Karel, Yardimci Mert, Schutter Geert
description:
tags:
 - approach
 - base
...
#Numerical Reliability Study Based on Rheological Input for Bingham-Paste-Pumping Using a Finite Volume Approach in OpenFOAM ([2021-09](date/2021/09))
<a href="https://www.mdpi.com/1996-1944/14/17/5011/pdf?version=1630973094" title="Open Access - Click to Download" target="_blank">:aca-openaccess:{ .xgreen .lg .middle}</a>
 <a href="https://doi.org/10.3390/ma14175011" title="DOI" target="_blank">:aca-doi:{ .lg .middle }</a> <a href="https://doi.org/10.3390/ma14175011" target="_blank">10.3390/ma14175011</a>

<span class="author"><a href="https://orcid.org/0000-0003-3941-4385" title="ORCID: 0000-0003-3941-4385" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/schryver_robin"><b>de&nbsp;Schryver</b>&nbsp;Robin</a></span>, <span class="author"><a href="https://orcid.org/0000-0003-3841-3196" title="ORCID: 0000-0003-3841-3196" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/cheikh_khadija"><b>el&nbsp;Cheikh</b>&nbsp;Khadija</a></span>, <span class="author"><a href="https://orcid.org/0000-0003-3891-7036" title="ORCID: 0000-0003-3891-7036" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/lesage_karel"><b>Lesage</b>&nbsp;Karel</a></span>, <span class="author"><a href="https://orcid.org/0000-0003-0713-0361" title="ORCID: 0000-0003-0713-0361" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/yardimci_yucel_mert"><b>Yardimci</b>&nbsp;Mert</a></span>, <span class="author"><a href="https://orcid.org/0000-0001-5603-2616" title="ORCID: 0000-0001-5603-2616" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/schutter_geert"><b>de&nbsp;Schutter</b>&nbsp;Geert</a></span><br>
Journal Article - Materials, Vol. 14, Iss. 17

<a href="../../keyword/approach"><button class="btn">#approach</button></a> <a href="../../keyword/base"><button class="btn">#base</button></a> <a href="../../keyword/bingham"><button class="btn">#bingham</button></a> <a href="../../keyword/finite"><button class="btn">#finite</button></a> <a href="../../keyword/numeric"><button class="btn">#numeric</button></a> <a href="../../keyword/paste"><button class="btn">#paste</button></a> <a href="../../keyword/pump"><button class="btn">#pump</button></a> <a href="../../keyword/reliability"><button class="btn">#reliability</button></a> <a href="../../keyword/rheology"><button class="btn">#rheology</button></a> <a href="../../keyword/volume"><button class="btn">#volume</button></a> 

<a href="https://scholar.google.com/scholar?as_q=numerical+reliability+study+based+on+rheological+input+for+bingham-paste-pumping+using+a+finite+volume+approach+in+openfoam&as_occt=title&as_sauthors=schryver&as_ylo=2019&as_yhi=2023&hl=en" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">R. de Schryver, K. E. Cheikh, K. Lesage, M. Y. Yardimci and G. de Schutter, “Numerical Reliability Study Based on Rheological Input for Bingham-Paste-Pumping Using a Finite Volume Approach in OpenFOAM”, <i>Materials</i>, vol. 14, no. 17, 2021, doi: 10.3390/ma14175011.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Schryver, Robin de, Khadija El Cheikh, Karel Lesage, Mert Yücel Yardimci, and Geert de Schutter. “Numerical Reliability Study Based on Rheological Input for Bingham-Paste-Pumping Using a Finite Volume Approach in OpenFOAM”. <i>Materials</i> 14, no. 17 (2021). https://doi.org/10.3390/ma14175011.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
