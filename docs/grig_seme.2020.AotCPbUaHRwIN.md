...
hide:
    ...
    - tags
    - footer
title: Grigoryan Erik, Semenova M.
description:
tags:
 - automation
 - construction
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">E. A. Grigoryan  and M. D. Semenova, “Automation of the Construction Process by Using a Hinged Robot with Interchangeable Nozzles”, <i>Materials Today: Proceedings</i>, vol. 30, pp. 380–387, 2020, doi: 10.1016/j.matpr.2019.12.381.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Grigoryan, Erik A., and M. D. Semenova. “Automation of the Construction Process by Using a Hinged Robot with Interchangeable Nozzles”. <i>Materials Today: Proceedings</i> 30 (2020): 380–87. https://doi.org/10.1016/j.matpr.2019.12.381.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
