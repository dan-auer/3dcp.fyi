...
#Reducing Material and Energy Consumption in Single-Story Buildings Through 3D-Printed Wall Designs ([2025-02](date/2025/02))
<a href="https://doi.org/10.1016/j.enbuild.2025.115497" title="Open Access - Click to Download" target="_blank">:aca-openaccess:{ .xgreen .lg .middle}</a>
 <a href="https://doi.org/10.1016/j.enbuild.2025.115497" title="DOI" target="_blank">:aca-doi:{ .lg .middle }</a> <a href="https://doi.org/10.1016/j.enbuild.2025.115497" target="_blank">10.1016/j.enbuild.2025.115497</a>
...
Journal Article - Energy and Buildings, No. 115497

<a href="../../keyword/buildability"><button class="btn">#buildability</button></a> <a href="../../keyword/consumption"><button class="btn">#consumption</button></a> <a href="../../keyword/design"><button class="btn">#design</button></a> <a href="../../keyword/energy"><button class="btn">#energy</button></a> <a href="../../keyword/material"><button class="btn">#material</button></a> <a href="../../keyword/print"><button class="btn">#print</button></a> <a href="../../keyword/reduction"><button class="btn">#reduction</button></a> <a href="../../keyword/single"><button class="btn">#single</button></a> <a href="../../keyword/wall"><button class="btn">#wall</button></a> 

<a href="https://scholar.google.com/scholar?as_q=reducing+material+and+energy+consumption+in+single-story+buildings+through+3d-printed+wall+designs&as_occt=title&as_sauthors=bayat&as_ylo=2023&as_yhi=2027&hl=en" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
<a href="https://www.scopus.com/record/display.url?eid=2-s2.0-85218454461&origin=resultslist" title="Search on Scopus" target="_blank">:aca-scopus:{ .lg .middle }</a>
<a href="https://www.webofscience.com/wos/woscc/full-record/WOS:001435449500001" title="Search on Web of Science" target="_blank">:aca-wos:{ .lg .middle }</a>
<a href="https://plu.mx/plum/a/?doi=10.1016/j.enbuild.2025.115497" title="Search on plu.mx" target="_blank">:aca-plumx:{ .lg .middle }</a>
<a href="https://api.crossref.org/works/10.1016/j.enbuild.2025.115497" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1016/j.enbuild.2025.115497" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1016/j.enbuild.2025.115497" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1016/j.enbuild.2025.115497&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1016/j.enbuild.2025.115497" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1016/j.enbuild.2025.115497&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4407731170" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1016/j.enbuild.2025.115497" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1016/j.enbuild.2025.115497?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{baya_kash.2025.RMaECiSSBT3PWD,
      author            = "Hamid Bayat and Alireza Kashani",
      title             = "Reducing Material and Energy Consumption in Single-Story Buildings Through 3D-Printed Wall Designs",
      doi               = "10.1016/j.enbuild.2025.115497",
      year              = "2025",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">H. Bayat  and A. Kashani, “Reducing Material and Energy Consumption in Single-Story Buildings Through 3D-Printed Wall Designs”, <i>Energy and Buildings</i>, p. 115497, 2025, doi: 10.1016/j.enbuild.2025.115497.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Bayat, Hamid, and Alireza Kashani. “Reducing Material and Energy Consumption in Single-Story Buildings Through 3D-Printed Wall Designs”. <i>Energy and Buildings</i>, 2025, 115497. https://doi.org/10.1016/j.enbuild.2025.115497.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
