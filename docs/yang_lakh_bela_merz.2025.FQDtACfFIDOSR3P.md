...
#:aca-closedaccess:{ .xred '} From Qualitative Diagnosis to Adaptive Compensation for Filament Imperfections During On-Site Robotic 3D Printing ([2025-09](date/2025/09))
<a href="https://doi.org/10.1109/aim64088.2025.11175861" title="DOI" target="_blank">:aca-doi:{ .lg .middle } 10.1109/aim64088.2025.11175861</a>
...
:aca-blank:{ .lg .middle}
    ...
    [`#imperfection`](keyword/imperfection)
    [`#print`](keyword/print)
