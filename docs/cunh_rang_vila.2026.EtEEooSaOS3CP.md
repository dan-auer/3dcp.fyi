...
hide:
    ...
    - tags
    - footer
title: Cunha Jaime, Rangel Bárbara, Vilas-Boas Rodrigo
description:
tags:
 - buildability
 - construction
...
<a href="https://api.crossref.org/works/10.1007/978-981-95-1818-0_41" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1007/978-981-95-1818-0_41" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1007/978-981-95-1818-0_41" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1007/978-981-95-1818-0_41&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1007/978-981-95-1818-0_41" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1007/978-981-95-1818-0_41&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4417181441" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1007/978-981-95-1818-0_41" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1007/978-981-95-1818-0_41?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{cunh_rang_vila.2026.EtEEooSaOS3CP,
      author            = "Jaime Augusto de Jesus Cunha and Bárbara Rangel and Rodrigo Vilas-Boas",
      title             = "Evaluating the Environmental Efficiency of on-Site and Off-Site 3D Construction Printing: A Roadmap Towards Sustainable Building Practices",
      doi               = "10.1007/978-981-95-1818-0_41",
      year              = "2026",
      volume            = "745",
      pages             = "407--418",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">J. A. de Jesus Cunha, B. Rangel and R. Vilas-Boas, “Evaluating the Environmental Efficiency of on-Site and Off-Site 3D Construction Printing: A Roadmap Towards Sustainable Building Practices”, in <i>Construction, Energy, Environment and Sustainability</i>,  2026, vol. 745, pp. 407–418. doi: 10.1007/978-981-95-1818-0_41.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Jesus Cunha, Jaime Augusto de, Bárbara Rangel, and Rodrigo Vilas-Boas. “Evaluating the Environmental Efficiency of on-Site and Off-Site 3D Construction Printing: A Roadmap Towards Sustainable Building Practices”. In <i>Construction, Energy, Environment and Sustainability</i>, 745:407–18, 2026. https://doi.org/10.1007/978-981-95-1818-0_41.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
