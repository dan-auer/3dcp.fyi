...
#:aca-closedaccess:{ .xred '} Density Gradient Concrete Fabrication with Injection 3D Gypsum Printing ([2024-04](date/2024/04))
<a href="https://doi.org/10.52842/conf.caadria.2024.2.079" title="DOI" target="_blank">:aca-doi:{ .lg .middle } 10.52842/conf.caadria.2024.2.079</a>
