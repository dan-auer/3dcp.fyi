...
hide:
    ...
    - tags
    - footer
title: Gradeci Klodian, Labonnote Nathalie
description:
tags:
 - additive
 - buildability
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">K. Gradeci  and N. Labonnote, “On the Potential of Integrating Building Information Modelling for the Additive Manufacturing of Concrete Structures”, <i>Construction Innovation</i>, vol. 20, no. 3, pp. 321–343, 2019, doi: 10.1108/ci-07-2019-0057.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Gradeci, Klodian, and Nathalie Labonnote. “On the Potential of Integrating Building Information Modelling for the Additive Manufacturing of Concrete Structures”. <i>Construction Innovation</i> 20, no. 3 (2019): 321–43. https://doi.org/10.1108/ci-07-2019-0057.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
