...
hide:
    ...
    - tags
    - footer
title: Ghosh Debalina, Anleu Paula, Pape Yann, Ma Zhonggoue
description:
tags:
 - concrete
 - effect
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">D. Ghosh, P. B. Anleu, Y. L. Pape and Z. J. Ma, “Effect of Inter-Layer-Time-Lapse and Workability-Retention on Printed Concrete Performance”, <i>Journal of Materials in Civil Engineering</i>, vol. 35, no. 10, 2023, doi: 10.1061/jmcee7.mteng-14515.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Ghosh, Debalina, Paula Bran Anleu, Yann Le Pape, and Zhonggoue John Ma. “Effect of Inter-Layer-Time-Lapse and Workability-Retention on Printed Concrete Performance”. <i>Journal of Materials in Civil Engineering</i> 35, no. 10 (2023). https://doi.org/10.1061/jmcee7.mteng-14515.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
