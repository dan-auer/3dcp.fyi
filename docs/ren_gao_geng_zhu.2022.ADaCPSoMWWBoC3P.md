...
hide:
    ...
    - tags
    - footer
title: Ren Chuangnan, Gao Baobin, Geng Chenhui, Zhu Wenjie
description:
tags:
 - assembly
 - base
...
<a href="https://api.crossref.org/works/10.3389/feart.2022.989331" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.3389/feart.2022.989331" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.3389/feart.2022.989331" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.3389/feart.2022.989331&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.3389/feart.2022.989331" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.3389/feart.2022.989331&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4297900927" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.3389/feart.2022.989331" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.3389/feart.2022.989331?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{ren_gao_geng_zhu.2022.ADaCPSoMWWBoC3P,
      author            = "Chuangnan Ren and Baobin Gao and Chenhui Geng and Wenjie Zhu",
      title             = "Assembled Design and Compressive Performance Simulation of Mine Waterproof Wall Based on Concrete 3D Printing",
      doi               = "10.3389/feart.2022.989331",
      year              = "2022",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">C. Ren, B. Gao, C. Geng and W. Zhu, “Assembled Design and Compressive Performance Simulation of Mine Waterproof Wall Based on Concrete 3D Printing”, <i>Frontiers in Earth Science</i>, vol. 10, 2022, doi: 10.3389/feart.2022.989331.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Ren, Chuangnan, Baobin Gao, Chenhui Geng, and Wenjie Zhu. “Assembled Design and Compressive Performance Simulation of Mine Waterproof Wall Based on Concrete 3D Printing”. <i>Frontiers in Earth Science</i> 10 (2022). https://doi.org/10.3389/feart.2022.989331.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
