...
hide:
    ...
    - tags
    - footer
title: Duarte Gonçalo, Brown Nathan, Duarte José
description:
tags:
 - concrete
 - form
...
<a href="https://api.crossref.org/works/10.1016/j.autcon.2024.105590" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1016/j.autcon.2024.105590" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1016/j.autcon.2024.105590" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1016/j.autcon.2024.105590&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1016/j.autcon.2024.105590" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1016/j.autcon.2024.105590&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4400208018" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1016/j.autcon.2024.105590" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1016/j.autcon.2024.105590?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{duar_brow_duar.2024.WfGSaOFaTPi3CPoV,
      author            = "Gonçalo Duarte and Nathan C. Brown and José Pinto Duarte",
      title             = "Workflow for Generating, Simulating, and Optimizing Form and Tool-Path in 3D Concrete Printing of Vaults",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">G. Duarte, N. C. Brown and J. P. Duarte, “Workflow for Generating, Simulating, and Optimizing Form and Tool-Path in 3D Concrete Printing of Vaults”, <i>Automation in Construction</i>, vol. 166, p. 105590, 2024, doi: 10.1016/j.autcon.2024.105590.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Duarte, Gonçalo, Nathan C. Brown, and José Pinto Duarte. “Workflow for Generating, Simulating, and Optimizing Form and Tool-Path in 3D Concrete Printing of Vaults”. <i>Automation in Construction</i> 166 (2024): 105590. https://doi.org/10.1016/j.autcon.2024.105590.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
