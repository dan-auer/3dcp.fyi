...
hide:
    - navigation
    - tags
title: Virama Ekanayaka, André Hürkamp
description:
tags:
 - additive
 - base
...
#[:aca-openaccess:{ .xgreen }](https://onlinelibrary.wiley.com/doi/pdfdirect/10.1002/pamm.202200273) Implementation of a Surrogate-Model for a Novel Path‐Based Finite-Element-Simulation for Additive Manufacturing-Processes in Construction ([2023-03](date/2023/03))
<a href="https://doi.org/10.1002/pamm.202200273" title="DOI" target="_blank">:aca-doi:{ .lg .middle } 10.1002/pamm.202200273</a>
...
:aca-blank:{ .lg .middle}
    Journal Article - Proceedings in Applied Mathematics and Mechanics, Vol. 22, Iss. 1, No. (None,)
