...
hide:
    - navigation
    - tags
title: Johannes Ewerz, Marc-Patrick Pfleger, Elisabeth Radl, Patrick Huber
description:
tags:
 - bond
 - concrete
...
# Concrete 3D Printing and Reinforcement:<br/>:aca-blank: Determination of Bond Strength Through Pull-Out Tests ([2025-06](date/2025/06))
-------------------------

:aca-blank:{ .lg .middle}
      <a href="../../../author/ewerz_johannes"><b>Ewerz</b> Johannes</a>
...
<a href="https://scholar.google.com/scholar_lookup?title=Concrete%203D%20Printing%20and%20Reinforcement" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
