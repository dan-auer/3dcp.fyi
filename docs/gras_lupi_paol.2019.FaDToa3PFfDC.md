...
hide:
    ...
    - tags
    - footer
title: Grassi Giulia, Lupica Spagnolo Sonia, Paoletti Ingrid
description:
tags:
 - climate
 - durability
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{gras_lupi_paol.2019.FaDToa3PFfDC,
      author            = "Giulia Grassi and Sonia Lupica Spagnolo and Ingrid Paoletti",
      title             = "Fabrication and Durability Testing of a 3D Printed Façade for Desert Climates",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">G. Grassi, S. L. Spagnolo and I. Paoletti, “Fabrication and Durability Testing of a 3D Printed Façade for Desert Climates”, <i>Additive Manufacturing</i>, vol. 28, pp. 439–444, 2019, doi: 10.1016/j.addma.2019.05.023.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Grassi, Giulia, Sonia Lupica Spagnolo, and Ingrid Paoletti. “Fabrication and Durability Testing of a 3D Printed Façade for Desert Climates”. <i>Additive Manufacturing</i> 28 (2019): 439–44. https://doi.org/10.1016/j.addma.2019.05.023.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
