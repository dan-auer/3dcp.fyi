...
hide:
    ...
    - tags
    - footer
title: Gierlinger David, Hansemann Georg, Schmid Robert, Trummer Andreas, Peters Stefan
description:
tags:
 - concrete
 - construction
...
<a href="https://api.crossref.org/works/10.1002/bate.70063" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1002/bate.70063" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1002/bate.70063" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1002/bate.70063&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1002/bate.70063" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1002/bate.70063&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/None" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1002/bate.70063" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1002/bate.70063?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{gier_hans_schm_trum.2025.DaCw3CP,
      author            = "David Gierlinger and Georg Hansemann and Robert Schmid and Andreas Trummer and Stefan Peters",
      title             = "Design and Construction with 3D Concrete Printing",
      doi               = "10.1002/bate.70063",
      year              = "2025",
      journal           = "Bautechnik",
    }
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">D. Gierlinger, G. Hansemann, R. Schmid, A. Trummer and S. Peters, “Design and Construction with 3D Concrete Printing”, <i>Bautechnik</i>, 2025, doi: 10.1002/bate.70063.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Gierlinger, David, Georg Hansemann, Robert Schmid, Andreas Trummer, and Stefan Peters. “Design and Construction with 3D Concrete Printing”. <i>Bautechnik</i>, 2025. https://doi.org/10.1002/bate.70063.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
