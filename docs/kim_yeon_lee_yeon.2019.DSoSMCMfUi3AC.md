...
hide:
    ...
    - tags
    - footer
title: Kim Kwan, Yeon Jaeheum, Lee Hee, Yeon Jung
description:
tags:
 - additive
 - cement
...
#Dimensional Stability of SBR-Modified Cementitious Mixtures for Use in 3D Additive Construction ([2019-08](date/2019/08))
<a href="https://www.mdpi.com/2076-3417/9/16/3386/pdf?version=1565965250" title="Open Access - Click to Download" target="_blank">:aca-openaccess:{ .xgreen .lg .middle}</a>
 <a href="https://doi.org/10.3390/app9163386" title="DOI" target="_blank">:aca-doi:{ .lg .middle }</a> <a href="https://doi.org/10.3390/app9163386" target="_blank">10.3390/app9163386</a>

<a href="../../../author/kim_kyu_kwan"><b>Kim</b>&nbsp;Kwan</a></span>, <span class="author"><a href="https://orcid.org/0000-0002-3603-8305" title="ORCID: 0000-0002-3603-8305" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/yeon_jaeheum"><b>Yeon</b>&nbsp;Jaeheum</a></span>, <a href="../../../author/lee_jun_hee"><b>Lee</b>&nbsp;Hee</a></span>, <span class="author"><a href="https://orcid.org/0000-0003-1147-0588" title="ORCID: 0000-0003-1147-0588" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/yeon_heum_jung"><b>Yeon</b>&nbsp;Jung</a></span><br>
Journal Article - Applied Sciences, Vol. 9, Iss. 16

<a href="../../keyword/additive"><button class="btn">#additive</button></a> <a href="../../keyword/cement"><button class="btn">#cement</button></a> <a href="../../keyword/construction"><button class="btn">#construction</button></a> <a href="../../keyword/dimension"><button class="btn">#dimension</button></a> <a href="../../keyword/mixture"><button class="btn">#mixture</button></a> <a href="../../keyword/modification"><button class="btn">#modification</button></a> <a href="../../keyword/stability"><button class="btn">#stability</button></a> <a href="../../keyword/use"><button class="btn">#use</button></a> 

<a href="https://scholar.google.com/scholar?as_q=dimensional+stability+of+sbr-modified+cementitious+mixtures+for+use+in+3d+additive+construction&as_occt=title&as_sauthors=kim&as_ylo=2017&as_yhi=2021&hl=en" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
<a href="https://www.scopus.com/record/display.url?eid=2-s2.0-85070899158&origin=resultslist" title="Search on Scopus" target="_blank">:aca-scopus:{ .lg .middle }</a>
<a href="https://www.webofscience.com/wos/woscc/full-record/WOS:000484444100180" title="Search on Web of Science" target="_blank">:aca-wos:{ .lg .middle }</a>
<a href="https://plu.mx/plum/a/?doi=10.3390/app9163386" title="Search on plu.mx" target="_blank">:aca-plumx:{ .lg .middle }</a>
<a href="https://api.crossref.org/works/10.3390/app9163386" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.3390/app9163386" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.3390/app9163386" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.3390/app9163386&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.3390/app9163386" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.3390/app9163386&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W2969757456" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.3390/app9163386" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.3390/app9163386?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{kim_yeon_lee_yeon.2019.DSoSMCMfUi3AC,
      author            = "Kwan Kyu Kim and Jaeheum Yeon and Hee Jun Lee and Jung Heum Yeon",
      title             = "Dimensional Stability of SBR-Modified Cementitious Mixtures for Use in 3D Additive Construction",
      doi               = "10.3390/app9163386",
      year              = "2019",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">K. K. Kim, J. Yeon, H. J. Lee and J. H. Yeon, “Dimensional Stability of SBR-Modified Cementitious Mixtures for Use in 3D Additive Construction”, <i>Applied Sciences</i>, vol. 9, no. 16, 2019, doi: 10.3390/app9163386.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Kim, Kwan Kyu, Jaeheum Yeon, Hee Jun Lee, and Jung Heum Yeon. “Dimensional Stability of SBR-Modified Cementitious Mixtures for Use in 3D Additive Construction”. <i>Applied Sciences</i> 9, no. 16 (2019). https://doi.org/10.3390/app9163386.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
