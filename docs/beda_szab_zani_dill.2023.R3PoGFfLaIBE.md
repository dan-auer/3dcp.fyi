...
hide:
    ...
    - tags
    - footer
title: Bedarf Patrick, Szabó Anna, Zanini Michele, Dillenburger Benjamin
description:
tags:
 - buildability
 - element
...
<a href="https://api.crossref.org/works/10.1089/3dp.2023.0183" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1089/3dp.2023.0183" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1089/3dp.2023.0183" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1089/3dp.2023.0183&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1089/3dp.2023.0183" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1089/3dp.2023.0183&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4389048378" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1089/3dp.2023.0183" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1089/3dp.2023.0183?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{beda_szab_zani_dill.2023.R3PoGFfLaIBE,
      author            = "Patrick Bedarf and Anna Szabó and Michele Zanini and Benjamin Dillenburger",
      title             = "Robotic 3D Printing of Geopolymer Foam for Lightweight and Insulating Building Elements",
      doi               = "10.1089/3dp.2023.0183",
      year              = "2023",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">P. Bedarf, A. Szabó, M. Zanini and B. Dillenburger, “Robotic 3D Printing of Geopolymer Foam for Lightweight and Insulating Building Elements”, <i>3D Printing and Additive Manufacturing</i>, 2023, doi: 10.1089/3dp.2023.0183.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Bedarf, Patrick, Anna Szabó, Michele Zanini, and Benjamin Dillenburger. “Robotic 3D Printing of Geopolymer Foam for Lightweight and Insulating Building Elements”. <i>3D Printing and Additive Manufacturing</i>, 2023. https://doi.org/10.1089/3dp.2023.0183.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
