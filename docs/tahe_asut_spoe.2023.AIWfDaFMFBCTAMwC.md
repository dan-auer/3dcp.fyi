...
hide:
    ...
    - tags
    - footer
title: Taher Ammar, Aşut Serdar, Spoel Willem
description:
tags:
 - additive
 - buildability
...
<a href="https://api.crossref.org/works/10.3390/buildings13112676" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.3390/buildings13112676" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.3390/buildings13112676" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.3390/buildings13112676&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.3390/buildings13112676" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.3390/buildings13112676&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4387904176" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.3390/buildings13112676" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.3390/buildings13112676?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{tahe_asut_spoe.2023.AIWfDaFMFBCTAMwC,
      author            = "Ammar Taher and Serdar Aşut and Willem van der Spoel",
      title             = "An Integrated Workflow for Designing and Fabricating Multi-Functional Building Components Through Additive Manufacturing with Clay",
      doi               = "10.3390/buildings13112676",
      year              = "2023",
      journal           = "Buildings",
      volume            = "13",
      number            = "11",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">A. Taher, S. Aşut and W. van der Spoel, “An Integrated Workflow for Designing and Fabricating Multi-Functional Building Components Through Additive Manufacturing with Clay”, <i>Buildings</i>, vol. 13, no. 11, p. 2676, 2023, doi: 10.3390/buildings13112676.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Taher, Ammar, Serdar Aşut, and Willem van der Spoel. “An Integrated Workflow for Designing and Fabricating Multi-Functional Building Components Through Additive Manufacturing with Clay”. <i>Buildings</i> 13, no. 11 (2023): 2676. https://doi.org/10.3390/buildings13112676.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
