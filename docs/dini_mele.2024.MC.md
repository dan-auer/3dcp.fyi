...
hide:
    - navigation
    - tags
title: Nancy Diniz, Frank Melendez
description:
tags:
 - clay
 - print
...
# Myco Clay:<br/>:aca-blank: 3D Printing Mycelium and Clay Biocomposites ([2023-11](date/2023/11))
-------------------------

:aca-blank:{ .lg .middle}
      <a href="../../../author/diniz_nancy"><b>Diniz</b> Nancy</a>
...
<a href="https://scholar.google.com/scholar_lookup?title=Myco%20Clay" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
