...
hide:
    ...
    - tags
    - footer
title: Khan Mohammad, Dani Aflah, Lim James, Roy Krishanu
description:
tags:
 - construction
 - feasibility
...
<a href="https://api.crossref.org/works/10.3390/buildings14041084" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.3390/buildings14041084" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.3390/buildings14041084" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.3390/buildings14041084&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.3390/buildings14041084" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.3390/buildings14041084&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4394815067" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.3390/buildings14041084" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.3390/buildings14041084?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{khan_dani_lim_roy.2024.AtFo3PCiNZH,
      author            = "Mohammad S. Khan and Aflah Alamsah Dani and James B. P. Lim and Krishanu Roy",
      title             = "Appraising the Feasibility of 3D Printing Construction in New Zealand Housing",
      doi               = "10.3390/buildings14041084",
      year              = "2024",
      journal           = "Buildings",
      volume            = "14",
      number            = "4",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">M. S. Khan, A. A. Dani, J. B. P. Lim and K. Roy, “Appraising the Feasibility of 3D Printing Construction in New Zealand Housing”, <i>Buildings</i>, vol. 14, no. 4, p. 1084, 2024, doi: 10.3390/buildings14041084.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Khan, Mohammad S., Aflah Alamsah Dani, James B. P. Lim, and Krishanu Roy. “Appraising the Feasibility of 3D Printing Construction in New Zealand Housing”. <i>Buildings</i> 14, no. 4 (2024): 1084. https://doi.org/10.3390/buildings14041084.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
