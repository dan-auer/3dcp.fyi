...
#Effect of Grain-Size and Layer-Thickness on Hardened State Properties in Selective Cement-Activation ([2023-12](date/2023/12))
<a href="https://onlinelibrary.wiley.com/doi/pdfdirect/10.1002/cepa.2816" title="Open Access - Click to Download" target="_blank">:aca-openaccess:{ .xgreen .lg .middle}</a>
 <a href="https://doi.org/10.1002/cepa.2816" title="DOI" target="_blank">:aca-doi:{ .lg .middle }</a> <a href="https://doi.org/10.1002/cepa.2816" target="_blank">10.1002/cepa.2816</a>
...
Journal Article - ce/papers, Vol. 6, Iss. 6, pp. 735-741

<a href="../../keyword/activation"><button class="btn">#activation</button></a> <a href="../../keyword/cement"><button class="btn">#cement</button></a> <a href="../../keyword/effect"><button class="btn">#effect</button></a> <a href="../../keyword/grain"><button class="btn">#grain</button></a> <a href="../../keyword/hardened"><button class="btn">#hardened</button></a> <a href="../../keyword/layer"><button class="btn">#layer</button></a> <a href="../../keyword/property"><button class="btn">#property</button></a> <a href="../../keyword/selective"><button class="btn">#selective</button></a> <a href="../../keyword/size"><button class="btn">#size</button></a> <a href="../../keyword/state"><button class="btn">#state</button></a> <a href="../../keyword/thickness"><button class="btn">#thickness</button></a> 

<a href="https://scholar.google.com/scholar?as_q=effect+of+grain-size+and+layer-thickness+on+hardened+state+properties+in+selective+cement-activation&as_occt=title&as_sauthors=mai+%28n%C3%A9e+dressler%29&as_ylo=2021&as_yhi=2025&hl=en" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
<a href="https://www.scopus.com/record/display.url?eid=None&origin=resultslist" title="Search on Scopus" target="_blank">:aca-scopus:{ .lg .middle }</a>
<a href="https://www.webofscience.com/wos/woscc/full-record/WOS:None" title="Search on Web of Science" target="_blank">:aca-wos:{ .lg .middle }</a>
<a href="https://plu.mx/plum/a/?doi=10.1002/cepa.2816" title="Search on plu.mx" target="_blank">:aca-plumx:{ .lg .middle }</a>
<a href="https://api.crossref.org/works/10.1002/cepa.2816" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1002/cepa.2816" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1002/cepa.2816" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1002/cepa.2816&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1002/cepa.2816" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1002/cepa.2816&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4389409173" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1002/cepa.2816" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1002/cepa.2816?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{mai_herd_lowk.2023.EoGSaLToHSPiSCA,
      author            = "Inka Mai (née Dressler) and Friedrich Herding and Dirk Lowke",
      title             = "Effect of Grain-Size and Layer-Thickness on Hardened State Properties in Selective Cement-Activation",
      doi               = "10.1002/cepa.2816",
      year              = "2023",
      journal           = "ce/papers",
      volume            = "6",
      number            = "6",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">I. M. (née Dressler), F. Herding and D. Lowke, “Effect of Grain-Size and Layer-Thickness on Hardened State Properties in Selective Cement-Activation”, <i>ce/papers</i>, vol. 6, no. 6, pp. 735–741, 2023, doi: 10.1002/cepa.2816.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Dressler), Inka Mai (née, Friedrich Herding, and Dirk Lowke. “Effect of Grain-Size and Layer-Thickness on Hardened State Properties in Selective Cement-Activation”. <i>Ce/papers</i> 6, no. 6 (2023): 735–41. https://doi.org/10.1002/cepa.2816.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
