...
hide:
    - navigation
    - tags
title: Zhixin Liu, Mingyang Li, Teck Wong
description:
tags:
 - configuration
 - form
...
#:aca-closedaccess:{ .xred '} Investigations of Nozzle-Configuration and Process Parameters on Porosity Formation of the 3D Printed Structure ([2022-11](date/2022/11))
<a href="https://doi.org/10.1016/j.matpr.2022.10.205" title="DOI" target="_blank">:aca-doi:{ .lg .middle } 10.1016/j.matpr.2022.10.205</a>
