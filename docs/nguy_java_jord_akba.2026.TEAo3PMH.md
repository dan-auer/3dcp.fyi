...
hide:
    ...
    - tags
    - footer
title: Nguyen Nhat, Javan Kazem, Jordan Adam, Akbarnezhad Ali, Banihashemi Saeed
description:
tags:
 - analysis
 - assessment
...
#Techno-Economic Analysis of 3D Printed Modular Housing&nbsp;([2026-01](date/2026/01))
<div class="h1-like">Productivity, Cost, and Environmental Assessment</div>
 <a href="https://doi.org/10.1016/j.jclepro.2025.147461" title="DOI" target="_blank">:aca-doi:{ .lg .middle }</a> <a href="https://doi.org/10.1016/j.jclepro.2025.147461" target="_blank">10.1016/j.jclepro.2025.147461</a>

<a href="../../../author/nguyen_nhat"><b>Nguyen</b>&nbsp;Nhat</a></span>, <a href="../../../author/javan_kazem"><b>Javan</b>&nbsp;Kazem</a></span>, <a href="../../../author/jordan_adam"><b>Jordan</b>&nbsp;Adam</a></span>, <a href="../../../author/akbarnezhad_ali"><b>Akbarnezhad</b>&nbsp;Ali</a></span>, <span class="author"><a href="https://orcid.org/0000-0002-7438-1235" title="ORCID: 0000-0002-7438-1235" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/banihashemi_saeed"><b>Banihashemi</b>&nbsp;Saeed</a></span><br>
Journal Article - Journal of Cleaner Production, Vol. 539, No. 147461

<a href="../../keyword/analysis"><button class="btn">#analysis</button></a> <a href="../../keyword/assessment"><button class="btn">#assessment</button></a> <a href="../../keyword/cost"><button class="btn">#cost</button></a> <a href="../../keyword/economic"><button class="btn">#economic</button></a> <a href="../../keyword/environment"><button class="btn">#environment</button></a> <a href="../../keyword/house"><button class="btn">#house</button></a> <a href="../../keyword/modular"><button class="btn">#modular</button></a> <a href="../../keyword/print"><button class="btn">#print</button></a> <a href="../../keyword/production"><button class="btn">#production</button></a> 

<a href="https://scholar.google.com/scholar?as_q=techno-economic+analysis+of+3d+printed+modular+housing&as_occt=title&as_sauthors=nguyen&as_ylo=2024&as_yhi=2028&hl=en" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
<a href="https://www.scopus.com/record/display.url?eid=None&origin=resultslist" title="Search on Scopus" target="_blank">:aca-scopus:{ .lg .middle }</a>
<a href="https://www.webofscience.com/wos/woscc/full-record/WOS:None" title="Search on Web of Science" target="_blank">:aca-wos:{ .lg .middle }</a>
<a href="https://plu.mx/plum/a/?doi=10.1016/j.jclepro.2025.147461" title="Search on plu.mx" target="_blank">:aca-plumx:{ .lg .middle }</a>
<a href="https://api.crossref.org/works/10.1016/j.jclepro.2025.147461" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1016/j.jclepro.2025.147461" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1016/j.jclepro.2025.147461" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1016/j.jclepro.2025.147461&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1016/j.jclepro.2025.147461" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1016/j.jclepro.2025.147461&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/None" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1016/j.jclepro.2025.147461" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1016/j.jclepro.2025.147461?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
    The construction sector faces persistent productivity deficits and widening housing shortfalls, particularly in countries such as Australia where build times are lengthening and policy targets for new dwellings are not being met. Modular construction and 3D concrete printing (3DCP) have each been promoted as routes to faster, lower-cost and lower-carbon delivery, yet integrated assessments of their combined application remain scarce. This study presents a techno-economic analysis (TEA) of modular 3D-printed construction (M3DP) for Australian detached housing. Using a 120 m2 Class 1a dwelling as the functional unit, we compare a conventional modular baseline with an M3DP variant in which load-bearing walls are produced by 3DCP and designed to meet National Construction Code structural performance requirements under AS 1170 load combinations. The TEA couples capital and life-cycle costs, construction time, labor hours, material waste and embodied carbon, drawing on Australian price indices, industry cost guides, case-study evidence and peer-reviewed life cycle assessment data. For a representative 2025 cost and carbon setting, M3DP reduces upfront construction cost by around 20–30 % relative to conventional modular construction, shortens construction time by approximately 50–70 %, and cuts material use and embodied emissions by up to ∼40 % and ∼55 %, respectively, while achieving comparable thermal performance when appropriate insulation detailing is adopted. On-site labor demand falls by roughly 80–95 %, implying substantial productivity and safety gains in a constrained labor market. Sensitivity analysis shows that economic viability is most strongly influenced by scale of deployment and material prices; underutilisation of equipment can erode, and in some cases eliminate, the cost advantage. The findings indicate that, where sufficient project pipelines and regulatory pathways can be secured, modular 3D-printed construction offers a high-impact pathway to accelerate housing delivery, enhance affordability and support embodied-carbon reduction in the built environment.
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{nguy_java_jord_akba.2026.TEAo3PMH,
      author            = "Nhat Nguyen and Kazem Javan and Adam Jordan and Ali Akbarnezhad and Saeed Banihashemi",
      title             = "Techno-Economic Analysis of 3D Printed Modular Housing: Productivity, Cost, and Environmental Assessment",
      doi               = "10.1016/j.jclepro.2025.147461",
      year              = "2026",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">N. Nguyen, K. Javan, A. Jordan, A. Akbarnezhad and S. Banihashemi, “Techno-Economic Analysis of 3D Printed Modular Housing: Productivity, Cost, and Environmental Assessment”, <i>Journal of Cleaner Production</i>, vol. 539, p. 147461, 2026, doi: 10.1016/j.jclepro.2025.147461.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Nguyen, Nhat, Kazem Javan, Adam Jordan, Ali Akbarnezhad, and Saeed Banihashemi. “Techno-Economic Analysis of 3D Printed Modular Housing: Productivity, Cost, and Environmental Assessment”. <i>Journal of Cleaner Production</i> 539 (2026): 147461. https://doi.org/10.1016/j.jclepro.2025.147461.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
