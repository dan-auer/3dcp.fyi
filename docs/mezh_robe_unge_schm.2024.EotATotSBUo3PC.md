...
hide:
    ...
    - tags
    - footer
title: Mezhov Alexander, Robens-Radermacher Annika, Unger Jörg, Schmidt Wolfram
description:
tags:
 - buildability
 - concrete
...
#Effect of the Ambient Temperature on the Structural Build-Up of 3D Printed Concrete&nbsp;([2024-09](date/2024/09))
<div class="h1-like">Experimental and Modelling Study</div>
 <a href="https://doi.org/10.24355/dbbs.084-202408170750-0" title="DOI" target="_blank">:aca-doi:{ .lg .middle }</a> <a href="https://doi.org/10.24355/dbbs.084-202408170750-0" target="_blank">10.24355/dbbs.084-202408170750-0</a>

<span class="author"><a href="https://orcid.org/0000-0003-2880-8354" title="ORCID: 0000-0003-2880-8354" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/mezhov_alexander"><b>Mezhov</b>&nbsp;Alexander</a></span>, <span class="author"><a href="https://orcid.org/0000-0001-9653-6085" title="ORCID: 0000-0001-9653-6085" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/robens-radermacher_annika"><b>Robens-Radermacher</b>&nbsp;Annika</a></span>, <span class="author"><a href="https://orcid.org/0000-0003-0035-0951" title="ORCID: 0000-0003-0035-0951" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/unger_f_jorg"><b>Unger</b>&nbsp;Jörg</a></span>, <span class="author"><a href="https://orcid.org/0000-0002-0528-4079" title="ORCID: 0000-0002-0528-4079" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/schmidt_wolfram"><b>Schmidt</b>&nbsp;Wolfram</a></span><br>
Contribution - Supplementary Proceedings of the 4th RILEM International Conference on Concrete and Digital Fabrication

<a href="../../keyword/buildability"><button class="btn">#buildability</button></a> <a href="../../keyword/concrete"><button class="btn">#concrete</button></a> <a href="../../keyword/effect"><button class="btn">#effect</button></a> <a href="../../keyword/experiment"><button class="btn">#experiment</button></a> <a href="../../keyword/model"><button class="btn">#model</button></a> <a href="../../keyword/print"><button class="btn">#print</button></a> <a href="../../keyword/structure"><button class="btn">#structure</button></a> <a href="../../keyword/temperature"><button class="btn">#temperature</button></a> 

<a href="https://scholar.google.com/scholar?as_q=effect+of+the+ambient+temperature+on+the+structural+build-up+of+3d+printed+concrete&as_occt=title&as_sauthors=mezhov&as_ylo=2022&as_yhi=2026&hl=en" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
<a href="https://www.scopus.com/record/display.url?eid=None&origin=resultslist" title="Search on Scopus" target="_blank">:aca-scopus:{ .lg .middle }</a>
<a href="https://www.webofscience.com/wos/woscc/full-record/WOS:None" title="Search on Web of Science" target="_blank">:aca-wos:{ .lg .middle }</a>
<a href="https://plu.mx/plum/a/?doi=10.24355/dbbs.084-202408170750-0" title="Search on plu.mx" target="_blank">:aca-plumx:{ .lg .middle }</a>
<a href="https://api.crossref.org/works/10.24355/dbbs.084-202408170750-0" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.24355/dbbs.084-202408170750-0" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.24355/dbbs.084-202408170750-0" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.24355/dbbs.084-202408170750-0&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.24355/dbbs.084-202408170750-0" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.24355/dbbs.084-202408170750-0&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W6945265094" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.24355/dbbs.084-202408170750-0" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.24355/dbbs.084-202408170750-0?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{mezh_robe_unge_schm.2024.EotATotSBUo3PC,
      author            = "Alexander Mezhov and Annika Robens-Radermacher and Jörg F. Unger and Wolfram Schmidt",
      title             = "Effect of the Ambient Temperature on the Structural Build-Up of 3D Printed Concrete: Experimental and Modelling Study",
      doi               = "10.24355/dbbs.084-202408170750-0",
      year              = "2024",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">A. Mezhov, A. Robens-Radermacher, J. F. Unger and W. Schmidt, “Effect of the Ambient Temperature on the Structural Build-Up of 3D Printed Concrete: Experimental and Modelling Study”, in <i>Supplementary Proceedings of the 4th RILEM International Conference on Concrete and Digital Fabrication</i>,  2024. doi: 10.24355/dbbs.084-202408170750-0.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Mezhov, Alexander, Annika Robens-Radermacher, Jörg F. Unger, and Wolfram Schmidt. “Effect of the Ambient Temperature on the Structural Build-Up of 3D Printed Concrete: Experimental and Modelling Study”. In <i>Supplementary Proceedings of the 4th RILEM International Conference on Concrete and Digital Fabrication</i>, edited by Dirk Lowke, Niklas Freund, David Böhler, and Friedrich Herding, 2024. https://doi.org/10.24355/dbbs.084-202408170750-0.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
