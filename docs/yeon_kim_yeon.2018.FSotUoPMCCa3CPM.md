...
hide:
    ...
    - tags
    - footer
title: Yeon Kyu-Seok, Kim Kwan, Yeon Jaeheum
description:
tags:
 - cement
 - composite
...
<a href="https://api.crossref.org/works/10.1007/978-3-319-78175-4_3" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1007/978-3-319-78175-4_3" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1007/978-3-319-78175-4_3" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1007/978-3-319-78175-4_3&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1007/978-3-319-78175-4_3" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1007/978-3-319-78175-4_3&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W2796210703" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1007/978-3-319-78175-4_3" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1007/978-3-319-78175-4_3?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{yeon_kim_yeon.2018.FSotUoPMCCa3CPM,
      author            = "Kyu-Seok Yeon and Kwan Kyu Kim and Jaeheum Yeon",
      title             = "Feasibility Study of the Use of Polymer-Modified Cement Composites as 3D Concrete Printing-Material",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">K.-S. Yeon, K. K. Kim and J. Yeon, “Feasibility Study of the Use of Polymer-Modified Cement Composites as 3D Concrete Printing-Material”, in <i>Proceedings of the International Congress on Polymers in Concrete: Polymers for Resilient and Sustainable Concrete Infrastructure</i>,  2018, pp. 27–36. doi: 10.1007/978-3-319-78175-4_3.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Yeon, Kyu-Seok, Kwan Kyu Kim, and Jaeheum Yeon. “Feasibility Study of the Use of Polymer-Modified Cement Composites as 3D Concrete Printing-Material”. In <i>Proceedings of the International Congress on Polymers in Concrete: Polymers for Resilient and Sustainable Concrete Infrastructure</i>, edited by Mahmoud M. Reda Taha, 27–36, 2018. https://doi.org/10.1007/978-3-319-78175-4_3.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
