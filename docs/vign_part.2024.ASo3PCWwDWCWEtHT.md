...
hide:
    - navigation
    - tags
title: B. Vignesh, N. Parthasarathi
description:
tags:
 - analysis
 - concrete
...
#:aca-closedaccess:{ .xred '} Analytical Study on 3D Printed Concrete Wall with Different Wall-Configurations When Exposed to High Temperature ([2023-11](date/2023/11))
<a href="https://doi.org/10.1007/978-981-99-6233-4_46" title="DOI" target="_blank">:aca-doi:{ .lg .middle } 10.1007/978-981-99-6233-4_46</a>

-------------------------

:aca-blank:{ .lg .middle}
      <a href="../../../author/vignesh_b"><b>Vignesh</b> B.</a>
