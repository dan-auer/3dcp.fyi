...
hide:
    ...
    - tags
    - footer
title: Silva Wilson, Andersen Thomas, Kudsk Anders, Jørgensen Kåre
description:
tags:
 - concrete
 - element
...
#3D Concrete Printing of Post-Tensioned Elements ([2018-07](date/2018/07))
<span class="author"><a href="https://orcid.org/0000-0001-9895-5128" title="ORCID: 0000-0001-9895-5128" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/silva_ricardo-leal_wilson"><b>da&nbsp;Silva</b>&nbsp;Wilson</a></span>, <a href="../../../author/andersen_juul_thomas"><b>Andersen</b>&nbsp;Thomas</a></span>, <a href="../../../author/kudsk_anders"><b>Kudsk</b>&nbsp;Anders</a></span>, <a href="../../../author/jorgensen_f_kare"><b>Jørgensen</b>&nbsp;Kåre</a></span><br>
Contribution - Proceedings of the IASS 2018 Annual Symposium

<a href="../../keyword/concrete"><button class="btn">#concrete</button></a> <a href="../../keyword/element"><button class="btn">#element</button></a> <a href="../../keyword/post"><button class="btn">#post</button></a> <a href="../../keyword/print"><button class="btn">#print</button></a> <a href="../../keyword/tension"><button class="btn">#tension</button></a> 

<a href="https://scholar.google.com/scholar?as_q=3d+concrete+printing+of+post-tensioned+elements&as_occt=title&as_sauthors=silva&as_ylo=2016&as_yhi=2020&hl=en" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
:aca-blank:{ .lg .middle}
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">W. R. L. da Silva, T. J. Andersen, A. Kudsk and K. F. Jørgensen, “3D Concrete Printing of Post-Tensioned Elements”, in <i>Proceedings of the IASS 2018 Annual Symposium: Creativity in Structural Design</i>,  2018.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Silva, Wilson Ricardo Leal da, Thomas Juul Andersen, Anders Kudsk, and Kåre F. Jørgensen. “3D Concrete Printing of Post-Tensioned Elements”. In <i>Proceedings of the IASS 2018 Annual Symposium: Creativity in Structural Design</i>, edited by International Association for Shell and Spatial Structures, 2018.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
