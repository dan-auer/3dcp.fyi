...
hide:
    ...
    - tags
    - footer
title: Dittel Gözdem, Scheurer Martin, Evers Clara, Meyer-Brötz Fabian, Patel Ankiet, Osswald Michael, Gries Thomas
description:
tags:
 - concrete
 - element
...
<a href="https://api.crossref.org/works/10.52825/ocp.v3i.429" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.52825/ocp.v3i.429" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.52825/ocp.v3i.429" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.52825/ocp.v3i.429&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.52825/ocp.v3i.429" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.52825/ocp.v3i.429&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4389784630" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.52825/ocp.v3i.429" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.52825/ocp.v3i.429?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{ditt_sche_ever_meye.2023.SPoTR3PCE,
      author            = "Gözdem Dittel and Martin Scheurer and Clara Evers and Fabian Meyer-Brötz and Ankiet Patel and Michael Osswald and Thomas Gries",
      title             = "Structural Performance of Textile Reinforced 3D Printed Concrete Elements",
      doi               = "10.52825/ocp.v3i.429",
      year              = "2023",
      volume            = "3",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">G. Dittel, “Structural Performance of Textile Reinforced 3D Printed Concrete Elements”, in <i>Visions and Strategies for Reinforcing Additively Manufactured Constructions</i>,  2023, vol. 3. doi: 10.52825/ocp.v3i.429.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Dittel, Gözdem, Martin Scheurer, Clara Evers, Fabian Meyer-Brötz, Ankiet Patel, Michael Osswald, and Thomas Gries. “Structural Performance of Textile Reinforced 3D Printed Concrete Elements”. In <i>Visions and Strategies for Reinforcing Additively Manufactured Constructions</i>, edited by Asko Fromm and Norman Peter Hack, Vol. 3, 2023. https://doi.org/10.52825/ocp.v3i.429.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
