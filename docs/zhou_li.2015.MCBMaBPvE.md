...
hide:
    ...
    - tags
    - footer
title: Zhou Xiangming, Li Zongjin
description:
tags:
 - base
 - buildability
...
<a href="https://api.crossref.org/works/10.1680/cien.14.00065" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1680/cien.14.00065" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1680/cien.14.00065" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1680/cien.14.00065&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1680/cien.14.00065" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1680/cien.14.00065&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W2110187559" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1680/cien.14.00065" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1680/cien.14.00065?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{zhou_li.2015.MCBMaBPvE,
      author            = "Xiangming Zhou and Zongjin Li",
      title             = "Manufacturing Cement-Based Materials and Building Products via Extrusion: From Laboratory to Factory",
      doi               = "10.1680/cien.14.00065",
      year              = "2015",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">X. Zhou  and Z. Li, “Manufacturing Cement-Based Materials and Building Products via Extrusion: From Laboratory to Factory”, <i>Proceedings of the Institution of Civil Engineers - Civil Engineering</i>, vol. 168, no. 6, pp. 11–16, 2015, doi: 10.1680/cien.14.00065.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Zhou, Xiangming, and Zongjin Li. “Manufacturing Cement-Based Materials and Building Products via Extrusion: From Laboratory to Factory”. <i>Proceedings of the Institution of Civil Engineers - Civil Engineering</i> 168, no. 6 (2015): 11–16. https://doi.org/10.1680/cien.14.00065.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
