...
hide:
    ...
    - tags
    - footer
title: Tan Yuan, Dahlenburg Maximilian, Fottner Johannes, Kessler Stephan
description:
tags:
 - analysis
 - base
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">Y. Tan, M. Dahlenburg, J. Fottner and S. Kessler, “Influencing Factors of the Mixing Performance of a Near-Nozzle Continuous Mixer for 3D Concrete Printing: An Analysis Based on Spatial-Lacey-Mixing-Index”, <i>Powder Technology</i>, vol. 403, 2022, doi: 10.1016/j.powtec.2022.117414.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Tan, Yuan, Maximilian Dahlenburg, Johannes Fottner, and Stephan Kessler. “Influencing Factors of the Mixing Performance of a Near-Nozzle Continuous Mixer for 3D Concrete Printing: An Analysis Based on Spatial-Lacey-Mixing-Index”. <i>Powder Technology</i> 403 (2022). https://doi.org/10.1016/j.powtec.2022.117414.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
