...
hide:
    - navigation
    - tags
title: Leo Li, Guang-Hu Zhang, Albert Kwan
description:
tags:
 - enhancement
 - exploration
...
#:aca-closedaccess:{ .xred '} Exploring Submarine 3D Printing:<br/>:aca-blank: Enhancing Washout-Resistance and Strength of 3D Printable Mortar ([2025-01](date/2025/01))
<a href="https://doi.org/10.1061/jmcee7.mteng-19089" title="DOI" target="_blank">:aca-doi:{ .lg .middle } 10.1061/jmcee7.mteng-19089</a>
...
:aca-blank:{ .lg .middle}
    Journal Article - Journal of Materials in Civil Engineering, Vol. 37, Iss. 3, No. (None,)
...
<a href="https://scholar.google.com/scholar_lookup?title=Exploring%20Submarine%203D%20Printing" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
