...
hide:
    ...
    - tags
    - footer
title: Xu Ping, Chen Tianyu, Fan Kaijun, Zhang Minxia
description:
tags:
 - concrete
 - dosage
...
<a href="https://api.crossref.org/works/10.1016/j.jobe.2023.108090" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1016/j.jobe.2023.108090" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1016/j.jobe.2023.108090" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1016/j.jobe.2023.108090&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1016/j.jobe.2023.108090" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1016/j.jobe.2023.108090&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4388490692" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1016/j.jobe.2023.108090" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1016/j.jobe.2023.108090?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{xu_chen_fan_zhan.2023.EoNSSDotPo3PC,
      author            = "Ping Xu and Tianyu Chen and Kaijun Fan and Minxia Zhang",
      title             = "Effect of Nano-Silica-Sol Dosage on the Properties of 3D Printed Concrete",
      doi               = "10.1016/j.jobe.2023.108090",
      year              = "2023",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">P. Xu, T. Chen, K. Fan and M. Zhang, “Effect of Nano-Silica-Sol Dosage on the Properties of 3D Printed Concrete”, <i>Journal of Building Engineering</i>, vol. 80, p. 108090, 2023, doi: 10.1016/j.jobe.2023.108090.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Xu, Ping, Tianyu Chen, Kaijun Fan, and Minxia Zhang. “Effect of Nano-Silica-Sol Dosage on the Properties of 3D Printed Concrete”. <i>Journal of Building Engineering</i> 80 (2023): 108090. https://doi.org/10.1016/j.jobe.2023.108090.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
