...
hide:
    ...
    - tags
    - footer
title: Toklu Yusuf, Bekdaş Gebrail, Geem Zong
description:
tags:
 - additive
 - concrete
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{tokl_bekd_geem.2020.HSOoNMfAMoCSaCE,
      author            = "Yusuf Cengiz Toklu and Gebrail Bekdaş and Zong Woo Geem",
      title             = "Harmony-Search-Optimization of Nozzle Movement for Additive Manufacturing of Concrete Structures and Concrete Elements",
      doi               = "10.3390/app10124413",
      year              = "2020",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">Y. C. Toklu, G. Bekdaş and Z. W. Geem, “Harmony-Search-Optimization of Nozzle Movement for Additive Manufacturing of Concrete Structures and Concrete Elements”, <i>Applied Sciences</i>, vol. 10, no. 12, 2020, doi: 10.3390/app10124413.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Toklu, Yusuf Cengiz, Gebrail Bekdaş, and Zong Woo Geem. “Harmony-Search-Optimization of Nozzle Movement for Additive Manufacturing of Concrete Structures and Concrete Elements”. <i>Applied Sciences</i> 10, no. 12 (2020). https://doi.org/10.3390/app10124413.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
