...
hide:
    - navigation
    - tags
title: Yusuf Toklu, Gebrail Bekdaş, Zong Geem
description:
tags:
 - additive
 - concrete
...
#[:aca-openaccess:{ .xgreen }](https://www.mdpi.com/2076-3417/10/12/4413/pdf?version=1605262554) Harmony-Search-Optimization of Nozzle Movement for Additive Manufacturing of Concrete Structures and Concrete Elements ([2020-06](date/2020/06))
<a href="https://doi.org/10.3390/app10124413" title="DOI" target="_blank">:aca-doi:{ .lg .middle } 10.3390/app10124413</a>

-------------------------

:aca-blank:{ .lg .middle}
      <a href="../../../author/toklu_cengiz_yusuf"><b>Toklu</b> Yusuf</a> <a href="https://orcid.org/0000-0002-1550-1911" title="ORCID: 0000-0002-1550-1911" target="_blank">:aca-orcid:{ .lg .middle }</a>
,     <a href="../../../author/bekdas_gebrail"><b>Bekdaş</b> Gebrail</a> <a href="https://orcid.org/0000-0002-7327-9810" title="ORCID: 0000-0002-7327-9810" target="_blank">:aca-orcid:{ .lg .middle }</a>
,     <a href="../../../author/geem_woo_zong"><b>Geem</b> Zong</a> <a href="https://orcid.org/0000-0002-0370-5562" title="ORCID: 0000-0002-0370-5562" target="_blank">:aca-orcid:{ .lg .middle }</a>
  
:aca-blank:{ .lg .middle}
    Journal Article - Applied Sciences, Vol. 10, Iss. 12, No. (None,)

:aca-blank:{ .lg .middle}
    [`#additive`](keyword/additive)
    [`#concrete`](keyword/concrete)
    [`#element`](keyword/element)
    [`#harmonization`](keyword/harmonization)
...
<a href="https://api.crossref.org/works/10.3390/app10124413" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.3390/app10124413" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.3390/app10124413" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.3390/app10124413&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.3390/app10124413" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.3390/app10124413&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W3039085701" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.3390/app10124413" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.3390/app10124413?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
