...
hide:
    ...
    - tags
    - footer
title: Zhang Yonghong, Cui Suping, Wang Xinxin, Yang Bohao, Zhang Na, Liu Tao
description:
tags:
 - base
 - concrete
...
<a href="https://api.crossref.org/works/10.1016/j.clwas.2025.100206" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1016/j.clwas.2025.100206" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1016/j.clwas.2025.100206" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1016/j.clwas.2025.100206&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1016/j.clwas.2025.100206" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1016/j.clwas.2025.100206&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4406199920" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1016/j.clwas.2025.100206" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1016/j.clwas.2025.100206?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{zhan_cui_wang_yang.2025.MaPoRWTBB3PC,
      author            = "Yonghong Zhang and Suping Cui and Xinxin Wang and Bohao Yang and Na Zhang and Tao Liu",
      title             = "Microstructure and Performance of Recycled Wind Turbine Blade-Based 3D Printed Concrete",
      doi               = "10.1016/j.clwas.2025.100206",
      year              = "2025",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">Y. Zhang, S. Cui, X. Wang, B. Yang, N. Zhang and T. Liu, “Microstructure and Performance of Recycled Wind Turbine Blade-Based 3D Printed Concrete”, <i>Cleaner Waste Systems</i>, p. 100206, 2025, doi: 10.1016/j.clwas.2025.100206.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Zhang, Yonghong, Suping Cui, Xinxin Wang, Bohao Yang, Na Zhang, and Tao Liu. “Microstructure and Performance of Recycled Wind Turbine Blade-Based 3D Printed Concrete”. <i>Cleaner Waste Systems</i>, 2025, 100206. https://doi.org/10.1016/j.clwas.2025.100206.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
