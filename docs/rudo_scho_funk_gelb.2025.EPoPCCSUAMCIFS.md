...
???+ failure "Formatted Citation"
    ...
    <span id="iee">E. Rudolph, D. Schönfelder, H. Funke and S. Gelbrich, “Efficient Production of Pre-Cast Concrete Staircases Using Additive-Manufactured, Component-Integrated Formworks Systems”, in <i>Environmental Challenges in Civil Engineering III</i>,  2025, vol. 615, pp. 160–174. doi: 10.1007/978-3-031-73776-3_11.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Rudolph, Enrico, Daniel Schönfelder, Henrik Funke, and Sandra Gelbrich. “Efficient Production of Pre-Cast Concrete Staircases Using Additive-Manufactured, Component-Integrated Formworks Systems”. In <i>Environmental Challenges in Civil Engineering III</i>, 615:160–74, 2025. https://doi.org/10.1007/978-3-031-73776-3_11.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
