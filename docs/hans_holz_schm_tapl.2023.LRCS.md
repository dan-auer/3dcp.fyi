...
hide:
    ...
    - tags
    - footer
title: Hansemann Georg, Holzinger Christoph, Schmid Robert, Tapley Joshua, Peters Stefan, Trummer Andreas
description:
tags:
 - concrete
 - light
...
<a href="https://api.crossref.org/works/10.1007/978-3-031-13249-0_36" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1007/978-3-031-13249-0_36" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1007/978-3-031-13249-0_36" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1007/978-3-031-13249-0_36&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1007/978-3-031-13249-0_36" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1007/978-3-031-13249-0_36&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4297837631" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1007/978-3-031-13249-0_36" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1007/978-3-031-13249-0_36?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{hans_holz_schm_tapl.2023.LRCS,
      author            = "Georg Hansemann and Christoph Holzinger and Robert Schmid and Joshua Paul Tapley and Stefan Peters and Andreas Trummer",
      title             = "Lightweight Reinforced Concrete Slab",
      doi               = "10.1007/978-3-031-13249-0_36",
      year              = "2023",
      pages             = "456--466",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">G. Hansemann, C. Holzinger, R. Schmid, J. P. Tapley, S. Peters and A. Trummer, “Lightweight Reinforced Concrete Slab”, in <i>Proceedings of the Design Modelling Symposium: Towards Radical Regeneration</i>,  2023, pp. 456–466. doi: 10.1007/978-3-031-13249-0_36.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Hansemann, Georg, Christoph Holzinger, Robert Schmid, Joshua Paul Tapley, Stefan Peters, and Andreas Trummer. “Lightweight Reinforced Concrete Slab”. In <i>Proceedings of the Design Modelling Symposium: Towards Radical Regeneration</i>, edited by Christoph Gengnagel, Olivier Baverel, Giovanni Betti, Mariana Popescu, Mette Ramsgaard Thomsen, and Jan Wurm, 456–66, 2023. https://doi.org/10.1007/978-3-031-13249-0_36.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
