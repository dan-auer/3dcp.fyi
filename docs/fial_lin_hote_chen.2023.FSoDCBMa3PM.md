...
hide:
    ...
    - tags
    - footer
title: Fiala Lukáš, Lin Wei-Ting, Hotěk Petr, Cheng An
description:
tags:
 - blend
 - development
...
<a href="https://api.crossref.org/works/10.1016/j.cscm.2023.e02675" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1016/j.cscm.2023.e02675" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1016/j.cscm.2023.e02675" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1016/j.cscm.2023.e02675&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1016/j.cscm.2023.e02675" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1016/j.cscm.2023.e02675&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4388625909" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1016/j.cscm.2023.e02675" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1016/j.cscm.2023.e02675?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{fial_lin_hote_chen.2023.FSoDCBMa3PM,
      author            = "Lukáš Fiala and Wei-Ting Lin and Petr Hotěk and An Cheng",
      title             = "Feasibility Study of Developing Cementless Blended Materials as 3D Printable Materials",
      doi               = "10.1016/j.cscm.2023.e02675",
      year              = "2023",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">L. Fiala, W.-T. Lin, P. Hotěk and A. Cheng, “Feasibility Study of Developing Cementless Blended Materials as 3D Printable Materials”, <i>Case Studies in Construction Materials</i>, vol. 19, p. e02675, 2023, doi: 10.1016/j.cscm.2023.e02675.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Fiala, Lukáš, Wei-Ting Lin, Petr Hotěk, and An Cheng. “Feasibility Study of Developing Cementless Blended Materials as 3D Printable Materials”. <i>Case Studies in Construction Materials</i> 19 (2023): e02675. https://doi.org/10.1016/j.cscm.2023.e02675.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
