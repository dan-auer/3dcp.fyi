...
hide:
    ...
    - tags
    - footer
title: Federowicz Karol, Cendrowski Krzysztof, Sikora Paweł
description:
tags:
 - age
 - application
...
#Low-Carbon Cementitious Composite Incorporated with Biochar and Recycled Fines Suitable for 3D Printing Applications&nbsp;([2024-10](date/2024/10))
<div class="h1-like">Hydration, Shrinkage and Early-Age Performance</div>
[:aca-openaccess:{ .xgreen .lg .middle}](https://doi.org/10.3221/igf-esis.71.08) <a href="https://doi.org/10.3221/igf-esis.71.08" title="DOI" target="_blank">:aca-doi:{ .lg .middle }</a> <a href="https://doi.org/10.3221/igf-esis.71.08" target="_blank">10.3221/igf-esis.71.08</a>

<span class="author"><a href="https://orcid.org/0000-0002-6622-4539" title="ORCID: 0000-0002-6622-4539" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/federowicz_karol"><b>Federowicz</b>&nbsp;Karol</a></span>, <span class="author"><a href="https://orcid.org/0000-0002-7913-6300" title="ORCID: 0000-0002-7913-6300" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/cendrowski_krzysztof"><b>Cendrowski</b>&nbsp;Krzysztof</a></span>, <span class="author"><a href="https://orcid.org/0000-0003-1092-1359" title="ORCID: 0000-0003-1092-1359" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/sikora_pawel"><b>Sikora</b>&nbsp;Paweł</a></span><br>
Journal Article - Fracture and Structural Integrity, Vol. 19, Iss. 71, pp. 91-107

<a href="../../keyword/age"><button class="btn">#age</button></a> <a href="../../keyword/application"><button class="btn">#application</button></a> <a href="../../keyword/carbon"><button class="btn">#carbon</button></a> <a href="../../keyword/cement"><button class="btn">#cement</button></a> <a href="../../keyword/composite"><button class="btn">#composite</button></a> <a href="../../keyword/early"><button class="btn">#early</button></a> <a href="../../keyword/hydration"><button class="btn">#hydration</button></a> <a href="../../keyword/incorporation"><button class="btn">#incorporation</button></a> <a href="../../keyword/low"><button class="btn">#low</button></a> <a href="../../keyword/performance"><button class="btn">#performance</button></a> <a href="../../keyword/print"><button class="btn">#print</button></a> <a href="../../keyword/recycling"><button class="btn">#recycling</button></a> <a href="../../keyword/shrinkage"><button class="btn">#shrinkage</button></a> <a href="../../keyword/suitability"><button class="btn">#suitability</button></a> 

<a href="https://scholar.google.com/scholar_lookup?title=Low-Carbon%20Cementitious%20Composite%20Incorporated%20with%20Biochar%20and%20Recycled%20Fines%20Suitable%20for%203D%20Printing%20Applications" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
<a href="https://www.scopus.com/record/display.url?eid=2-s2.0-85207419089&origin=resultslist" title="Search on Scopus" target="_blank">:aca-scopus:{ .lg .middle }</a>
<a href="https://www.webofscience.com/wos/woscc/full-record/WOS:001339421500003" title="Search on Web of Science" target="_blank">:aca-wos:{ .lg .middle }</a>
<a href="https://plu.mx/plum/a/?doi=10.3221/igf-esis.71.08" title="Search on plu.mx" target="_blank">:aca-plumx:{ .lg .middle }</a>
<a href="https://api.crossref.org/works/10.3221/igf-esis.71.08" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.3221/igf-esis.71.08" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.3221/igf-esis.71.08" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.3221/igf-esis.71.08&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.3221/igf-esis.71.08" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.3221/igf-esis.71.08&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4403397428" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.3221/igf-esis.71.08" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.3221/igf-esis.71.08?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">K. Federowicz, K. Cendrowski and P. Sikora, “Low-Carbon Cementitious Composite Incorporated with Biochar and Recycled Fines Suitable for 3D Printing Applications: Hydration, Shrinkage and Early-Age Performance”, <i>Fracture and Structural Integrity</i>, vol. 19, no. 71, pp. 91–107, 2025, doi: 10.3221/igf-esis.71.08.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Federowicz, Karol, Krzysztof Cendrowski, and Paweł Sikora. “Low-Carbon Cementitious Composite Incorporated with Biochar and Recycled Fines Suitable for 3D Printing Applications: Hydration, Shrinkage and Early-Age Performance”. <i>Fracture and Structural Integrity</i> 19, no. 71 (2025): 91–107. https://doi.org/10.3221/igf-esis.71.08.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
