...
hide:
    ...
    - tags
    - footer
title: Robens-Radermacher Annika, Kujath Cezary, Bos Freek, Mechtcherine Viktor, Unger Jörg
description:
tags:
 - analysis
 - concrete
...
#Design and Implementation of a Database System for Querying, Sharing, and Analyzing Experimental Data&nbsp;([2025-06](date/2025/06))
<div class="h1-like">Mechanical Properties of 3D Printed Concrete</div>
<a href="https://link.springer.com/content/pdf/10.1617/s11527-025-02650-9.pdf" title="Open Access - Click to Download" target="_blank">:aca-openaccess:{ .xgreen .lg .middle}</a>
 <a href="https://doi.org/10.1617/s11527-025-02650-9" title="DOI" target="_blank">:aca-doi:{ .lg .middle }</a> <a href="https://doi.org/10.1617/s11527-025-02650-9" target="_blank">10.1617/s11527-025-02650-9</a>

<span class="author"><a href="https://orcid.org/0000-0001-9653-6085" title="ORCID: 0000-0001-9653-6085" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/robens-radermacher_annika"><b>Robens-Radermacher</b>&nbsp;Annika</a></span>, <a href="../../../author/kujath_cezary"><b>Kujath</b>&nbsp;Cezary</a></span>, <span class="author"><a href="https://orcid.org/0000-0002-6666-2395" title="ORCID: 0000-0002-6666-2395" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/bos_paul_freek"><b>Bos</b>&nbsp;Freek</a></span>, <span class="author"><a href="https://orcid.org/0000-0002-4685-7064" title="ORCID: 0000-0002-4685-7064" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/mechtcherine_viktor"><b>Mechtcherine</b>&nbsp;Viktor</a></span>, <span class="author"><a href="https://orcid.org/0000-0003-0035-0951" title="ORCID: 0000-0003-0035-0951" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/unger_f_jorg"><b>Unger</b>&nbsp;Jörg</a></span><br>
Journal Article - Materials and Structures, Vol. 58, Iss. 5

<a href="../../keyword/analysis"><button class="btn">#analysis</button></a> <a href="../../keyword/concrete"><button class="btn">#concrete</button></a> <a href="../../keyword/data"><button class="btn">#data</button></a> <a href="../../keyword/database"><button class="btn">#database</button></a> <a href="../../keyword/design"><button class="btn">#design</button></a> <a href="../../keyword/experiment"><button class="btn">#experiment</button></a> <a href="../../keyword/implementation"><button class="btn">#implementation</button></a> <a href="../../keyword/mechanics"><button class="btn">#mechanics</button></a> <a href="../../keyword/print"><button class="btn">#print</button></a> <a href="../../keyword/property"><button class="btn">#property</button></a> <a href="../../keyword/system"><button class="btn">#system</button></a> 

<a href="https://scholar.google.com/scholar?as_q=design+and+implementation+of+a+database+system+for+querying%2C+sharing%2C+and+analyzing+experimental+data&as_occt=title&as_sauthors=robens-radermacher&as_ylo=2023&as_yhi=2027&hl=en" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{robe_kuja_bos_mech.2025.DaIoaDSfQSaAED,
      author            = "Annika Robens-Radermacher and Cezary Kujath and Freek Paul Bos and Viktor Mechtcherine and Jörg F. Unger",
      title             = "Design and Implementation of a Database System for Querying, Sharing, and Analyzing Experimental Data: Mechanical Properties of 3D Printed Concrete",
      doi               = "10.1617/s11527-025-02650-9",
      year              = "2025",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">A. Robens-Radermacher, C. Kujath, F. P. Bos, V. Mechtcherine and J. F. Unger, “Design and Implementation of a Database System for Querying, Sharing, and Analyzing Experimental Data: Mechanical Properties of 3D Printed Concrete”, <i>Materials and Structures</i>, vol. 58, no. 5, 2025, doi: 10.1617/s11527-025-02650-9.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Robens-Radermacher, Annika, Cezary Kujath, Freek Paul Bos, Viktor Mechtcherine, and Jörg F. Unger. “Design and Implementation of a Database System for Querying, Sharing, and Analyzing Experimental Data: Mechanical Properties of 3D Printed Concrete”. <i>Materials and Structures</i> 58, no. 5 (2025). https://doi.org/10.1617/s11527-025-02650-9.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
