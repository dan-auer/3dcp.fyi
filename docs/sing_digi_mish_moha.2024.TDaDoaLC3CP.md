...
hide:
    ...
    - tags
    - footer
title: Singh Aman, Digi Rohan, Mishra Ruby, Mohanty Rajiva, Pandey Anish
description:
tags:
 - concrete
 - cost
...
<a href="https://api.crossref.org/works/10.1007/978-981-97-1080-5_58" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1007/978-981-97-1080-5_58" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1007/978-981-97-1080-5_58" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1007/978-981-97-1080-5_58&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1007/978-981-97-1080-5_58" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1007/978-981-97-1080-5_58&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4396887878" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1007/978-981-97-1080-5_58" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1007/978-981-97-1080-5_58?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{sing_digi_mish_moha.2024.TDaDoaLC3CP,
      author            = "Aman Singh and Rohan Digi and Ruby Mishra and Rajiva Lochan Mohanty and Anish Pandey",
      title             = "The Design and Development of a Low Cost 3D Concrete Printer",
      doi               = "10.1007/978-981-97-1080-5_58",
      year              = "2024",
      pages             = "695--706",
      booktitle         = "International Conference on Recent Advances in Mechanical Engineering Research and Development",
      editor            = "Seshadev Sahoo and Natraj Yedla",
    }
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">A. Singh, R. Digi, R. Mishra, R. L. Mohanty and A. Pandey, “The Design and Development of a Low Cost 3D Concrete Printer”, in <i>International Conference on Recent Advances in Mechanical Engineering Research and Development</i>,  2024, pp. 695–706. doi: 10.1007/978-981-97-1080-5_58.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Singh, Aman, Rohan Digi, Ruby Mishra, Rajiva Lochan Mohanty, and Anish Pandey. “The Design and Development of a Low Cost 3D Concrete Printer”. In <i>International Conference on Recent Advances in Mechanical Engineering Research and Development</i>, edited by Seshadev Sahoo and Natraj Yedla, 695–706, 2024. https://doi.org/10.1007/978-981-97-1080-5_58.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
