...
hide:
    ...
    - tags
    - footer
title: Chen Zhaohui, Wang Zhenyue, Liao Minmao, Sun Junbo, Sun Xiao
description:
tags:
 - bearing
 - capacity
...
<a href="https://api.crossref.org/works/10.1007/978-3-031-64269-2_4" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1007/978-3-031-64269-2_4" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1007/978-3-031-64269-2_4" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1007/978-3-031-64269-2_4&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1007/978-3-031-64269-2_4" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1007/978-3-031-64269-2_4&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4400485327" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1007/978-3-031-64269-2_4" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1007/978-3-031-64269-2_4?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{chen_wang_liao_sun.2024.IoPPoBCo3PCHS,
      author            = "Zhaohui Chen and Zhenyue Wang and Minmao Liao and Junbo Sun and Xiao Sun",
      title             = "Influence of Printing-Pattern on Bearing-Capacity of 3D Printed Concrete Hollow Structures",
      doi               = "10.1007/978-3-031-64269-2_4",
      year              = "2024",
      pages             = "26--31",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">Z. Chen, Z. Wang, M. Liao, J. Sun and X. Sun, “Influence of Printing-Pattern on Bearing-Capacity of 3D Printed Concrete Hollow Structures”, in <i>Construction 3D Printing: Selected Papers from the 4th International Conference on 3D Construction Printing Conference</i>,  2024, pp. 26–31. doi: 10.1007/978-3-031-64269-2_4.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Chen, Zhaohui, Zhenyue Wang, Minmao Liao, Junbo Sun, and Xiao Sun. “Influence of Printing-Pattern on Bearing-Capacity of 3D Printed Concrete Hollow Structures”. In <i>Construction 3D Printing: Selected Papers from the 4th International Conference on 3D Construction Printing Conference</i>, edited by Ming Jen Tan, Mingyang Li, Yi Wei Daniel Tay, Teck Neng Wong, and Paulo Jorge Bartolo, 26–31, 2024. https://doi.org/10.1007/978-3-031-64269-2_4.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
