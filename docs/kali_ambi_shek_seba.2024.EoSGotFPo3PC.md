...
hide:
    ...
    - tags
    - footer
title: Kaliyavaradhan Senthil, Ambily Parukutty, Shekar Deepadharshan, Sebastian Shilpa
description:
tags:
 - concrete
 - effect
...
<a href="https://api.crossref.org/works/10.1680/jmacr.23.00166" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1680/jmacr.23.00166" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1680/jmacr.23.00166" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1680/jmacr.23.00166&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1680/jmacr.23.00166" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1680/jmacr.23.00166&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4392131388" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1680/jmacr.23.00166" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1680/jmacr.23.00166?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{kali_ambi_shek_seba.2024.EoSGotFPo3PC,
      author            = "Senthil Kumar Kaliyavaradhan and Parukutty S. Ambily and Deepadharshan Shekar and Shilpa Sebastian",
      title             = "Effect of Sand-Gradations on the Fresh Properties of 3D Printable Concrete",
      doi               = "10.1680/jmacr.23.00166",
      year              = "2024",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">S. K. Kaliyavaradhan, P. S. Ambily, D. Shekar and S. Sebastian, “Effect of Sand-Gradations on the Fresh Properties of 3D Printable Concrete”, <i>Magazine of Concrete Research</i>, pp. 1–32, 2024, doi: 10.1680/jmacr.23.00166.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Kaliyavaradhan, Senthil Kumar, Parukutty S. Ambily, Deepadharshan Shekar, and Shilpa Sebastian. “Effect of Sand-Gradations on the Fresh Properties of 3D Printable Concrete”. <i>Magazine of Concrete Research</i>, 2024, 1–32. https://doi.org/10.1680/jmacr.23.00166.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
