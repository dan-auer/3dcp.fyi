...
hide:
    - navigation
    - tags
title: David Böhler, Niklas Freund, Inka Mai (née Dressler), Dirk Lowke
description:
tags:
 - density
 - effect
...
#[:aca-openaccess:{ .xgreen }](https://onlinelibrary.wiley.com/doi/pdfdirect/10.1002/cepa.2822) Shotcrete 3D Printing:<br/>:aca-blank: Effect of Material‐Process-Interaction on the Global and Local Material Density ([2023-12](date/2023/12))
<a href="https://doi.org/10.1002/cepa.2822" title="DOI" target="_blank">:aca-doi:{ .lg .middle } 10.1002/cepa.2822</a>
