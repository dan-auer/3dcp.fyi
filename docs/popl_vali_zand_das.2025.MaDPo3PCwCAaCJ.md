...
hide:
    ...
    - tags
    - footer
title: Popli Siddharth, Valikhah Fatemeh, Zandi Lak Erfan, Das Sreekanta
description:
tags:
 - aggregate
 - coarse
...
<a href="https://api.crossref.org/works/10.1061/jsdccc.sceng-1808" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1061/jsdccc.sceng-1808" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1061/jsdccc.sceng-1808" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1061/jsdccc.sceng-1808&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1061/jsdccc.sceng-1808" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1061/jsdccc.sceng-1808&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4411865992" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1061/jsdccc.sceng-1808" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1061/jsdccc.sceng-1808?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{popl_vali_zand_das.2025.MaDPo3PCwCAaCJ,
      author            = "Siddharth Popli and Fatemeh Valikhah and Erfan Zandi Lak and Sreekanta Das",
      title             = "Mechanical and Durability Performance of 3D-Printed Concrete with Coarse Aggregates and Cold Joints",
      doi               = "10.1061/jsdccc.sceng-1808",
      year              = "2025",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">S. Popli, F. Valikhah, E. Z. Lak and S. Das, “Mechanical and Durability Performance of 3D-Printed Concrete with Coarse Aggregates and Cold Joints”, <i>Journal of Structural Design and Construction Practice</i>, vol. 30, no. 4, 2025, doi: 10.1061/jsdccc.sceng-1808.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Popli, Siddharth, Fatemeh Valikhah, Erfan Zandi Lak, and Sreekanta Das. “Mechanical and Durability Performance of 3D-Printed Concrete with Coarse Aggregates and Cold Joints”. <i>Journal of Structural Design and Construction Practice</i> 30, no. 4 (2025). https://doi.org/10.1061/jsdccc.sceng-1808.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
