...
hide:
    ...
    - tags
    - footer
title: Secrieru Egor, Butler Marko, Mechtcherine Viktor
description:
tags:
 - concrete
 - labor
...
<a href="https://api.crossref.org/works/10.1002/bate.201400072" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1002/bate.201400072" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1002/bate.201400072" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1002/bate.201400072&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1002/bate.201400072" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1002/bate.201400072&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W2161134967" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1002/bate.201400072" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1002/bate.201400072?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
    To date, there are no standardized regulations for assessing the pumpability of fresh concrete in which the requirements for its rheological properties are specified. To test the pumpability of fresh concrete - especially on the construction site - the establishment of simple, robust and yet meaningful rheological measurement techniques is of fundamental importance. This article presents the new testing approaches for a reliable optimization of the pumping of fresh concrete. In particular, the mode of operation of the so-called sliding pipe rheometer (SLIPER) is explained, with which the flow rates, pressure conditions and resulting states of movement of the fresh concrete in a concrete delivery line can be quantitatively estimated in a good approximation. As part of a Pa - rameter study, the results obtained using SLIPER are analyzed and compared with those of a stationary concrete viscometer. The determined correlations between rheology and pumpability of both normal concretes and special concretes (self-compacting concrete (SCC) and high-ductility concrete (SHCC)) are presented. Finally, the predictive ability of the pumping behavior of concrete is validated on the basis of the SLIPER investigations by measuring the pumping pressure under construction site conditions.
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{secr_butl_mech.2014.TPoC,
      author            = "Egor Secrieru and Marko Butler and Viktor Mechtcherine",
      title             = "Testing Pumpability of Concrete: From Laboratory into Practice",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">E. Secrieru, M. Butler and V. Mechtcherine, “Testing Pumpability of Concrete: From Laboratory into Practice”, <i>Bautechnik</i>, vol. 91, no. 11, pp. 797–811, 2014, doi: 10.1002/bate.201400072.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Secrieru, Egor, Marko Butler, and Viktor Mechtcherine. “Testing Pumpability of Concrete: From Laboratory into Practice”. <i>Bautechnik</i> 91, no. 11 (2014): 797–811. https://doi.org/10.1002/bate.201400072.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
