...
hide:
    ...
    - tags
    - footer
title: Daadouch Koussay, Reinold Janis, Meschke Günther
description:
tags:
 - concrete
 - layer
...
#Numerical Simulation of 3D Concrete Printing&nbsp;([2024-09](date/2024/09))
<div class="h1-like">From the Layer- to the Structural-Scale</div>
 <a href="https://doi.org/10.24355/dbbs.084-202408151447-0" title="DOI" target="_blank">:aca-doi:{ .lg .middle }</a> <a href="https://doi.org/10.24355/dbbs.084-202408151447-0" target="_blank">10.24355/dbbs.084-202408151447-0</a>

<a href="../../../author/daadouch_koussay"><b>Daadouch</b>&nbsp;Koussay</a></span>, <a href="../../../author/reinold_michel_janis"><b>Reinold</b>&nbsp;Janis</a></span>, <span class="author"><a href="https://orcid.org/0000-0003-2277-1327" title="ORCID: 0000-0003-2277-1327" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/meschke_gunther"><b>Meschke</b>&nbsp;Günther</a></span><br>
Contribution - Supplementary Proceedings of the 4th RILEM International Conference on Concrete and Digital Fabrication

<a href="../../keyword/concrete"><button class="btn">#concrete</button></a> <a href="../../keyword/layer"><button class="btn">#layer</button></a> <a href="../../keyword/numeric"><button class="btn">#numeric</button></a> <a href="../../keyword/print"><button class="btn">#print</button></a> <a href="../../keyword/scale"><button class="btn">#scale</button></a> <a href="../../keyword/simulation"><button class="btn">#simulation</button></a> <a href="../../keyword/structure"><button class="btn">#structure</button></a> 

<a href="https://scholar.google.com/scholar?as_q=numerical+simulation+of+3d+concrete+printing&as_occt=title&as_sauthors=daadouch&as_ylo=2022&as_yhi=2026&hl=en" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{daad_rein_mesc.2024.NSo3CP,
      author            = "Koussay Daadouch and Janis Michel Reinold and Günther Meschke",
      title             = "Numerical Simulation of 3D Concrete Printing: From the Layer- to the Structural-Scale",
      doi               = "10.24355/dbbs.084-202408151447-0",
      year              = "2024",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">K. Daadouch, J. M. Reinold and G. Meschke, “Numerical Simulation of 3D Concrete Printing: From the Layer- to the Structural-Scale”, in <i>Supplementary Proceedings of the 4th RILEM International Conference on Concrete and Digital Fabrication</i>,  2024. doi: 10.24355/dbbs.084-202408151447-0.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Daadouch, Koussay, Janis Michel Reinold, and Günther Meschke. “Numerical Simulation of 3D Concrete Printing: From the Layer- to the Structural-Scale”. In <i>Supplementary Proceedings of the 4th RILEM International Conference on Concrete and Digital Fabrication</i>, edited by Dirk Lowke, Niklas Freund, David Böhler, and Friedrich Herding, 2024. https://doi.org/10.24355/dbbs.084-202408151447-0.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
