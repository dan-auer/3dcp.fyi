...
hide:
    ...
    - tags
    - footer
title: Cong Long-Yu, Zhang Fang, Qian Yong-Jiu
description:
tags:
 - beam
 - behavior
...
#Flexural Behavior Investigation of RC Beams with FRP-Reinforced 3D-Printed ECC Permanent Formwork ([2025-12](date/2025/12))
 <a href="https://doi.org/10.1016/j.engstruct.2025.122046" title="DOI" target="_blank">:aca-doi:{ .lg .middle }</a> <a href="https://doi.org/10.1016/j.engstruct.2025.122046" target="_blank">10.1016/j.engstruct.2025.122046</a>

<span class="author"><a href="https://orcid.org/0000-0002-8205-1092" title="ORCID: 0000-0002-8205-1092" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/cong_long-yu"><b>Cong</b>&nbsp;Long-Yu</a></span>, <a href="../../../author/zhang_fang"><b>Zhang</b>&nbsp;Fang</a></span>, <a href="../../../author/qian_yong-jiu"><b>Qian</b>&nbsp;Yong-Jiu</a></span><br>
Journal Article - Engineering Structures, Vol. 351, No. 122046

<a href="../../keyword/beam"><button class="btn">#beam</button></a> <a href="../../keyword/behavior"><button class="btn">#behavior</button></a> <a href="../../keyword/ecc"><button class="btn">#ecc</button></a> <a href="../../keyword/flexural"><button class="btn">#flexural</button></a> <a href="../../keyword/formwork"><button class="btn">#formwork</button></a> <a href="../../keyword/investigation"><button class="btn">#investigation</button></a> <a href="../../keyword/permanent"><button class="btn">#permanent</button></a> <a href="../../keyword/print"><button class="btn">#print</button></a> <a href="../../keyword/reinforcement"><button class="btn">#reinforcement</button></a> 

<a href="https://scholar.google.com/scholar?as_q=flexural+behavior+investigation+of+rc+beams+with+frp-reinforced+3d-printed+ecc+permanent+formwork&as_occt=title&as_sauthors=cong&as_ylo=2023&as_yhi=2027&hl=en" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
<a href="https://www.scopus.com/record/display.url?eid=None&origin=resultslist" title="Search on Scopus" target="_blank">:aca-scopus:{ .lg .middle }</a>
<a href="https://www.webofscience.com/wos/woscc/full-record/WOS:None" title="Search on Web of Science" target="_blank">:aca-wos:{ .lg .middle }</a>
<a href="https://plu.mx/plum/a/?doi=10.1016/j.engstruct.2025.122046" title="Search on plu.mx" target="_blank">:aca-plumx:{ .lg .middle }</a>
<a href="https://api.crossref.org/works/10.1016/j.engstruct.2025.122046" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1016/j.engstruct.2025.122046" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1016/j.engstruct.2025.122046" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1016/j.engstruct.2025.122046&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1016/j.engstruct.2025.122046" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1016/j.engstruct.2025.122046&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/None" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1016/j.engstruct.2025.122046" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1016/j.engstruct.2025.122046?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{cong_zhan_qian.2026.FBIoRBwFR3PEPF,
      author            = "Long-Yu Cong and Fang Zhang and Yong-Jiu Qian",
      title             = "Flexural Behavior Investigation of RC Beams with FRP-Reinforced 3D-Printed ECC Permanent Formwork",
      doi               = "10.1016/j.engstruct.2025.122046",
      year              = "2026",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">L.-Y. Cong, F. Zhang and Y.-J. Qian, “Flexural Behavior Investigation of RC Beams with FRP-Reinforced 3D-Printed ECC Permanent Formwork”, <i>Engineering Structures</i>, vol. 351, p. 122046, 2026, doi: 10.1016/j.engstruct.2025.122046.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Cong, Long-Yu, Fang Zhang, and Yong-Jiu Qian. “Flexural Behavior Investigation of RC Beams with FRP-Reinforced 3D-Printed ECC Permanent Formwork”. <i>Engineering Structures</i> 351 (2026): 122046. https://doi.org/10.1016/j.engstruct.2025.122046.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
