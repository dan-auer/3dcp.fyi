...
hide:
    - navigation
    - tags
title: Eric Schönsee, Götz Hüsken, Olubunmi Jeyifous, Alexander Mezhov, Christoph Strangfeld
description:
tags:
 - additive
 - base
...
#[:aca-openaccess:{ .xgreen }](https://doi.org/10.4028/p-ev4gpv) Calculating Rheological Properties of Fresh Mortar for Additive Manufacturing Based on Experimental, Multi-Sensor Data ([2023-06](date/2023/06))
<a href="https://doi.org/10.4028/p-ev4gpv" title="DOI" target="_blank">:aca-doi:{ .lg .middle } 10.4028/p-ev4gpv</a>
