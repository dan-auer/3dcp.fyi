...
hide:
    ...
    - tags
    - footer
title: Coward Andy, Forsberg Torben
description:
tags:
 - beam
 - bridge
...
<a href="https://api.crossref.org/works/10.2749/manchester.2024.0706" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.2749/manchester.2024.0706" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.2749/manchester.2024.0706" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.2749/manchester.2024.0706&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.2749/manchester.2024.0706" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.2749/manchester.2024.0706&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4395450488" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.2749/manchester.2024.0706" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.2749/manchester.2024.0706?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{cowa_fors.2024.RoaURBbUo3PmB,
      author            = "Andy Coward and Torben Forsberg",
      title             = "Reconstruction of a Ukrainian Road Bridge by Use of 3D Printed minimass™ Beams",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">A. Coward  and T. Forsberg, “Reconstruction of a Ukrainian Road Bridge by Use of 3D Printed minimass™ Beams”, in <i>Proceedings of the 2024 IABSE Symposium: Construction's Role for a World in Emergency</i>,  2024, p. 45. doi: 10.2749/manchester.2024.0706.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Coward, Andy, and Torben Forsberg. “Reconstruction of a Ukrainian Road Bridge by Use of 3D Printed Minimass™ Beams”. In <i>Proceedings of the 2024 IABSE Symposium: Construction's Role for a World in Emergency</i>, edited by International Association for Bridge and Structural Engineering, 45, 2024. https://doi.org/10.2749/manchester.2024.0706.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
