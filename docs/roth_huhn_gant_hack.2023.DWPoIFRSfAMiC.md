...
hide:
    ...
    - tags
    - footer
title: Rothe Tom, Hühne Christian, Gantner Stefan, Hack Norman
description:
tags:
 - additive
 - construction
...
<a href="https://api.crossref.org/works/10.52825/ocp.v3i.187" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.52825/ocp.v3i.187" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.52825/ocp.v3i.187" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.52825/ocp.v3i.187&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.52825/ocp.v3i.187" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.52825/ocp.v3i.187&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4389815796" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.52825/ocp.v3i.187" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.52825/ocp.v3i.187?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{roth_huhn_gant_hack.2023.DWPoIFRSfAMiC,
      author            = "Tom Niklas Rothe and Christian Hühne and Stefan Gantner and Norman Peter Hack",
      title             = "Dynamic Winding Process of Individualized Fiber-Reinforcement Structures for Additive Manufacturing in Construction",
      doi               = "10.52825/ocp.v3i.187",
      year              = "2023",
      volume            = "3",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">T. N. Rothe, C. Hühne, S. Gantner and N. P. Hack, “Dynamic Winding Process of Individualized Fiber-Reinforcement Structures for Additive Manufacturing in Construction”, in <i>Visions and Strategies for Reinforcing Additively Manufactured Constructions</i>,  2023, vol. 3. doi: 10.52825/ocp.v3i.187.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Rothe, Tom Niklas, Christian Hühne, Stefan Gantner, and Norman Peter Hack. “Dynamic Winding Process of Individualized Fiber-Reinforcement Structures for Additive Manufacturing in Construction”. In <i>Visions and Strategies for Reinforcing Additively Manufactured Constructions</i>, edited by Asko Fromm and Norman Peter Hack, Vol. 3, 2023. https://doi.org/10.52825/ocp.v3i.187.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
