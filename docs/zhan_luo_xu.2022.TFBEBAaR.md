...
hide:
    - navigation
    - tags
title: Jiale Zhang, Hanbin Luo, Jie Xu
description:
tags:
 - automation
 - bim
...
#[:aca-openaccess:{ .xgreen }](https://figshare.com/articles/journal_contribution/Towards_fully_BIM-enabled_building_automation_and_robotics_A_perspective_of_lifecycle_information_flow/17698367/1/files/32837150.pdf) Towards Fully BIM-Enabled Building Automation and Robotics:<br/>:aca-blank: A Perspective of Lifecycle Information Flow ([2021-12](date/2021/12))
<a href="https://doi.org/10.1016/j.compind.2021.103570" title="DOI" target="_blank">:aca-doi:{ .lg .middle } 10.1016/j.compind.2021.103570</a>

-------------------------

:aca-blank:{ .lg .middle}
      <a href="../../../author/zhang_jiale"><b>Zhang</b> Jiale</a>
...
:aca-blank:{ .lg .middle}
    Journal Article - Computers in Industry, Vol. 135, No. (None,)
