...
#The Effect of Curing Conditions on the Service Life of 3D Printed Concrete Formwork ([2023-10](date/2023/10))
<a href="https://www.mdpi.com/1996-1944/16/21/6972/pdf?version=1698683200" title="Open Access - Click to Download" target="_blank">:aca-openaccess:{ .xgreen .lg .middle}</a>
 <a href="https://doi.org/10.3390/ma16216972" title="DOI" target="_blank">:aca-doi:{ .lg .middle }</a> <a href="https://doi.org/10.3390/ma16216972" target="_blank">10.3390/ma16216972</a>
...
Journal Article - Materials, Vol. 16, Iss. 21, No. 6972

<a href="../../keyword/concrete"><button class="btn">#concrete</button></a> <a href="../../keyword/condition"><button class="btn">#condition</button></a> <a href="../../keyword/cure"><button class="btn">#cure</button></a> <a href="../../keyword/effect"><button class="btn">#effect</button></a> <a href="../../keyword/formwork"><button class="btn">#formwork</button></a> <a href="../../keyword/life"><button class="btn">#life</button></a> <a href="../../keyword/print"><button class="btn">#print</button></a> 

<a href="https://scholar.google.com/scholar?as_q=the+effect+of+curing+conditions+on+the+service+life+of+3d+printed+concrete+formwork&as_occt=title&as_sauthors=bekaert&as_ylo=2021&as_yhi=2025&hl=en" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
<a href="https://www.scopus.com/record/display.url?eid=2-s2.0-85176328615&origin=resultslist" title="Search on Scopus" target="_blank">:aca-scopus:{ .lg .middle }</a>
<a href="https://www.webofscience.com/wos/woscc/full-record/WOS:001100308300001" title="Search on Web of Science" target="_blank">:aca-wos:{ .lg .middle }</a>
<a href="https://plu.mx/plum/a/?doi=10.3390/ma16216972" title="Search on plu.mx" target="_blank">:aca-plumx:{ .lg .middle }</a>
<a href="https://api.crossref.org/works/10.3390/ma16216972" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.3390/ma16216972" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.3390/ma16216972" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.3390/ma16216972&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.3390/ma16216972" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.3390/ma16216972&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4388017810" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.3390/ma16216972" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.3390/ma16216972?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{beka_titt_schu.2023.TEoCCotSLo3PCF,
      author            = "Michiel Bekaert and Kim van Tittelboom and Geert de Schutter",
      title             = "The Effect of Curing Conditions on the Service Life of 3D Printed Concrete Formwork",
      doi               = "10.3390/ma16216972",
      year              = "2023",
      journal           = "Materials",
      volume            = "16",
      number            = "21",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">M. Bekaert, K. van Tittelboom and G. de Schutter, “The Effect of Curing Conditions on the Service Life of 3D Printed Concrete Formwork”, <i>Materials</i>, vol. 16, no. 21, p. 6972, 2023, doi: 10.3390/ma16216972.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Bekaert, Michiel, Kim van Tittelboom, and Geert de Schutter. “The Effect of Curing Conditions on the Service Life of 3D Printed Concrete Formwork”. <i>Materials</i> 16, no. 21 (2023): 6972. https://doi.org/10.3390/ma16216972.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
