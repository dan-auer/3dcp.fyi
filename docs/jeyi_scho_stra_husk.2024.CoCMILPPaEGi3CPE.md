...
hide:
    ...
    - tags
    - footer
title: Jeyifous Olubunmi, Schönsee Eric, Strangfeld Christoph, Hüsken Götz
description:
tags:
 - concrete
 - continuous
...
#Correlation of Continuously Measured In-Line Process Parameters and Extruded Geometry in 3D Concrete Printing Experiments ([2024-09](date/2024/09))
<a title="Closed Access">:aca-closedaccess:{ .xred .lg .middle}</a>
 <a href="https://doi.org/10.1007/978-3-031-70031-6_15" title="DOI" target="_blank">:aca-doi:{ .lg .middle }</a> <a href="https://doi.org/10.1007/978-3-031-70031-6_15" target="_blank">10.1007/978-3-031-70031-6_15</a>
...
<a href="../../keyword/concrete"><button class="btn">#concrete</button></a> <a href="../../keyword/continuous"><button class="btn">#continuous</button></a> <a href="../../keyword/correlation"><button class="btn">#correlation</button></a> <a href="../../keyword/experiment"><button class="btn">#experiment</button></a> <a href="../../keyword/extrusion"><button class="btn">#extrusion</button></a> <a href="../../keyword/geometry"><button class="btn">#geometry</button></a> <a href="../../keyword/line"><button class="btn">#line</button></a> <a href="../../keyword/measurement"><button class="btn">#measurement</button></a> <a href="../../keyword/parameter"><button class="btn">#parameter</button></a> <a href="../../keyword/print"><button class="btn">#print</button></a> <a href="../../keyword/process"><button class="btn">#process</button></a> 

<a href="https://scholar.google.com/scholar?as_q=correlation+of+continuously+measured+in-line+process+parameters+and+extruded+geometry+in+3d+concrete+printing+experiments&as_occt=title&as_sauthors=jeyifous&as_ylo=2022&as_yhi=2026&hl=en" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
<a href="https://www.scopus.com/record/display.url?eid=2-s2.0-85203010759&origin=resultslist" title="Search on Scopus" target="_blank">:aca-scopus:{ .lg .middle }</a>
<a href="https://www.webofscience.com/wos/woscc/full-record/WOS:001333034600015" title="Search on Web of Science" target="_blank">:aca-wos:{ .lg .middle }</a>
<a href="https://plu.mx/plum/a/?doi=10.1007/978-3-031-70031-6_15" title="Search on plu.mx" target="_blank">:aca-plumx:{ .lg .middle }</a>
<a href="https://api.crossref.org/works/10.1007/978-3-031-70031-6_15" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1007/978-3-031-70031-6_15" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1007/978-3-031-70031-6_15" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1007/978-3-031-70031-6_15&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1007/978-3-031-70031-6_15" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1007/978-3-031-70031-6_15&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4402088260" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1007/978-3-031-70031-6_15" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1007/978-3-031-70031-6_15?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{jeyi_scho_stra_husk.2024.CoCMILPPaEGi3CPE,
      author            = "Olubunmi Anthony Jeyifous and Eric Schönsee and Christoph Strangfeld and Götz Hüsken",
      title             = "Correlation of Continuously Measured In-Line Process Parameters and Extruded Geometry in 3D Concrete Printing Experiments",
      doi               = "10.1007/978-3-031-70031-6_15",
      year              = "2024",
      volume            = "53",
      pages             = "127--133",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">O. A. Jeyifous, E. Schönsee, C. Strangfeld and G. Hüsken, “Correlation of Continuously Measured In-Line Process Parameters and Extruded Geometry in 3D Concrete Printing Experiments”, in <i>Proceedings of the 4th RILEM International Conference on Concrete and Digital Fabrication</i>,  2024, vol. 53, pp. 127–133. doi: 10.1007/978-3-031-70031-6_15.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Jeyifous, Olubunmi Anthony, Eric Schönsee, Christoph Strangfeld, and Götz Hüsken. “Correlation of Continuously Measured In-Line Process Parameters and Extruded Geometry in 3D Concrete Printing Experiments”. In <i>Proceedings of the 4th RILEM International Conference on Concrete and Digital Fabrication</i>, edited by Dirk Lowke, Niklas Freund, David Böhler, and Friedrich Herding, 53:127–33, 2024. https://doi.org/10.1007/978-3-031-70031-6_15.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
