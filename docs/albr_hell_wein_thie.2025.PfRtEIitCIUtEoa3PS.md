...
hide:
    ...
    - tags
    - footer
title: Albrecht Sophie, Hellerbrand Stefan, Weininger Florian, Thiel Charlotte
description:
tags:
 - construction
 - environment
...
<a href="https://api.crossref.org/works/10.1007/978-981-97-9400-3_6" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1007/978-981-97-9400-3_6" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1007/978-981-97-9400-3_6" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1007/978-981-97-9400-3_6&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1007/978-981-97-9400-3_6" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1007/978-981-97-9400-3_6&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4408967433" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1007/978-981-97-9400-3_6" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1007/978-981-97-9400-3_6?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{albr_hell_wein_thie.2025.PfRtEIitCIUtEoa3PS,
      author            = "Sophie Viktoria Albrecht and Stefan Hellerbrand and Florian Weininger and Charlotte Thiel",
      title             = "Possibilities for Reducing the Environmental Impact in the Construction Industry Using the Example of a 3D Printed Staircase",
      doi               = "10.1007/978-981-97-9400-3_6",
      year              = "2025",
      volume            = "418",
      pages             = "55--64",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">S. V. Albrecht, S. Hellerbrand, F. Weininger and C. Thiel, “Possibilities for Reducing the Environmental Impact in the Construction Industry Using the Example of a 3D Printed Staircase”, in <i>Proceedings of the 4th International Conference on Sustainable Development in Civil, Urban and Transportation Engineering</i>,  2025, vol. 418, pp. 55–64. doi: 10.1007/978-981-97-9400-3_6.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Albrecht, Sophie Viktoria, Stefan Hellerbrand, Florian Weininger, and Charlotte Thiel. “Possibilities for Reducing the Environmental Impact in the Construction Industry Using the Example of a 3D Printed Staircase”. In <i>Proceedings of the 4th International Conference on Sustainable Development in Civil, Urban and Transportation Engineering</i>, 418:55–64, 2025. https://doi.org/10.1007/978-981-97-9400-3_6.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
