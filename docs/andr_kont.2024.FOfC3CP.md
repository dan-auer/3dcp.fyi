...
hide:
    - navigation
    - tags
title: Vasilis Andreou, Odysseas Kontovourkis
description:
tags:
 - complexity
 - concrete
...
#:aca-closedaccess:{ .xred '} Formwork-Optimization for Complex 3D Concrete Printing:<br/>:aca-blank: A Unified Theoretical, Digital, and Experimental Framework ([2024-09](date/2024/09))
<a href="https://doi.org/10.52842/conf.ecaade.2024.1.223" title="DOI" target="_blank">:aca-doi:{ .lg .middle } 10.52842/conf.ecaade.2024.1.223</a>

-------------------------

:aca-blank:{ .lg .middle}
      <a href="../../../author/andreou_vasilis"><b>Andreou</b> Vasilis</a>
