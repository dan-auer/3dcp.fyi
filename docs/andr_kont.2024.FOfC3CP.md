...
hide:
    ...
    - tags
    - footer
title: Andreou Vasilis, Kontovourkis Odysseas
description:
tags:
 - complexity
 - concrete
...
#Formwork-Optimization for Complex 3D Concrete Printing&nbsp;([2024-09](date/2024/09))
<div class="h1-like">A Unified Theoretical, Digital, and Experimental Framework</div>
<a title="Closed Access">:aca-closedaccess:{ .xred .lg .middle}</a>
 <a href="https://doi.org/10.52842/conf.ecaade.2024.1.223" title="DOI" target="_blank">:aca-doi:{ .lg .middle }</a> <a href="https://doi.org/10.52842/conf.ecaade.2024.1.223" target="_blank">10.52842/conf.ecaade.2024.1.223</a>

<a href="../../../author/andreou_vasilis"><b>Andreou</b>&nbsp;Vasilis</a></span>, <span class="author"><a href="https://orcid.org/0000-0001-5804-9657" title="ORCID: 0000-0001-5804-9657" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/kontovourkis_odysseas"><b>Kontovourkis</b>&nbsp;Odysseas</a></span><br>
...
<a href="../../keyword/complexity"><button class="btn">#complexity</button></a> <a href="../../keyword/concrete"><button class="btn">#concrete</button></a> <a href="../../keyword/digital"><button class="btn">#digital</button></a> <a href="../../keyword/experiment"><button class="btn">#experiment</button></a> <a href="../../keyword/formwork"><button class="btn">#formwork</button></a> <a href="../../keyword/framework"><button class="btn">#framework</button></a> <a href="../../keyword/optimization"><button class="btn">#optimization</button></a> <a href="../../keyword/print"><button class="btn">#print</button></a> <a href="../../keyword/theory"><button class="btn">#theory</button></a> <a href="../../keyword/uniform"><button class="btn">#uniform</button></a> 

<a href="https://scholar.google.com/scholar?as_q=formwork-optimization+for+complex+3d+concrete+printing&as_occt=title&as_sauthors=andreou&as_ylo=2022&as_yhi=2026&hl=en" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
<a href="https://www.scopus.com/record/display.url?eid=2-s2.0-85209778507&origin=resultslist" title="Search on Scopus" target="_blank">:aca-scopus:{ .lg .middle }</a>
<a href="https://www.webofscience.com/wos/woscc/full-record/WOS:None" title="Search on Web of Science" target="_blank">:aca-wos:{ .lg .middle }</a>
<a href="https://plu.mx/plum/a/?doi=10.52842/conf.ecaade.2024.1.223" title="Search on plu.mx" target="_blank">:aca-plumx:{ .lg .middle }</a>
<a href="https://api.crossref.org/works/10.52842/conf.ecaade.2024.1.223" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.52842/conf.ecaade.2024.1.223" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.52842/conf.ecaade.2024.1.223" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.52842/conf.ecaade.2024.1.223&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.52842/conf.ecaade.2024.1.223" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.52842/conf.ecaade.2024.1.223&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4404456294" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.52842/conf.ecaade.2024.1.223" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.52842/conf.ecaade.2024.1.223?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">V. Andreou  and O. Kontovourkis, “Formwork-Optimization for Complex 3D Concrete Printing: A Unified Theoretical, Digital, and Experimental Framework”, in <i>Proceedings of the 42nd Conference on Education and Research in Computer Aided Architectural Design in Europe: Data-Driven Intelligence</i>,  2024, pp. 223–232. doi: 10.52842/conf.ecaade.2024.1.223.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Andreou, Vasilis, and Odysseas Kontovourkis. “Formwork-Optimization for Complex 3D Concrete Printing: A Unified Theoretical, Digital, and Experimental Framework”. In <i>Proceedings of the 42nd Conference on Education and Research in Computer Aided Architectural Design in Europe: Data-Driven Intelligence</i>, edited by Odysseas Kontovourkis, Marios C. Phocas, and Gabriel Wurzer, 223–32, 2024. https://doi.org/10.52842/conf.ecaade.2024.1.223.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
