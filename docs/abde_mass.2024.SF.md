...
hide:
    ...
    - tags
    - footer
title: Abdelmohsen Sherif, Massoud Passant
description:
tags:
 - architecture
 - clay
...
#Synthetic Fabrications&nbsp;([2024-11](date/2024/11))
<div class="h1-like">Lessons from Integrating Robotic Clay-Fabrication in Architectural Education</div>
<a href="../../../author/abdelmohsen_sherif"><b>Abdelmohsen</b>&nbsp;Sherif</a></span>, <a href="../../../author/massoud_passant"><b>Massoud</b>&nbsp;Passant</a></span><br>
Contribution - Proceedings of the 12th International Conference of the Arab Society for Computation in Architecture, Art and Design, pp. 508-518
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{abde_mass.2024.SF,
      author            = "Sherif Abdelmohsen and Passant Massoud",
      title             = "Synthetic Fabrications: Lessons from Integrating Robotic Clay-Fabrication in Architectural Education",
      year              = "2024",
      pages             = "508--518",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">S. Abdelmohsen  and P. Massoud, “Synthetic Fabrications: Lessons from Integrating Robotic Clay-Fabrication in Architectural Education”, in <i>Proceedings of the 12th International Conference of the Arab Society for Computation in Architecture, Art and Design</i>,  2024, pp. 508–518.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Abdelmohsen, Sherif, and Passant Massoud. “Synthetic Fabrications: Lessons from Integrating Robotic Clay-Fabrication in Architectural Education”. In <i>Proceedings of the 12th International Conference of the Arab Society for Computation in Architecture, Art and Design</i>, edited by Sherif Abdelmohsen, Amar Bennadji, Zaki Mallasi, Mostafa Alani, and Sema Alaçam, 508–18, 2024.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
