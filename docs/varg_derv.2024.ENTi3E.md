...
hide:
    ...
    - tags
    - footer
title: Vargas José, Dervishaj Arlind
description:
tags:
 - 3dcp
 - element
...
#Embedding NFC Tags into 3DCP Elements ([2024-09](date/2024/09))
 <a href="https://doi.org/10.24355/dbbs.084-202408130936-0" title="DOI" target="_blank">:aca-doi:{ .lg .middle }</a> <a href="https://doi.org/10.24355/dbbs.084-202408130936-0" target="_blank">10.24355/dbbs.084-202408130936-0</a>

<span class="author"><a href="https://orcid.org/0000-0002-0641-0567" title="ORCID: 0000-0002-0641-0567" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/vargas_hernandez_jose"><b>Vargas</b>&nbsp;José</a></span>, <span class="author"><a href="https://orcid.org/0000-0002-9436-6753" title="ORCID: 0000-0002-9436-6753" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/dervishaj_arlind"><b>Dervishaj</b>&nbsp;Arlind</a></span><br>
Contribution - Supplementary Proceedings of the 4th RILEM International Conference on Concrete and Digital Fabrication

<a href="../../keyword/3dcp"><button class="btn">#3dcp</button></a> <a href="../../keyword/element"><button class="btn">#element</button></a> <a href="../../keyword/embedded"><button class="btn">#embedded</button></a> 

<a href="https://scholar.google.com/scholar?as_q=embedding+nfc+tags+into+3dcp+elements&as_occt=title&as_sauthors=vargas&as_ylo=2022&as_yhi=2026&hl=en" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{varg_derv.2024.ENTi3E,
      author            = "José Hernández Vargas and Arlind Dervishaj",
      title             = "Embedding NFC Tags into 3DCP Elements",
      doi               = "10.24355/dbbs.084-202408130936-0",
      year              = "2024",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">J. H. Vargas  and A. Dervishaj, “Embedding NFC Tags into 3DCP Elements”, in <i>Supplementary Proceedings of the 4th RILEM International Conference on Concrete and Digital Fabrication</i>,  2024. doi: 10.24355/dbbs.084-202408130936-0.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Vargas, José Hernández, and Arlind Dervishaj. “Embedding NFC Tags into 3DCP Elements”. In <i>Supplementary Proceedings of the 4th RILEM International Conference on Concrete and Digital Fabrication</i>, edited by Dirk Lowke, Niklas Freund, David Böhler, and Friedrich Herding, 2024. https://doi.org/10.24355/dbbs.084-202408130936-0.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
