...
hide:
    ...
    - tags
    - footer
title: Mohammed Alyaa, Saadi Nihad
description:
tags:
 - additive
 - agent
...
<a href="https://api.crossref.org/works/10.3390/polym12122900" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.3390/polym12122900" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.3390/polym12122900" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.3390/polym12122900&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.3390/polym12122900" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.3390/polym12122900&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W3109000321" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.3390/polym12122900" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.3390/polym12122900?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{moha_saad.2020.UHESCGSfAMAFbUGOaVMA,
      author            = "Alyaa Mohammed and Nihad Tareq Khshain Al Saadi",
      title             = "Ultra-High Early Strength Cementitious Grout Suitable for Additive Manufacturing Applications Fabricated by Using Graphene Oxide and Viscosity Modifying Agents",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">A. Mohammed  and N. T. K. A. Saadi, “Ultra-High Early Strength Cementitious Grout Suitable for Additive Manufacturing Applications Fabricated by Using Graphene Oxide and Viscosity Modifying Agents”, <i>Polymers</i>, vol. 12, no. 12, 2020, doi: 10.3390/polym12122900.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Mohammed, Alyaa, and Nihad Tareq Khshain Al Saadi. “Ultra-High Early Strength Cementitious Grout Suitable for Additive Manufacturing Applications Fabricated by Using Graphene Oxide and Viscosity Modifying Agents”. <i>Polymers</i> 12, no. 12 (2020). https://doi.org/10.3390/polym12122900.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
