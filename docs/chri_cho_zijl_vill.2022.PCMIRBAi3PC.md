...
hide:
    ...
    - tags
    - footer
title: Christen Heidi, Cho Seung, Zijl Gideon, Villiers Wibke
description:
tags:
 - aggregate
 - brick
...
#Phase-Change-Material-Infused Recycled Brick-Aggregate in 3D Printed Concrete ([2022-11](date/2022/11))
<a href="http://www.cell.com/article/S2405844022028869/pdf" title="Open Access - Click to Download" target="_blank">:aca-openaccess:{ .xgreen .lg .middle}</a>
 <a href="https://doi.org/10.1016/j.heliyon.2022.e11598" title="DOI" target="_blank">:aca-doi:{ .lg .middle }</a> <a href="https://doi.org/10.1016/j.heliyon.2022.e11598" target="_blank">10.1016/j.heliyon.2022.e11598</a>

<span class="author"><a href="https://orcid.org/0000-0003-3956-2871" title="ORCID: 0000-0003-3956-2871" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/christen_heidi"><b>Christen</b>&nbsp;Heidi</a></span>, <span class="author"><a href="https://orcid.org/0000-0003-0664-1370" title="ORCID: 0000-0003-0664-1370" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/cho_seung"><b>Cho</b>&nbsp;Seung</a></span>, <span class="author"><a href="https://orcid.org/0000-0001-8066-7750" title="ORCID: 0000-0001-8066-7750" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/zijl_pieter-adriaan-greeff_gideon"><b>van&nbsp;Zijl</b>&nbsp;Gideon</a></span>, <span class="author"><a href="https://orcid.org/0000-0002-0775-5305" title="ORCID: 0000-0002-0775-5305" target="_blank">:aca-orcid:{ .lg .middle }</a>&nbsp;<a href="../../../author/villiers_wibke"><b>de&nbsp;Villiers</b>&nbsp;Wibke</a></span><br>
Journal Article - Heliyon, Vol. 8, Iss. 11

<a href="../../keyword/aggregate"><button class="btn">#aggregate</button></a> <a href="../../keyword/brick"><button class="btn">#brick</button></a> <a href="../../keyword/change"><button class="btn">#change</button></a> <a href="../../keyword/concrete"><button class="btn">#concrete</button></a> <a href="../../keyword/material"><button class="btn">#material</button></a> <a href="../../keyword/phase"><button class="btn">#phase</button></a> <a href="../../keyword/print"><button class="btn">#print</button></a> <a href="../../keyword/recycling"><button class="btn">#recycling</button></a> 

<a href="https://scholar.google.com/scholar?as_q=phase-change-material-infused+recycled+brick-aggregate+in+3d+printed+concrete&as_occt=title&as_sauthors=christen&as_ylo=2020&as_yhi=2024&hl=en" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
<a href="https://www.scopus.com/record/display.url?eid=2-s2.0-85142182467&origin=resultslist" title="Search on Scopus" target="_blank">:aca-scopus:{ .lg .middle }</a>
<a href="https://www.webofscience.com/wos/woscc/full-record/WOS:000904086400005" title="Search on Web of Science" target="_blank">:aca-wos:{ .lg .middle }</a>
<a href="https://plu.mx/plum/a/?doi=10.1016/j.heliyon.2022.e11598" title="Search on plu.mx" target="_blank">:aca-plumx:{ .lg .middle }</a>
<a href="https://api.crossref.org/works/10.1016/j.heliyon.2022.e11598" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1016/j.heliyon.2022.e11598" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1016/j.heliyon.2022.e11598" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1016/j.heliyon.2022.e11598&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1016/j.heliyon.2022.e11598" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1016/j.heliyon.2022.e11598&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4309630756" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1016/j.heliyon.2022.e11598" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1016/j.heliyon.2022.e11598?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{chri_cho_zijl_vill.2022.PCMIRBAi3PC,
      author            = "Heidi Christen and Seung Cho and Gideon Pieter Adriaan Greeff van Zijl and Wibke de Villiers",
      title             = "Phase-Change-Material-Infused Recycled Brick-Aggregate in 3D Printed Concrete",
      doi               = "10.1016/j.heliyon.2022.e11598",
      year              = "2022",
      journal           = "Heliyon",
      volume            = "8",
      number            = "11",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">H. Christen, S. Cho, G. P. A. G. van Zijl and W. de Villiers, “Phase-Change-Material-Infused Recycled Brick-Aggregate in 3D Printed Concrete”, <i>Heliyon</i>, vol. 8, no. 11, 2022, doi: 10.1016/j.heliyon.2022.e11598.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Christen, Heidi, Seung Cho, Gideon Pieter Adriaan Greeff van Zijl, and Wibke de Villiers. “Phase-Change-Material-Infused Recycled Brick-Aggregate in 3D Printed Concrete”. <i>Heliyon</i> 8, no. 11 (2022). https://doi.org/10.1016/j.heliyon.2022.e11598.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
