...
hide:
    ...
    - tags
    - footer
title: Florea Vitalie, Păuleţ-Crăiniceanu Fideliu, Luca Septimiu-George, Pastia Cristian
description:
tags:
 - advantage
 - buildability
...
<a href="https://api.crossref.org/works/10.1007/978-3-030-61118-7_26" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1007/978-3-030-61118-7_26" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1007/978-3-030-61118-7_26" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1007/978-3-030-61118-7_26&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1007/978-3-030-61118-7_26" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1007/978-3-030-61118-7_26&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W3096843588" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1007/978-3-030-61118-7_26" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1007/978-3-030-61118-7_26?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
    Recently, a phenomenon of “printing” houses and construction 3D printers has taken on or greatly increased in many parts of the world. This phenomenon is intensively shown in various media and in science news and science articles. 3D printers and house printing are praised to be very advantageous from economical, energetic and sustainable point of view. However, there are no norms or rules to cover this type of construction works. In addition, a lack of methods for structural calculation and for certification of materials regarding “printing” is observed. Effects on future design and execution of this type of constructions on the market labor and on education in construction domain are unknown. In addition to some practical applications and their characteristics, this paper tries to present the requirements of 3D-Printing applications in the field of constructions, limitation of current technologies, the advantages and disadvantages of3D printed houses and the effects on the listed above sub-domains. Future of 3D printing for constructions is analyzed in a sustainability perspective.
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{flor_paul_luca_past.2021.3PoB,
      author            = "Vitalie Florea and Fideliu Păuleţ-Crăiniceanu and Septimiu-George Luca and Cristian Pastia",
      title             = "3D Printing of Buildings: Limits, Design, Advantages and Disadvantages",
      doi               = "10.1007/978-3-030-61118-7_26",
      year              = "2021",
      pages             = "298--308",
      booktitle         = "Critical Thinking in the Sustainable Rehabilitation and Risk Management of the Built Environment",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">V. Florea, F. Păuleţ-Crăiniceanu, S.-G. Luca and C. Pastia, “3D Printing of Buildings: Limits, Design, Advantages and Disadvantages”, in <i>Critical Thinking in the Sustainable Rehabilitation and Risk Management of the Built Environment</i>,  2021, pp. 298–308. doi: 10.1007/978-3-030-61118-7_26.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Florea, Vitalie, Fideliu Păuleţ-Crăiniceanu, Septimiu-George Luca, and Cristian Pastia. “3D Printing of Buildings: Limits, Design, Advantages and Disadvantages”. In <i>Critical Thinking in the Sustainable Rehabilitation and Risk Management of the Built Environment</i>, edited by Ancuța Rotaru, 298–308, 2021. https://doi.org/10.1007/978-3-030-61118-7_26.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
