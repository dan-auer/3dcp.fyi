...
hide:
    ...
    - tags
    - footer
title: Liu Shun, Yang Xiaobin, Wu Jianing
description:
tags:
 - analysis
 - base
...
<a href="https://api.crossref.org/works/10.1016/j.jobe.2025.113276" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1016/j.jobe.2025.113276" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1016/j.jobe.2025.113276" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1016/j.jobe.2025.113276&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1016/j.jobe.2025.113276" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1016/j.jobe.2025.113276&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4411613400" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1016/j.jobe.2025.113276" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1016/j.jobe.2025.113276?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{liu_yang_wu.2025.DEAoCB3PSMUDCLUC,
      author            = "Shun Liu and Xiaobin Yang and Jianing Wu",
      title             = "Damage Evolution Analysis of Cement-Based 3D Printing Similar Materials Under Different Cyclic Loading-Unloading Conditions",
      doi               = "10.1016/j.jobe.2025.113276",
      year              = "2025",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">S. Liu, X. Yang and J. Wu, “Damage Evolution Analysis of Cement-Based 3D Printing Similar Materials Under Different Cyclic Loading-Unloading Conditions”, <i>Journal of Building Engineering</i>, p. 113276, 2025, doi: 10.1016/j.jobe.2025.113276.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Liu, Shun, Xiaobin Yang, and Jianing Wu. “Damage Evolution Analysis of Cement-Based 3D Printing Similar Materials Under Different Cyclic Loading-Unloading Conditions”. <i>Journal of Building Engineering</i>, 2025, 113276. https://doi.org/10.1016/j.jobe.2025.113276.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
