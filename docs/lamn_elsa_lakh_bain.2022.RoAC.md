...
hide:
    ...
    - tags
    - footer
title: Lamnini Soukaina, Elsayed Hamada, Lakhdar Yazid, Baino Francesco, Smeacetto Federico, Bernardo Enrico
description:
tags:
 - advance
 - ceramic
...
<a href="https://api.crossref.org/works/10.1016/j.heliyon.2022.e10651" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1016/j.heliyon.2022.e10651" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1016/j.heliyon.2022.e10651" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1016/j.heliyon.2022.e10651&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1016/j.heliyon.2022.e10651" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1016/j.heliyon.2022.e10651&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4296051970" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1016/j.heliyon.2022.e10651" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1016/j.heliyon.2022.e10651?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @article{lamn_elsa_lakh_bain.2022.RoAC,
      author            = "Soukaina Lamnini and Hamada Elsayed and Yazid Lakhdar and Francesco Baino and Federico Smeacetto and Enrico Bernardo",
      title             = "Robocasting of Advanced Ceramics: Ink-Optimization and Protocol to Predict the Printing Parameters",
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">S. Lamnini, H. Elsayed, Y. Lakhdar, F. Baino, F. Smeacetto and E. Bernardo, “Robocasting of Advanced Ceramics: Ink-Optimization and Protocol to Predict the Printing Parameters”, <i>Heliyon</i>, vol. 8, no. 9, 2022, doi: 10.1016/j.heliyon.2022.e10651.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Lamnini, Soukaina, Hamada Elsayed, Yazid Lakhdar, Francesco Baino, Federico Smeacetto, and Enrico Bernardo. “Robocasting of Advanced Ceramics: Ink-Optimization and Protocol to Predict the Printing Parameters”. <i>Heliyon</i> 8, no. 9 (2022). https://doi.org/10.1016/j.heliyon.2022.e10651.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
