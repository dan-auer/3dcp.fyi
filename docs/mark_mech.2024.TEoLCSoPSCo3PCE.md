...
#The Effect of Layer Cross-Section on Plastic Shrinkage Cracking of 3D Printed Concrete Elements ([2023-10](date/2023/10))
:aca-closedaccess:{ .xred .lg .middle} <a href="https://doi.org/10.1007/978-3-031-44603-0_30" title="DOI" target="_blank">:aca-doi:{ .lg .middle }</a> <a href="https://doi.org/10.1007/978-3-031-44603-0_30" target="_blank">10.1007/978-3-031-44603-0_30</a>
...
Contribution - Modern Building Materials, Structures and Techniques, pp. 300-309

<a href="../../keyword/concrete"><button class="btn">#concrete</button></a> <a href="../../keyword/crack"><button class="btn">#crack</button></a> <a href="../../keyword/cross"><button class="btn">#cross</button></a> <a href="../../keyword/effect"><button class="btn">#effect</button></a> <a href="../../keyword/element"><button class="btn">#element</button></a> <a href="../../keyword/layer"><button class="btn">#layer</button></a> <a href="../../keyword/plastic"><button class="btn">#plastic</button></a> <a href="../../keyword/print"><button class="btn">#print</button></a> <a href="../../keyword/section"><button class="btn">#section</button></a> <a href="../../keyword/shrinkage"><button class="btn">#shrinkage</button></a> 

<a href="https://scholar.google.com/scholar_lookup?title=The%20Effect%20of%20Layer%20Cross-Section%20on%20Plastic%20Shrinkage%20Cracking%20of%203D%20Printed%20Concrete%20Elements" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
<a href="https://www.scopus.com/record/display.url?eid=2-s2.0-85175964436&origin=resultslist" title="Search on Scopus" target="_blank">:aca-scopus:{ .lg .middle }</a>
<a href="https://www.webofscience.com/wos/woscc/full-record/WOS:None" title="Search on Web of Science" target="_blank">:aca-wos:{ .lg .middle }</a>
<a href="https://plu.mx/plum/a/?doi=10.1007/978-3-031-44603-0_30" title="Search on plu.mx" target="_blank">:aca-plumx:{ .lg .middle }</a>
<a href="https://api.crossref.org/works/10.1007/978-3-031-44603-0_30" title="Search on CrossRef" target="_blank">:aca-crossref:{ .lg .middle }</a>
<a href="https://api.openalex.org/works/doi:10.1007/978-3-031-44603-0_30" title="Search on OpenAlex" target="_blank">:aca-openalex:{ .lg .middle }</a>
<a href="https://api.semanticscholar.org/graph/v1/paper/10.1007/978-3-031-44603-0_30" title="Search on Semantic Scholar" target="_blank">:aca-semanticscholar:{ .lg .middle }</a>
<a href="https://crossmark.crossref.org/dialog/?doi=10.1007/978-3-031-44603-0_30&domain=pdf" title="Search on Crossmark" target="_blank">:aca-crossmark:{ .lg .middle }</a>
<a href="https://opencitations.net/meta/api/v1/metadata/doi:10.1007/978-3-031-44603-0_30" title="Search on OpenCitations" target="_blank">:aca-opencitations:{ .lg .middle }</a>
<a href="https://www.researchgate.net/search.Search.html?query=10.1007/978-3-031-44603-0_30&type=publication&type=publication" title="Search on Reserachgate (Login Required)" target="_blank">:aca-researchgate:{ .lg .middle }</a>
<a href="https://inciteful.xyz/p/W4387907580" title="Search on Inciteful" target="_blank">:aca-connectedpapers:{ .lg .middle }</a>
<a href="https://www.altmetric.com/details/doi/10.1007/978-3-031-44603-0_30" title="Search on Altmetric" target="_blank">:aca-altmetric:{ .lg .middle }</a>
<a href="https://api.unpaywall.org/v2/10.1007/978-3-031-44603-0_30?email=peter@enis.de" title="Search on Unpaywall" target="_blank">:aca-unpaywall:{ .lg .middle }</a>
???+ quote "Abstract" 
...
???+ warning "BibTeX"
    ...
    ```bibtex
    @inproceedings{mark_mech.2024.TEoLCSoPSCo3PCE,
      author            = "Slava Viacheslav Markin and Viktor Mechtcherine",
      title             = "The Effect of Layer Cross-Section on Plastic Shrinkage Cracking of 3D Printed Concrete Elements",
      doi               = "10.1007/978-3-031-44603-0_30",
      year              = "2024",
      volume            = "392",
      pages             = "300--309",
      booktitle         = "Modern Building Materials, Structures and Techniques",
      editor            = "Joaquim A. O. Barros and Gintaris Kaklauskas and Zava and Edmundas K. Zavadskas",
    }
...
???+ failure "Formatted Citation"
    ...
    <span id="iee">S. V. Markin  and V. Mechtcherine, “The Effect of Layer Cross-Section on Plastic Shrinkage Cracking of 3D Printed Concrete Elements”, in <i>Modern Building Materials, Structures and Techniques</i>,  2024, vol. 392, pp. 300–309. doi: 10.1007/978-3-031-44603-0_30.</span><button class="md-code__button" data-clipboard-target="#ieee" data-md-type="copy" title="Copy IEEE Citation to Clipboard"></button>

    === "CMOS"

    <span id="cmos">Markin, Slava Viacheslav, and Viktor Mechtcherine. “The Effect of Layer Cross-Section on Plastic Shrinkage Cracking of 3D Printed Concrete Elements”. In <i>Modern Building Materials, Structures and Techniques</i>, edited by Joaquim A. O. Barros, Gintaris Kaklauskas, Zava, and Edmundas K. Zavadskas, 392:300–309, 2024. https://doi.org/10.1007/978-3-031-44603-0_30.</span><button class="md-code__button" data-clipboard-target="#cmos" data-md-type="copy" title="Copy CMOS Citation to Clipboard"></button>
