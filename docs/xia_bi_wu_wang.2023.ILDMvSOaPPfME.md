...
hide:
    - navigation
    - tags
title: Lingwei Xia, Minghao Bi, Jie Wu, Fang Wang, Li Wang, Yi Xie, Guowei Ma
description:
tags:
 - design
 - extrusion
...
#:aca-closedaccess:{ .xred '} Integrated Lightweight Design-Method via Structural Optimization and Path-Planning for Material-Extrusion ([2023-01](date/2023/01))
<a href="https://doi.org/10.1016/j.addma.2022.103387" title="DOI" target="_blank">:aca-doi:{ .lg .middle } 10.1016/j.addma.2022.103387</a>
...
:aca-blank:{ .lg .middle}
    Journal Article - Additive Manufacturing, Vol. 62, No. (None,)
...
<a href="https://scholar.google.com/scholar_lookup?title=Integrated%20Lightweight%20Design-Method%20via%20Structural%20Optimization%20and%20Path-Planning%20for%20Material-Extrusion" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
