...
hide:
    - navigation
    - tags
title: Ana Matos, Mehmet Emiroğlu, Serkan Subaşı, Muhammed Maraşlı, Ana Guimarães, João Delgado
description:
tags:
 - architecture
 - base
...
#:aca-closedaccess:{ .xred '} Architectonic Cement-Based Composites 3D Printing ([2023-01](date/2023/01))
<a href="https://doi.org/10.1007/978-3-031-09319-7_4" title="DOI" target="_blank">:aca-doi:{ .lg .middle } 10.1007/978-3-031-09319-7_4</a>
...
<a href="https://scholar.google.com/scholar_lookup?title=Architectonic%20Cement-Based%20Composites%203D%20Printing" title="Search on Google Scholar" target="_blank">:aca-googlescholar:{ .lg .middle }</a>
